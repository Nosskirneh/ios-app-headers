...
@class FPRCounterList, FPRTraceBackgroundActivityTracker, NSDate, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSSet, NSString;
...
- (void)incrementCounterNamed:(id)arg1;
