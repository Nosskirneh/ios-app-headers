...
@class GCKCastSecureSocket, GCKError, NSData;

@protocol GCKCastSecureSocketDelegate <NSObject>
- (void)castSocket:(GCKCastSecureSocket *)arg1 didDisconnectWithError:(GCKError *)arg2;
- (void)castSocket:(GCKCastSecureSocket *)arg1 didReceiveMessage:(NSData *)arg2;
- (void)castSocket:(GCKCastSecureSocket *)arg1 didFailToConnectWithError:(GCKError *)arg2;
