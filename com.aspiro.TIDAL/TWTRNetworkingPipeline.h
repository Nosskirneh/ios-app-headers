...
- (void).cxx_destruct;
- (void)enqueueUserPackage:(id)arg1;
- (void)enqueueGuestPackage:(id)arg1;
- (id)userQueueForUser:(id)arg1;
- (void)enqueueRequest:(id)arg1 sessionStore:(id)arg2 requestingUser:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)enqueueRequest:(id)arg1 sessionStore:(id)arg2 requestingUser:(id)arg3;
- (void)enqueueRequest:(id)arg1 sessionStore:(id)arg2;
