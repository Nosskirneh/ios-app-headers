...
@class NSArray, NSDate, NSDictionary, NSString, NSURL, TWTRTweetMediaEntity, TWTRTweetRepository, TWTRUser, TWTRVideoMetaData;
...
@property(readonly, nonatomic) TWTRVideoMetaData *videoEntity;
