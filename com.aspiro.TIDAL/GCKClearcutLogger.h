...
@class GCKNHTTPClient, GCKNHTTPRequest, GCKSenderInfo, NSDateFormatter, NSMutableArray, NSMutableDictionary, NSString, NSURL;
...
+ (id)sharedInstance;
@property(copy, nonatomic) NSString *pseudonymousSenderID; // @synthesize pseudonymousSenderID=_pseudonymousSenderID;
