...
@class CCTClearcutFlags, CCTClearcutMetaLogger, CCTLogWriter, GMVGIPPseudonymousIDStore, GTMSessionFetcher, NSError, NSHashTable, NSMutableArray, NSMutableDictionary, NSURL, PHTPhenotype;
@protocol CCTClearcutAuthorizer, CCTClockProtocol, CCTUploaderLock, CCTUploaderLockProvider, NSObject, OS_dispatch_queue, OS_dispatch_source;
...
- (void)setCollectForDebugSkipPersistentStorage:(_Bool)arg1;
