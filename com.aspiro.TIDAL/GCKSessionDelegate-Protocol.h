...
- (void)sessionDidResume:(GCKSession *)arg1;
- (void)session:(GCKSession *)arg1 didSuspendWithReason:(long long)arg2;
- (void)session:(GCKSession *)arg1 didEndWithError:(NSError *)arg2;
