...
@class GCKPB_ClientInfo, GCKPB_DeviceStatus, GCKPB_ExternalTimestamp, GCKPB_PBMutableArray, NSString;
...
@property(retain, nonatomic) GCKPB_DeviceStatus *deviceStatus; // @dynamic deviceStatus;
@property(retain, nonatomic) GCKPB_ExternalTimestamp *externalTimestamp; // @dynamic externalTimestamp;
