...
@class GCKPB_ActiveExperiments, GCKPB_AppUsage1pLogEvent, GCKPB_ExperimentIds, GCKPB_NetworkConnectionInfo, GCKPB_PBMutableArray, NSData, NSString;
...
@property(retain, nonatomic) GCKPB_NetworkConnectionInfo *networkConnectionInfo; // @dynamic networkConnectionInfo;
