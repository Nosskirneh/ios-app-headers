...
@class GCKApplicationMetadata, GCKCastDeviceController, GCKDevice, GCKDeviceConfiguration, GCKDeviceInformation, GCKError, GCKMultizoneDevice, GCKMultizoneStatus, NSDictionary, NSString;
...
- (void)deviceController:(GCKCastDeviceController *)arg1 didPairWithGuestModeDevice:(GCKDevice *)arg2;
...
- (void)deviceController:(GCKCastDeviceController *)arg1 didSuspendConnectionWithReason:(long long)arg2;
- (void)deviceController:(GCKCastDeviceController *)arg1 didDisconnectWithError:(GCKError *)arg2;
