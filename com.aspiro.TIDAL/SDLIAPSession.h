...
@property(retain, nonatomic) SDLStreamDelegate *streamDelegate; // @synthesize streamDelegate=_streamDelegate;
@property(nonatomic) __weak id <SDLIAPSessionDelegate> delegate; // @synthesize delegate=_delegate;
@property(retain, nonatomic) EASession *easession; // @synthesize easession=_easession;
