...
@interface _TtC4WiMP9SonosShow : NSObject
{
...
- (id)initWithId:(id)arg1 name:(id)arg2 host:(id)arg3 imageUrl:(id)arg4;
@property(nonatomic, copy) NSString *imageUrl; // @synthesize imageUrl;
@property(nonatomic, retain) _TtC4WiMP11SonosArtist *host; // @synthesize host;
