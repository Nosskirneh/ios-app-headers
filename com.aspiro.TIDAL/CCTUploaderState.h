...
@property(nonatomic) _Bool collectForDebugSkipPersistentStorage; // @dynamic collectForDebugSkipPersistentStorage;
...
@property(nonatomic) _Bool hasCollectForDebugSkipPersistentStorage; // @dynamic hasCollectForDebugSkipPersistentStorage;
