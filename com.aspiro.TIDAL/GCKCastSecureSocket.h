...
@class GCKBCircularByteBuffer, GCKClientCertificate, NSInputStream, NSOutputStream, NSString, NSTimer;
@protocol GCKCastSecureSocketDelegate;

@interface GCKCastSecureSocket : NSObject <NSStreamDelegate>
{
    unsigned long long _bufferSize;
    GCKBCircularByteBuffer *_streamReadBuffer;
    GCKBCircularByteBuffer *_streamWriteBuffer;
    CDUnknownBlockType _streamReadBlock;
    CDUnknownBlockType _streamWriteBlock;
    struct SSLContext *_SSLContext;
    GCKBCircularByteBuffer *_sslReadBuffer;
    GCKBCircularByteBuffer *_sslWriteBuffer;
    CDUnknownBlockType _sslReadBlock;
    CDUnknownBlockType _sslWriteBlock;
    _Bool _handshaking;
    _Bool _inSSLHandshakeCall;
    GCKBCircularByteBuffer *_ioReadBuffer;
    GCKBCircularByteBuffer *_ioWriteBuffer;
