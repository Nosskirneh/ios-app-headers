...
@class TWTRTweetMediaEntity, TWTRTweetMediaView, UIViewController;
...
- (_Bool)tweetMediaView:(TWTRTweetMediaView *)arg1 shouldPresentMediaEntity:(TWTRTweetMediaEntity *)arg2;
@end
