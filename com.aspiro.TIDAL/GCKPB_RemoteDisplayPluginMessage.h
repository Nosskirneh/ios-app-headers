...
@class GCKPB_RemoteDisplayPluginConfig;

@interface GCKPB_RemoteDisplayPluginMessage : GCKPB_PBGeneratedMessage
{
}
...
@property(retain, nonatomic) GCKPB_RemoteDisplayPluginConfig *remoteDisplayConfig; // @dynamic remoteDisplayConfig;
