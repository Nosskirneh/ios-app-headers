...
#import "RHAlbumHighlightMOProtocol-Protocol.h"

@class NSNumber, NSString, RHAlbumMO, RHArtistMO, RHGenreMO;

@interface _RHAlbumHighlightMO : ZDSManagedObject <RHAlbumHighlightMOProtocol>
{
}
