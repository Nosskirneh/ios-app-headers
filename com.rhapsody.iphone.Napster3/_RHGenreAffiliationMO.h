...
#import "RHGenreAffiliationMOProtocol-Protocol.h"

@class NSNumber, NSString, RHGenreMO;

@interface _RHGenreAffiliationMO : ZDSManagedObject <RHGenreAffiliationMOProtocol>
{
}
...
@property(retain, nonatomic) RHGenreMO *affiliated; // @dynamic affiliated;
