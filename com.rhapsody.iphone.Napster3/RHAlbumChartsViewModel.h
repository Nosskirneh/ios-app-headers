...
@class NSArray, RHAccountController, RHModelObserver, RHProfileMO, ZDSDeferred, _TtC7Napster12Dependencies;
@protocol RHProfilesService, _TtP7Napster17ImageProviderOBJC_;

@interface RHAlbumChartsViewModel : NSObject
{
    NSArray *_tags;
...
- (id)artistNameForIndex:(unsigned long long)arg1;
