...
@class GCKAdBreakStatus, GCKMediaInformation, GCKMediaQueueItem, GCKMediaSeekableRange, GCKVideoInfo, NSArray, NSMutableArray, NSMutableDictionary;
...
@interface GCKMediaStatus : NSObject <NSCopying>
{
    ...
    GCKMediaSeekableRange *_seekableRange;
}

@property(retain, nonatomic) GCKMediaSeekableRange *seekableRange; // @synthesize seekableRange=_seekableRange;
