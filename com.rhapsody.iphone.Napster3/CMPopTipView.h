...
+ (id)rh_defaultTipViewWithMessage:(id)arg1 attributedMessage:(id)arg2 maxWidth:(double)arg3;
+ (id)rh_defaultTipViewWithAttributedMessage:(id)arg1 maxWidth:(double)arg2;
+ (id)rh_defaultTipViewWithMessage:(id)arg1 maxWidth:(double)arg2;
+ (id)rh_defaultTipViewWithMessage:(id)arg1;
...
- (struct CGSize)calculatedTextSizeForContainerView:(id)arg1;
- (void)addDismissTapAnywhereWithContainerView:(id)arg1 controlEvents:(unsigned long long)arg2;
- (void)addDismissTapAnywhereIfNeededWithContainerView:(id)arg1;
- (void)presentWithFrame:(struct CGRect)arg1 animated:(_Bool)arg2;
- (void)presentAtPoint:(struct CGPoint)arg1 inView:(id)arg2 pointDirection:(long long)arg3 animated:(_Bool)arg4;
