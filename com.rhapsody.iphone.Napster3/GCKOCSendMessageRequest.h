...
@class GCKOCEnvironmentScan, GCKOCMessage, NSMutableArray;
...
@property(retain, nonatomic) NSMutableArray *bssidArray; // @dynamic bssidArray;
@property(readonly, nonatomic) unsigned long long bssidArray_Count; // @dynamic bssidArray_Count;
