...
#import "RHPlaylistItemMOProtocol-Protocol.h"

@class NSNumber, NSString, RHPlaylistMO, RHTrackMO;

@interface _RHPlaylistItemMO : ZDSManagedObject <RHPlaylistItemMOProtocol>
{
}
