...
@interface RHArtistHighlightsForGenreViewController : RHViewController <PSTCollectionViewDataSource, PSTCollectionViewDelegate, PSTCollectionViewDelegateFlowLayout, NSFetchedResultsControllerDelegate, RHFilterChooserViewControllerDelegate>
{
...
- (void)viewUnloading;
- (void)viewDidLoad;
- (id)initWithDataController:(id)arg1 genre:(id)arg2 selectedArtistHighlightScope:(long long)arg3;
