...
- (id)_parseListWithScanner:(id)arg1 atIndentationLevel:(unsigned long long)arg2;
- (id)_parseListItemWithScanner:(id)arg1 atIndentationLevel:(unsigned long long)arg2;
- (_Bool)_parseListMarkerWithScanner:(id)arg1;
