...
@class GCKAnalyticsEventLogger, GCKApplicationMetadata, GCKBroadcastKeyExchangeChannel, GCKCastDeviceConnector, GCKDevice, GCKDiscoveryChannel, GCKJoinOptions, GCKLaunchOptions, GCKMultizoneControlChannel, GCKReceiverControlChannel, GCKRequest, NSMutableDictionary, NSString;
...
- (id)initWithConnector:(id)arg1 analyticsEventLogger:(id)arg2;
