...
@class IDHmiAction, IDListModel, IDModel, IDProperty, IDView, IDWidgetHmiService, NSMutableDictionary, NSString;
...
@property(nonatomic) IDView *contentPreviewView; // @synthesize contentPreviewView=_contentPreviewView;
