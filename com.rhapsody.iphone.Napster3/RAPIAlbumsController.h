...
@interface RAPIAlbumsController : RAPIController <RAPIListScreenDelegate>
{
    unsigned long long _mode;
    CarIntegrationContentItem *_artist;
    NSArray *_albums;
}

@property(retain, nonatomic) NSArray *albums; // @synthesize albums=_albums;
@property(retain, nonatomic) CarIntegrationContentItem *artist; // @synthesize artist=_artist;
