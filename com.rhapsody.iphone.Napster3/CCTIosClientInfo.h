...
@class IosAccessibilityState, NSString;

@interface CCTIosClientInfo : GPBMessage
{
}
...
@property(retain, nonatomic) IosAccessibilityState *accessibilityState; // @dynamic accessibilityState;
