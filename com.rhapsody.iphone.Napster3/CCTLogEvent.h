...
@class CCTExperimentIds, CCTNetworkConnectionInfo, GPBInt32Array, NSData, NSString;

@interface CCTLogEvent : GPBMessage
{
}
...
@property(retain, nonatomic) CCTExperimentIds *experimentIds; // @dynamic experimentIds;
