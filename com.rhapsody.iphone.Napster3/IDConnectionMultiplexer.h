...
@class IDA4AConnection, IDA4APacketReaderWriterRegistry, IDA4AProxyInfo, NSConditionLock, NSString;
@protocol IDConnectionMultiplexerDelegate;

@interface IDConnectionMultiplexer : NSObject <IDA4AConnectionDelegate, IDA4APacketWriter>
{
