...
@class GCKAnalyticsEventLogger, GCKSessionManager, GCKSessionTraits, NSString, NSTimer, UISlider, UIView;

@interface GCKUIPhysicalVolumeButtonController : NSObject
{
