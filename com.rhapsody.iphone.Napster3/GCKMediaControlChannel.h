...
@interface GCKMediaControlChannel : GCKCastChannel <GCKRequestTrackerDelegate>
{
    ...
    unsigned long long _lastQueueReloadEventSequenceNumber;
...
- (double)approximateStreamTimeBasedOn:(double)arg1 possibleStartTime:(double)arg2 possibleEndTime:(double)arg3;
...
- (long long)loadMedia:(id)arg1 withOptions:(id)arg2;
