...
@interface RAPIRadioStationsForGenreController : RAPIController <RAPIListScreenDelegate>
{
    CarIntegrationContentItem *_genre;
    NSArray *_stations;
...
@property(retain, nonatomic) CarIntegrationContentItem *genre; // @synthesize genre=_genre;
- (void).cxx_destruct;
