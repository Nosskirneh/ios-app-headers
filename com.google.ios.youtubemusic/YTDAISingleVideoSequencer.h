...
@class GIMMe, NSString, YTPlaybackConfig, YTPlaybackData, YTPlayerTransition, YTPlayerView, YTSingleVideoController, YTSingleVideoControllerSet;
@protocol MLViewportSizeProvider, YTSingleVideoControllerDelegate, YTSingleVideoSequencerDelegate;

@interface YTDAISingleVideoSequencer : NSObject <YTSingleVideoControllerVideoSequencerDelegate, YTSingleVideoSequencer>
{
