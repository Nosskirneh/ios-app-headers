...
#import "YTAsyncWorker-Protocol.h"
#import "YTOfflineCoordinatorObserver-Protocol.h"
#import "YTOfflinePlaylistControllerObserver-Protocol.h"
#import "YTOfflineSchedulerServiceCommandObserver-Protocol.h"
#import "YTOfflineVideoControllerObserver-Protocol.h"
#import "YTOfflineVideoListControllerObserver-Protocol.h"

@class GIMMe, NSString, YTOfflineCoordinator, YTOfflinePlaylistController, YTOfflineVideoController, YTOfflineVideoListController;
...
- (void).cxx_destruct;
- (void)refreshStreamsForVideo:(id)arg1 workIdentifier:(unsigned long long)arg2 completionBlock:(CDUnknownBlockType)arg3 errorBlock:(CDUnknownBlockType)arg4;
- (void)maybeDownloadVideos:(id)arg1 workIdentifier:(unsigned long long)arg2 completionBlock:(CDUnknownBlockType)arg3 errorBlock:(CDUnknownBlockType)arg4;
