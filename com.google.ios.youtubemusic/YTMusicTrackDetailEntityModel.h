...
@class NSData, NSDictionary, NSString, YTIMusicTrackDetailEntity, YTMusicTrackEntityModel;
...
@interface YTMusicTrackDetailEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMusicTrackDetailEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMusicTrackDetailEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
