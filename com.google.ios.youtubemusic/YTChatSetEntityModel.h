...
@class NSArray, NSData, NSDictionary, NSString, YTIChatSetEntity, YTSocialSharingSyncTokenModel;
@protocol YTEntityStore;

@interface YTChatSetEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    NSString *_key;
    ...
    YTIChatSetEntity *_protoBuf;
}

@property(copy, nonatomic) YTIChatSetEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
- (id)copy;
- (void)chatsArrayAtIndexes:(id)arg1 callbackQueue:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
@property(readonly, nonatomic) NSArray *chatsArray;
@property(readonly, nonatomic) _Bool hasChatsArray;
