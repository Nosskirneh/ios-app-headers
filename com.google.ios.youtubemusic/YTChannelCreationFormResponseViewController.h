...
#import "YTChannelCreationFormResponderProvider-Protocol.h"
#import "YTChannelCreationFormResponseViewDelegate-Protocol.h"
#import "YTRendererController-Protocol.h"

@class GIMMe, NSDateComponents, NSDateFormatter, NSMutableArray, NSString, YTChannelCreationFormResponseView, YTDatePickerView, YTIChannelCreationFormRenderer, YTIDropdownRenderer, YTIFormattedString;
@protocol YTResponder;

@interface YTChannelCreationFormResponseViewController : UIViewController <GOOTextFieldValidator, YTChannelCreationFormResponderProvider, YTChannelCreationFormResponseViewDelegate, YTRendererController>
{
