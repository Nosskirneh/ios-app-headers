...
@class NSData, YTContactEntityModel, YTIChatMessageHeart;
@protocol YTEntityStore;

@interface YTChatMessageHeartModel : NSObject <NSCopying, NSMutableCopying>
{
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIChatMessageHeart *_protoBuf;
}

@property(copy, nonatomic) YTIChatMessageHeart *protoBuf; // @synthesize protoBuf=_protoBuf;
