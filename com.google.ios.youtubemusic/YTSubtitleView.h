...
@class NSArray, NSString, UIImageView, YTFormattedStringLabel, YTLabel;
...
@interface YTSubtitleView : UIView <GA11YMixinEmbedder, YTPageStyling, YTReusableView>
{
    ...
    YTFormattedStringLabel *_additionalLabel;
    YTFormattedStringLabel *_otherLabel;
...
@property(readonly, nonatomic) YTFormattedStringLabel *otherLabel; // @synthesize otherLabel=_otherLabel;
@property(readonly, nonatomic) YTFormattedStringLabel *additionalLabel; // @synthesize additionalLabel=_additionalLabel;
@property(readonly, nonatomic) YTFormattedStringLabel *viewCountLabel; // @synthesize viewCountLabel=_viewCountLabel;
@property(readonly, nonatomic) YTFormattedStringLabel *bylineLabel; // @synthesize bylineLabel=_bylineLabel;
