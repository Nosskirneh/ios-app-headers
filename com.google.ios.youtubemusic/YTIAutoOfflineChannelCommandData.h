...
@interface YTIAutoOfflineChannelCommandData : GPBMessage
{
}
...
@property(nonatomic) _Bool hasMostRecentPublishedTimestamp; // @dynamic hasMostRecentPublishedTimestamp;
@property(nonatomic) unsigned long long mostRecentPublishedTimestamp; // @dynamic mostRecentPublishedTimestamp;
