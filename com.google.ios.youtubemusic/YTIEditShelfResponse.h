...
@class NSMutableArray, YTIResponseContext, YTIShelfEditorSupportedRenderers;

@interface YTIEditShelfResponse : GPBMessage
{
}
...
@property(nonatomic) _Bool hasShelfEditor; // @dynamic hasShelfEditor;
@property(retain, nonatomic) YTIResponseContext *responseContext; // @dynamic responseContext;
@property(retain, nonatomic) YTIShelfEditorSupportedRenderers *shelfEditor; // @dynamic shelfEditor;
