...
@class GPCPromise, NSArray, NSDate, NSDictionary, NSNumber, NSString, PDLAutocompletion;

@protocol PDLTopNCache
@property(readonly) long long autocompletionsCount;
@property(nonatomic) _Bool openAutomaticallyIfClosed;
@property(nonatomic) _Bool containsPartialResults;
@property(readonly, nonatomic) long long cacheSyncState;
@property(readonly, nonatomic) NSDate *lastModifiedDate;
@property(retain, nonatomic) NSNumber *latestAffinityThreshold;
