...
@class NSData, YTIChatSetPageData;
@protocol YTEntityStore;

@interface YTChatSetPageDataModel : NSObject <NSCopying, NSMutableCopying>
{
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIChatSetPageData *_protoBuf;
}

@property(copy, nonatomic) YTIChatSetPageData *protoBuf; // @synthesize protoBuf=_protoBuf;
