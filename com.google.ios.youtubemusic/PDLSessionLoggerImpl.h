...
@protocol CCTClearcutLogger, GSCAddressBookService, OS_dispatch_queue, PDLClientInfoProvider, PDLTopNCache;
...
- (id)initWithRegistryContext:(id)arg1 cacheService:(id)arg2 clientConfig:(id)arg3 sessionContext:(id)arg4;
