...
@class YTIInvalidationContinuationData, YTINextContinuationData, YTIReloadContinuationData;

@interface YTIConversationSwitcherSectionSupportedContinuations : GPBMessage
{
}
