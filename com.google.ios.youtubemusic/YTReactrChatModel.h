...
@class NSData, NSString, YTIReactrChat;
@protocol YTEntityStore;

@interface YTReactrChatModel : NSObject <NSCopying, NSMutableCopying>
{
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIReactrChat *_protoBuf;
}

@property(copy, nonatomic) YTIReactrChat *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(readonly, nonatomic) NSString *chatEntityKey;
@property(readonly, nonatomic) NSString *conversationParams;
- (id)init;
