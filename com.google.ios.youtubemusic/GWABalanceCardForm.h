...
#import "GWABalanceCardViewDelegate-Protocol.h"
#import "GWAFlowSection-Protocol.h"
#import "GWAForm-Protocol.h"

@class GWABalanceCardView, GWAComponentGroup, GWADependencyGraph, GWAFlowContext, NSArray, NSString, OrchBalanceCard, UIColor, UIImage;
...
- (void).cxx_destruct;
- (void)balanceCardView:(id)arg1 linkTapped:(id)arg2;
...
- (id)value;
- (id)initWithBalanceCard:(id)arg1 context:(id)arg2;
