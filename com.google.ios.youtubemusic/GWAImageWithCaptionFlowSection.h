...
@class GWAComponentGroup, GWAImageWithCaptionView, NSArray, NSString, UIColor, UIImage;
@protocol GWACardComponentDelegate, GWAFlowSectionDelegate;

@interface GWAImageWithCaptionFlowSection : NSObject <GWAFlowSection, GWADependencyGraphComponent>
{
