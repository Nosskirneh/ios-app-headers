...
#import "YTFirstTimeSignInViewControllerDelegate-Protocol.h"

@class GIMMe, NSString, YTFirstTimeSignInViewController, YTGaiaIdentityService, YTIdentityTransaction, YTInlineSignInController;
