...
@property(nonatomic) _Bool acceptedPermissionsDialog; // @dynamic acceptedPermissionsDialog;
...
@property(nonatomic) _Bool hasAcceptedPermissionsDialog; // @dynamic hasAcceptedPermissionsDialog;
...
@property(nonatomic) _Bool hasUsingFcm; // @dynamic hasUsingFcm;
...
@property(nonatomic) _Bool usingFcm; // @dynamic usingFcm;
