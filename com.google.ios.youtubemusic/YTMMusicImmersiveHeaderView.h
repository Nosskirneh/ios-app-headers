...
@class CAGradientLayer, MDCInkTouchController, NSMutableArray, NSString, QTMButton, UILabel, UITapGestureRecognizer, UIView, YTFormattedStringLabel, YTIButtonRenderer, YTIFormattedString, YTIHeaderFabRenderer, YTIMenuRenderer, YTIMusicThumbnailRenderer, YTISubscribeButtonRenderer, YTIToggleButtonRenderer, YTMBevelView, YTMMusicThumbnailView, YTMResizeableFabView, YTNotificationMultiToggleButton, YTNotificationOptionsButton, YTNotificationPreferenceToggleButton, YTSubscribeSwitch, YTViewGroup;
...
@interface YTMMusicImmersiveHeaderView : YTMFlexibleHeaderBackgroundView <YTSubscribeSwitchContainer>
{
    ...
    _Bool _specialtyButtonsAtBottom;
...
- (void)setSpecialtyButtonsAtBottom:(_Bool)arg1;
