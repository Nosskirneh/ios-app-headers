...
{
    YTApiaryResourceParser *_createPersonaResponseParser;
...
- (void)makeCreatePersonaRequestWithIdentityID:(id)arg1 givenName:(id)arg2 day:(int)arg3 month:(int)arg4 year:(int)arg5 avatar:(id)arg6 clickTrackingParams:(id)arg7 innerTubeResponseBlock:(CDUnknownBlockType)arg8 errorBlock:(CDUnknownBlockType)arg9;
- (id)init;
