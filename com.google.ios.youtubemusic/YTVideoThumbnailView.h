...
@class NSString, UIImageView, YTBadge, YTBadgesView, YTFormattedStringLabel, YTImageView, YTProgressView, YTVideoThumbnailClientStatusIndicatorView;
@protocol GA11YMixinImpl, YTVideoViewModel;

@interface YTVideoThumbnailView : UIView <GA11YMixinEmbedder, YTImageViewContainer, YTPageStyling, YTReusableView, YTWatchTransitionViewProtocol>
{
