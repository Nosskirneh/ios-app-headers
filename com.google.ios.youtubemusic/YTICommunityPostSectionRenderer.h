...
@class NSData, YTIButtonSupportedRenderers, YTICommunityPostSectionHintSupportedRenderers, YTIFormattedString;
...
@property(retain, nonatomic) YTICommunityPostSectionHintSupportedRenderers *hint; // @dynamic hint;
