...
@class NSData, NSString, YTIImageAttachmentSource;
...
@interface YTImageAttachmentSourceModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIImageAttachmentSource *_protoBuf;
}

@property(copy, nonatomic) YTIImageAttachmentSource *protoBuf; // @synthesize protoBuf=_protoBuf;
