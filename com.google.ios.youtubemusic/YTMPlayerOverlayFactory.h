...
@class GIMMe, NSString, YTMNowPlayingViewController;

@interface YTMPlayerOverlayFactory : NSObject <YTPlayerOverlayFactory>
{
...
- (id)initWithNowPlayingViewController:(id)arg1;
