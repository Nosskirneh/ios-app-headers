...
@class GWAComponentGroup, GWAPhoneFieldView, NSArray, NSString, OrchPhoneForm, UIColor, UIImage;
@protocol GWACardComponentDelegate, GWAFlowSectionDelegate;

@interface GWAPhoneFormFlowSection : NSObject <GOOTextFieldValidator, GWAFlowSection>
{
