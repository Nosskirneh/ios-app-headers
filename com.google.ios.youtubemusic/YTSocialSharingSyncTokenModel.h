...
@class NSData, NSString, YTISocialSharingSyncToken;
@protocol YTEntityStore;

@interface YTSocialSharingSyncTokenModel : NSObject <NSCopying, NSMutableCopying>
{
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTISocialSharingSyncToken *_protoBuf;
}

@property(copy, nonatomic) YTISocialSharingSyncToken *protoBuf; // @synthesize protoBuf=_protoBuf;
