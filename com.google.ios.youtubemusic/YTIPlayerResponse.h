...
@class NSData, NSMutableArray, NSString, YTIAdSafetyExperienceReason, YTIAttestationSupportedRenderers, YTICaptionsSupportedRenderers, YTIEndscreenSupportedRenderers, YTIHeartbeatParams, YTIInStreamPlayerCtaAdsSupportedRenderers, YTIInfoCardsSupportedRenderers, YTIOfflineState, YTIPaidContentOverlaySupportedRenderers, YTIPlayabilityStatus, YTIPlaybackTracking, YTIPlayerCompanionAdsSupportedRenderers, YTIPlayerConfig, YTIPlayerControlsOverlaySupportedRenderers, YTIRenderer, YTIResponseContext, YTIStoryboardsSupportedRenderers, YTIStreamingData, YTISurveySupportedRenderers, YTISurveysSupportedRenderers, YTIVideoDetails, YTIVideoQualityPromoSupportedRenderers;
...
@property(nonatomic) _Bool hasSurveys; // @dynamic hasSurveys;
...
@property(retain, nonatomic) YTISurveysSupportedRenderers *surveys; // @dynamic surveys;
