...
@property(nonatomic) _Bool hasPausedIcon; // @dynamic hasPausedIcon;
...
@property(nonatomic) _Bool hasPlayingIcon; // @dynamic hasPlayingIcon;
@property(nonatomic) _Bool hasTrackingParams; // @dynamic hasTrackingParams;
@property(nonatomic) _Bool hasUsePausedEqualizer; // @dynamic hasUsePausedEqualizer;
@property(nonatomic) _Bool hasUsePlayingEqualizer; // @dynamic hasUsePlayingEqualizer;
