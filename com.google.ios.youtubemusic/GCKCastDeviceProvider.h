...
@class GCKAnalyticsEventLogger, GCKBLEScanner, GCKCastDeviceMDNSScanner, GCKCastDevicePublisher, GCKCastOptions, GCKDatabase, GCKDiscoveryCriteria, GCKNNetworkReachability, GCKRuntimeConfiguration, NSArray, NSString;
