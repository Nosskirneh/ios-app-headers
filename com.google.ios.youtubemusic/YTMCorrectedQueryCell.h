...
@protocol YTCorrectedQuery, YTResponder;

@interface YTMCorrectedQueryCell : YTCollectionViewCell <YTFormattedStringLabelDelegate, YTCollectionViewCellProtocol, YTResponder>
{
