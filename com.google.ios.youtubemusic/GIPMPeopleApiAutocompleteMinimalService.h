...
#import "GIPMPeopleApiAutocompleteMinimalService-Protocol.h"
...
@interface GIPMPeopleApiAutocompleteMinimalService : FCDRPCService <SRLService, GIPMPeopleApiAutocompleteMinimalService>
{
    FCDRPC *_listAutocompletionsRPC;
}
...
+ (id)servicePackage;
+ (id)serviceName;
@property(readonly, nonatomic) FCDRPC *listAutocompletionsRPC; // @synthesize listAutocompletionsRPC=_listAutocompletionsRPC;
- (void).cxx_destruct;
