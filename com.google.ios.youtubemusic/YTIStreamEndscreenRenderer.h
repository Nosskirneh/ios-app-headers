...
@property(nonatomic) _Bool hasVideoClipCollection; // @dynamic hasVideoClipCollection;
...
@property(retain, nonatomic) YTIRenderer *videoClipCollection; // @dynamic videoClipCollection;
