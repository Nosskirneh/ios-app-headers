...
@class GCKAdBreakClipVastAdsRequest, NSString, NSURL;
...
@interface GCKAdBreakClipInfo : NSObject <NSCopying, NSSecureCoding>
{
    ...
    GCKAdBreakClipVastAdsRequest *_vastAdsRequest;
    id _customData;
}

+ (_Bool)supportsSecureCoding;
@property(retain, nonatomic) id customData; // @synthesize customData=_customData;
@property(retain, nonatomic) GCKAdBreakClipVastAdsRequest *vastAdsRequest; // @synthesize vastAdsRequest=_vastAdsRequest;
