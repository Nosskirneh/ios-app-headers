...
@class NSData, NSDictionary, NSString, YTIMusicPlaylistEntryCollectionEntity, YTMusicPlaylistEntityModel;
...
@interface YTMusicPlaylistEntryCollectionEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMusicPlaylistEntryCollectionEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMusicPlaylistEntryCollectionEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
