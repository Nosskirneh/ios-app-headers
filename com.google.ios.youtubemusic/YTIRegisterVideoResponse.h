...
@class NSString, YTIRegisterVideoResponseSupportedRenderers, YTIResponseContext;

@interface YTIRegisterVideoResponse : GPBMessage
{
}
...
@property(retain, nonatomic) YTIRegisterVideoResponseSupportedRenderers *contents; // @dynamic contents;
