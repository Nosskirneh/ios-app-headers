...
@class NSData, NSDictionary, NSString, YTIMusicArtistDetailEntity, YTMusicArtistEntityModel;
...
@interface YTMusicArtistDetailEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMusicArtistDetailEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMusicArtistDetailEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
