...
@interface FixFlowFixFlowParameters : GPBMessage
{
}
...
@property(copy, nonatomic) NSString *checkoutRecurrenceId; // @dynamic checkoutRecurrenceId;
...
@property(nonatomic) _Bool hasCheckoutRecurrenceId; // @dynamic hasCheckoutRecurrenceId;
