...
@class NSData, YTAccessibilityDataModel, YTIAccessibilitySupportedDatas;
...
@interface YTAccessibilitySupportedDatasModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    YTAccessibilityDataModel *_accessibilityData;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIAccessibilitySupportedDatas *_protoBuf;
}

@property(copy, nonatomic) YTIAccessibilitySupportedDatas *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTAccessibilityDataModel *accessibilityData; // @synthesize accessibilityData=_accessibilityData;
- (void).cxx_destruct;
