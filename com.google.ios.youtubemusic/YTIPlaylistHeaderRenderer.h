...
@property(nonatomic) _Bool hasShufflePlayButton; // @dynamic hasShufflePlayButton;
@property(nonatomic) _Bool hasShufflePlayEndpoint; // @dynamic hasShufflePlayEndpoint;
