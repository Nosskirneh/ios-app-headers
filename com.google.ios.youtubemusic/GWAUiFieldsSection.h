...
@interface GWAUiFieldsSection : NSObject <GOOTextFieldValidator, GWADependencyGraphComponent, GWAFocusDelegate, GWASelectFieldViewDelegate, GWASummaryViewDelegate, GWAUIFieldDelegate, GWAFlowSection>
{
    NSArray *_fields;
