...
@class NSData, YTIBackstageAccessRestrictionsSupportedRenderers, YTIBackstageAttachmentSupportedRenderers, YTIBackstageImageCreationSupportedRenderers, YTIBackstageVideoLinkSupportedRenderers, YTIButtonSupportedRenderers, YTICommand, YTIFormattedString, YTILoggingDirectives, YTIPollCreationSupportedRenderers, YTIPollEditorInfo, YTIPrefilledImageData, YTIRenderer, YTIThumbnailDetails;

@interface YTIBackstagePostDialogRenderer : GPBMessage
{
}
...
@property(nonatomic) _Bool hasPrefilledType; // @dynamic hasPrefilledType;
...
@property(nonatomic) int prefilledType; // @dynamic prefilledType;
