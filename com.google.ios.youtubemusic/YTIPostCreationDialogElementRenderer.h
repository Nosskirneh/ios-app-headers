...
@class NSData, NSString, YTIFormattedString, YTILoggingDirectives, YTIPostCreationDialogElementsCompatibility, YTIRenderer, YTIThumbnailDetails;

@interface YTIPostCreationDialogElementRenderer : GPBMessage
{
}
