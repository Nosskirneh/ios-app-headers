...
@interface YTInvalidationIdModel : NSObject <NSCopying, NSMutableCopying>
{
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIInvalidationId *_protoBuf;
}

@property(copy, nonatomic) YTIInvalidationId *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(readonly, nonatomic) long long protoCreationTimestampMs;
@property(readonly, nonatomic) _Bool hasProtoCreationTimestampMs;
@property(readonly, nonatomic) _Bool subscribeToGcmTopics;
@property(readonly, nonatomic) _Bool hasSubscribeToGcmTopics;
@property(readonly, nonatomic) NSString *topic;
@property(readonly, nonatomic) NSData *objectId;
@property(readonly, nonatomic) int objectSource;
@property(readonly, nonatomic) _Bool hasObjectSource;
- (id)init;
