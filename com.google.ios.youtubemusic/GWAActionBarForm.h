...
#import "GWAActionBarViewDelegate-Protocol.h"
...
@class GWAActionBarView, GWAComponentGroup, GWADependencyGraph, GWAFlowContext, NSArray, NSMutableArray, NSString, OrchActionBar, UIColor, UIImage;
...
- (void).cxx_destruct;
- (void)actionBarView:(id)arg1 linkTapped:(id)arg2;
...
- (id)value;
- (id)initWithActionBar:(id)arg1 context:(id)arg2;
