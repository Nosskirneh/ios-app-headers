...
#import "YTPlayerOverlayViewController.h"
...
@class GIMMe, MLNerdStatsOverlayViewController, MLNerdStatsPlaybackData, NSError, NSString, UIViewController, YTCPN, YTCaptionTrackSwitchController, YTCaptionViewController, YTHotConfig, YTIMenuRenderer, YTIPlayerOverflowRenderer, YTIReportFormModalRenderer, YTNoSoundMemoViewController, YTOverflowMenuViewController, YTPlayerOverflowRendererController, YTPlayerResponse, YTVEVisibilityUpdateResponderEventGate, YTVideoPlayerOverlayView;
@protocol YTCaptionsVisibilityResponderProvider, YTDataServices, YTInfoCardDrawerOverlayProtocol, YTInfoCardTeaserOverlayProtocol, YTOfflineModeProvider, YTPlayerOverlayDelegate, YTPlayerServices, YTVideoPlayerOverlayConfig, YTVideoPlayerOverlayDelegate;

@interface YTVideoPlayerOverlayViewController : YTPlayerOverlayViewController <MLNerdStatsOverlayViewControllerDelegate, YTCaptionTrackSwitchDelegate, YTLegalReportMediaTimeResponderProvider, YTOfflineModeObserver, YTOverflowMenuViewControllerDelegate, YTPlaybackRouteButtonVisibilityObserver, YTAudioTrackSwitchUIObserver, YTInfoCardDrawerOverlayDelegate, YTPlayerOverflowInfoProvider, YTPlayerViewLayoutProtocol, YTVideoPlayerOverlayProtocol, YTVideoQualitySwitchUIObserver>
{
...
- (_Bool)isErrorRecoverable:(id)arg1;
...
@property(readonly, nonatomic) YTVideoPlayerOverlayView *videoPlayerOverlayView;
