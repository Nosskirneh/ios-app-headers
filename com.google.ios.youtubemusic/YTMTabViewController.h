...
@class GIMMe, NSError, NSMutableArray, NSString, UIScrollView, YTISingleColumnBrowseResultsRenderer, YTMBaseInnerTubeViewController, YTMInnerTubeControllerFactory, YTMTabHeaderViewController, YTMTabView;
@protocol YTInnerTubeUIService, YTLightweightScrollableDelegate, YTResponder;

@interface YTMTabViewController : UIViewController <UIScrollViewDelegate, YTLightweightScrollable, YTLightweightScrollableDelegate, YTLikeServiceObserver, YTPlaylistServiceObserver, YTMTabHeaderViewControllerDelegate, YTMTabViewDelegate, YTTopScrolling, YTResponseViewController>
{
    ...
    _Bool _tabsVisible;
    _Bool _viewVisible;
    _Bool _likesNeedRefresh;
    id <YTResponder> _likesViewController;
...
- (void)updateLikesAndRefreshNow:(_Bool)arg1;
