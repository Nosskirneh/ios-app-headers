...
+ (id)libraryTabClingFromViewController:(id)arg1 targetView:(id)arg2 firstResponder:(id)arg3;
...
+ (id)likesTabClingFromViewController:(id)arg1 targetView:(id)arg2 firstResponder:(id)arg3;
