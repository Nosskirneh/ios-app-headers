...
@class NSData, NSDictionary, NSString, YTIMusicArtistUserDetailEntity, YTMusicArtistEntityModel;
...
@interface YTMusicArtistUserDetailEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMusicArtistUserDetailEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMusicArtistUserDetailEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
- (id)copy;
- (void)parentArtistWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
