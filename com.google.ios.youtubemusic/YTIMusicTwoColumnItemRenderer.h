...
@class NSData, NSMutableArray, YTIAccessibilitySupportedDatas, YTICommand, YTIFormattedString, YTIIosClientOfflineData, YTIMusicOfflineItemData, YTIMusicPlaylistItemData, YTIRenderer;
...
+ (id)ytm_musicTwoColumnItemRendererWithOfflineVideo:(id)arg1 playlistId:(id)arg2 isAlbum:(_Bool)arg3 index:(long long)arg4 explicitOfflineEnabled:(_Bool)arg5 nowPlayingIndicatorEnabled:(_Bool)arg6;
+ (id)ytm_musicTwoColumnItemRendererForAlbumWithOfflineVideo:(id)arg1 playlistId:(id)arg2 index:(long long)arg3 explicitOfflineEnabled:(_Bool)arg4 nowPlayingIndicatorEnabled:(_Bool)arg5;
+ (id)ytm_musicTwoColumnItemRendererForPlaylistWithOfflineVideo:(id)arg1 playlistId:(id)arg2 index:(long long)arg3 explicitOfflineEnabled:(_Bool)arg4 nowPlayingIndicatorEnabled:(_Bool)arg5;
+ (id)ytm_musicTwoColumnRendererWithOfflinePlaylist:(id)arg1 useWatchEndpoint:(_Bool)arg2 shuffleEnabled:(_Bool)arg3 nowPlayingIndicatorEnabled:(_Bool)arg4;
