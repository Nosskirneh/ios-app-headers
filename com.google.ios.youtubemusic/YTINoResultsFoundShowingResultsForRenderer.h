...
@property(nonatomic) _Bool hasNoResultsFound; // @dynamic hasNoResultsFound;
...
@property(retain, nonatomic) YTIFormattedString *noResultsFound; // @dynamic noResultsFound;
