...
#import "GWAUiFieldsView.h"

@class GWAUiFieldDateFieldView, GWAUiFieldTextFieldView, NSString, OrchDate, OrchTooltip;

@interface GWACreditCardMetadataFieldView : GWAUiFieldsView
{
    OrchDate *_minDate;
    OrchDate *_maxDate;
