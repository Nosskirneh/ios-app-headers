...
@class NSData, NSMutableArray, YTIAccessibilitySupportedDatas, YTICommand, YTIMusicPlaylistItemData, YTIRenderer;
...
+ (id)descriptor;
+ (id)ytm_enumNameForDisplayStyle:(int)arg1;
- (id)ytm_getSubtitleFromFlexColumns;
- (id)ytm_getTitleFromFlexColumns;
