...
@interface YTAddFromPhonebookLinkModel : NSObject <NSCopying, NSMutableCopying>
{
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIAddFromPhonebookLink *_protoBuf;
}

@property(copy, nonatomic) YTIAddFromPhonebookLink *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(readonly, nonatomic) NSString *serializedPermissionEndpoint;
- (id)init;
