...
@property(retain, nonatomic) NSMutableArray *feedbackResponsesArray; // @dynamic feedbackResponsesArray;
@property(readonly, nonatomic) unsigned long long feedbackResponsesArray_Count; // @dynamic feedbackResponsesArray_Count;
