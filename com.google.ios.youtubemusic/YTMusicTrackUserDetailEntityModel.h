...
@class NSData, NSDictionary, NSString, YTIMusicTrackUserDetailEntity, YTMusicTrackEntityModel;
...
@interface YTMusicTrackUserDetailEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMusicTrackUserDetailEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMusicTrackUserDetailEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
- (id)copy;
- (void)parentTrackWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
