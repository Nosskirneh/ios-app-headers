...
@class GWABinRange, GWABinRangeMatcher, GWAComponentGroup, GWACreditCardMetadataFieldView, GWACreditCardTextFieldView, GWACreditCardType, GWAFlowContext, GWAPANFormatter, NSArray, NSMutableDictionary, NSString, OrchCreditCardForm, QTMButton, UIColor, UIImage;
@protocol GWACardComponentDelegate, GWAFlowSectionDelegate, NSCopying;

@interface GWACreditCardFormFlowSection : NSObject <GOOTextFieldValidator, GWACardScanningViewControllerDelegate, GWAFocusDelegate, GWASummaryViewDelegate, GWACollapsibleFlowSection>
{
