...
@class GRWMessage, GRWMessagingRichCardViewController, MDCDialogTransitionController, NSString;

@interface GRWMessagingDisplayRichDialog : NSObject <GRWMessagingContentControllerDelegate, GRWDismissablePresentedViewController, GRWMessagingDisplayPresentation>
{
