...
@class MLHLSRemotePlaylist, NSArray, YTIAudioTrack;
...
+ (id)buildMasterPlaylistWithPlaylists:(id)arg1 mediaTags:(id)arg2 initialPlaylist:(id)arg3 defaultAudioTrack:(id)arg4 hasIndependentSegments:(_Bool)arg5;
+ (id)masterPlaylistByPairingStreams:(id)arg1 videoToAudioItagMap:(id)arg2 captionTrackLanguageToURLMap:(id)arg3 hasIndependentSegments:(_Bool)arg4 error:(id *)arg5;
...
- (id)initWithRemotePlaylists:(id)arg1 mediaTags:(id)arg2 hasIndependentSegments:(_Bool)arg3;
