...
@class NSData, NSDictionary, NSString, YTChannelEntityModel, YTIVideoEntity, YTThumbnailDetailsModel;
...
@interface YTVideoEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIVideoEntity *_protoBuf;
}

@property(copy, nonatomic) YTIVideoEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
