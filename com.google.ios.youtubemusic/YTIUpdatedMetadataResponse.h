...
@class NSMutableArray, YTIResponseContext, YTIUpdatedMetadataSupportedContinuations;
...
@property(retain, nonatomic) YTIUpdatedMetadataSupportedContinuations *continuation; // @dynamic continuation;
