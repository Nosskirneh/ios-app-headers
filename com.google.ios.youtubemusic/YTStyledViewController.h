...
#import "YTTitleControlResponderProvider-Protocol.h"
#import "YTTopController-Protocol.h"

@class GIMMe, NSHashTable, NSString, UIButton, YTInteractionLoggingProxyButton, YTNavigationBarTitleView;
@protocol YTColorStyle, YTCommonButton, YTLayoutStyle, YTResponder;
...
@interface YTStyledViewController : YTMultiSizeViewController <YTResponder, YTTopController, YTTitleControlResponderProvider>
{
    ...
    UIButton<YTCommonButton> *_titleButton;
