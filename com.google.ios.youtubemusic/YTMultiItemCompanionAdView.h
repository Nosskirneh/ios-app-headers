...
@class FLXLayout, NSString, UIButton, YTBadge, YTFormattedStringLabel, YTMultiItemCompanionAdFiveProductsView, YTMultiItemCompanionAdFourProductsView, YTMultiItemCompanionAdOneProductView, YTMultiItemCompanionAdThreeProductsView, YTMultiItemCompanionAdTwoProductsView;
@protocol YTCommonButton, YTMultiItemCompanionAdProductView;
...
@property(readonly, nonatomic) UIButton<YTCommonButton> *actionButton; // @synthesize actionButton=_actionButton;
- (void).cxx_destruct;
