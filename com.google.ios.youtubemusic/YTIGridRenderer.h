...
@class NSData, NSMutableArray, YTICommand, YTIFormattedString, YTIGridColumnOverrideData, YTIGridStyle;
...
@property(nonatomic) _Bool hasVisibleRowCount; // @dynamic hasVisibleRowCount;
