...
@class NSArray, NSData, NSDictionary, NSString, YTIChatMessageSetEntity, YTSocialSharingSyncTokenModel;
@protocol YTEntityStore;

@interface YTChatMessageSetEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    NSString *_key;
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    YTSocialSharingSyncTokenModel *_pageToken;
    NSData *_data;
    NSDictionary *_metadata;
    id <YTEntityStore> _entityStore;
    YTIChatMessageSetEntity *_protoBuf;
}

@property(copy, nonatomic) YTIChatMessageSetEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTSocialSharingSyncTokenModel *pageToken; // @synthesize pageToken=_pageToken;
- (void).cxx_destruct;
...
- (id)copy;
- (void)messagesArrayAtIndexes:(id)arg1 callbackQueue:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
@property(readonly, nonatomic) NSArray *messagesArray;
@property(readonly, nonatomic) _Bool hasMessagesArray;
