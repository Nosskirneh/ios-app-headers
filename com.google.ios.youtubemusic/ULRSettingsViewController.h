...
@class GOONavigationStyle, NSSet, NSString, SSOIdentity, SSOService, UIScrollView, UIView, ULRManager, ULRSettings;
@protocol ULRSettingsDelegate;
...
@property(readonly, nonatomic) SSOIdentity *signedInIdentity; // @synthesize signedInIdentity=_signedInIdentity;
