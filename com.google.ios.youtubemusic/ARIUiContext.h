...
@class ARIRenderingServerData, ARITextDetails, NSString;
...
@property(nonatomic) _Bool hasRenderingServerData; // @dynamic hasRenderingServerData;
...
@property(retain, nonatomic) ARIRenderingServerData *renderingServerData; // @dynamic renderingServerData;
