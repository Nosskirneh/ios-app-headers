...
#import "GSCImageAnimatorDelegate-Protocol.h"

@class CALayer, GSCImageAnimator, GSCImageCacheItem, GSCImageIconSpec, GSCImageUrl, GSCImageUrlOptions, UIImage;
...
@property(readonly, nonatomic) int loadingState; // @synthesize loadingState=_loadingState;
...
- (void)loadVideoThumbnailForAVAsset:(id)arg1 requestSize:(struct CGSize)arg2 forLocalAssetUrl:(id)arg3;
