...
#import "GSCSingleForegroundAccountsService-Protocol.h"
#import "SRLConfigurableService-Protocol.h"

@class GOOAccountScopedProvider, NSMutableDictionary, NSMutableOrderedSet, NSString, PHSBroadcast;
@protocol GSCAccountId, GSCAccountsExternalSource, GSCAccountsStorageService, OS_dispatch_queue;

@interface GSCSingleForegroundAccountsService : NSObject <SRLConfigurableService, GSCAccountsExternalSourceDelegate, GSCAccountsService, GSCSingleForegroundAccountsService>
{
    long long _previousForegroundAccountAction;
    NSMutableDictionary *_accountsDict;
    id <GSCAccountId> _foregroundAccountId;
    ...
    GOOAccountScopedProvider *_wipeoutHandlersProvider;
...
- (void)invokeDeletionHandlersForAccountWithId:(id)arg1;
- (id)invokeDeactivationHandlersForAccountWithId:(id)arg1;
...
- (id)initWithAccountsExternalSource:(id)arg1 accountsStorageService:(id)arg2 accountWipeoutHandlersProvider:(id)arg3 options:(id)arg4;
