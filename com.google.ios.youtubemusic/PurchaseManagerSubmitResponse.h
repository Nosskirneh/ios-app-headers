...
@class NSData, NSString, OrchIntegratorCallbackData, OrchLoadTarget, OrchResponseContext, OrchSecureDataHeader, OrchUiError, PurchaseManagerPage;
...
@property(retain, nonatomic) PurchaseManagerPage *nextPage; // @dynamic nextPage;
