...
@class NSData, YTICommentRepliesResponseSupportedRenderers, YTIContinuationSupportedRenderers, YTIResponseContext;
...
@property(retain, nonatomic) YTICommentRepliesResponseSupportedRenderers *contents; // @dynamic contents;
