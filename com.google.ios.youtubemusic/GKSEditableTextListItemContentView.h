...
@class GKSTitleIconListItemView, GOOTextField, NSString, UILabel, UIView;
@protocol GKSEditableTextListItemContentViewDelegate;

@interface GKSEditableTextListItemContentView : GOOBaseContentView <GOOTextFieldValidator>
{
