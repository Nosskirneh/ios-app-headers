...
@class NSData, NSDictionary, NSString, YTIMusicPlaylistUserDetailEntity, YTMusicPlaylistEntityModel;
...
@interface YTMusicPlaylistUserDetailEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMusicPlaylistUserDetailEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMusicPlaylistUserDetailEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
