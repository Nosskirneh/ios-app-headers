...
@class NSData, NSMutableArray, NSString, YTICommand, YTIFormattedString, YTILikeButtonSupportedRenderers, YTIMainAppCompactRendererStyle, YTIMenuSupportedRenderers, YTIThumbnailDetails;

@interface YTICompactRadioRenderer : GPBMessage
{
}
