...
@class NSData, NSMutableArray, YTIActiveViewDisplayMeasurement, YTIPromotedSparklesTextSearchContent, YTIRenderer;
...
@property(retain, nonatomic) YTIPromotedSparklesTextSearchContent *content; // @dynamic content;
