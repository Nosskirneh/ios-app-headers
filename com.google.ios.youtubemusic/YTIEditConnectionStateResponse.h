...
@class NSMutableArray, NSString, YTIItemSectionContactUpdateSupportedRenderers, YTIResponseContext;

@interface YTIEditConnectionStateResponse : GPBMessage
{
}
...
@property(nonatomic) _Bool hasReplacementRenderer; // @dynamic hasReplacementRenderer;
@property(nonatomic) _Bool hasResponseContext; // @dynamic hasResponseContext;
@property(retain, nonatomic) YTIItemSectionContactUpdateSupportedRenderers *replacementRenderer; // @dynamic replacementRenderer;
