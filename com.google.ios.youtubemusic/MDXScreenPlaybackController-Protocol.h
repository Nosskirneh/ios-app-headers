...
@class MDXAdSessionState, NSArray, NSString, YTIAudioTrack;
@protocol MLCaptionTrack;

@protocol MDXScreenPlaybackController <NSObject>
@property(readonly, nonatomic) NSString *currentCaptionTrackVSSID;
...
- (void)setCaptionTrack:(id <MLCaptionTrack>)arg1 withStyle:(NSString *)arg2 forVideoID:(NSString *)arg3;
