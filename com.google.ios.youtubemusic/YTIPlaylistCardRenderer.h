...
@class NSData, NSMutableArray, YTICommand, YTIFormattedString, YTIMenuSupportedRenderers, YTIPlaylistThumbnailSupportedRenderers;

@interface YTIPlaylistCardRenderer : GPBMessage
{
}
