...
@class NSData, NSMutableArray, NSString, YTIAssociatedGameSupportedRenderers, YTICommand, YTICompactChannelSubscribeButtonSupportedRenderers, YTIFormattedString, YTIKidsTileDisplayExtension, YTIMainAppCompactRendererStyle, YTIMenuSupportedRenderers, YTISubscriptionButton, YTIThumbnailDetails;
