...
@class NSData, NSMutableArray, NSString, YTILiveChatActionPanelSupportedRenderers, YTILiveChatHeaderSupportedRenderers, YTILiveChatItemListSupportedRenderers, YTILiveChatParticipantsListSupportedRenderers, YTILiveChatPopoutMessageSupportedRenderers, YTILiveChatPromoSupportedRenderers, YTILiveChatRendererClientMessages, YTILiveChatTickerSupportedRenderers, YTIRenderer;

@interface YTILiveChatRenderer : GPBMessage
{
}
...
@property(retain, nonatomic) YTILiveChatPromoSupportedRenderers *promo; // @dynamic promo;
