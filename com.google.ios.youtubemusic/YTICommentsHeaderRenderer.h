...
@class NSData, NSMutableArray, NSString, YTICommentClusterListSupportedRenderers, YTICommentCreationSupportedRenderers, YTICommentSectionSubMenuSupportedRenderers, YTIFormattedString, YTILoggingDirectives, YTIRenderer;

@interface YTICommentsHeaderRenderer : GPBMessage <YTInnerTubeSectionHeaderRenderer>
{
}
...
@property(retain, nonatomic) YTICommentClusterListSupportedRenderers *commentClusterList; // @dynamic commentClusterList;
...
@property(nonatomic) _Bool ghostCardsEnabledOnEmpty; // @dynamic ghostCardsEnabledOnEmpty;
@property(nonatomic) _Bool hasBatchActionBar; // @dynamic hasBatchActionBar;
@property(nonatomic) _Bool hasCommentClusterList; // @dynamic hasCommentClusterList;
...
@property(nonatomic) _Bool hasGhostCardsEnabledOnEmpty; // @dynamic hasGhostCardsEnabledOnEmpty;
