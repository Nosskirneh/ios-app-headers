...
@class NSArray, NSString, UIButton, UIImageView, YTBadge, YTFormattedStringLabel, YTQTMButton, YTShoppingCompanionAdRegularOneProductView, YTShoppingCompanionAdRegularThreeOrMoreProductsView, YTShoppingCompanionAdRegularTwoProductsView;
@protocol YTCommonButton, YTShoppingCompanionAdProductView;
...
@interface YTShoppingCompanionAdView : UIView <YTPageStyling, YTReusableView>
{
    ...
    UIButton<YTCommonButton> *_sponsoredButton;
}

@property(readonly, nonatomic) UIButton<YTCommonButton> *sponsoredButton; // @synthesize sponsoredButton=_sponsoredButton;
