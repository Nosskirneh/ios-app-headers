...
@class YTIButtonSupportedRenderers, YTICommand, YTIFormattedString;

@interface YTIAnalyticsBulletsRenderer_BulletPoint : GPBMessage
{
}
...
@property(retain, nonatomic) YTIButtonSupportedRenderers *bulletButton; // @dynamic bulletButton;
@property(nonatomic) _Bool hasBulletButton; // @dynamic hasBulletButton;
