...
@class GWAComponentGroup, GWAUiFieldsSection, GWAUiFieldsView, NSArray, NSMutableDictionary, NSString, OrchNameForm, UIColor, UIImage;
@protocol GWACardComponentDelegate, GWAFlowSectionDelegate;

@interface GWANameForm : NSObject <GOOTextFieldValidator, GWACollapsibleFlowSection, GWASummaryViewDelegate, GWAForm>
{
