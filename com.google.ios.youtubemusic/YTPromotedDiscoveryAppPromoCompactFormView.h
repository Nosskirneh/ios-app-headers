...
@class NSMutableArray, NSMutableDictionary, NSString, YTBadge, YTButton, YTFormattedStringLabel, YTIPromotedDiscoveryAppPromoCompactFormRenderer, YTImageView, YTRatingView;
...
@property(retain, nonatomic) YTBadge *appBadge; // @synthesize appBadge=_appBadge;
