...
+ (id)descriptor;
+ (id)ytm_videoMetadataRendererFromOfflineVideo:(id)arg1;
...
@property(nonatomic) _Bool hasStatsItemStatus; // @dynamic hasStatsItemStatus;
...
@property(nonatomic) int statsItemStatus; // @dynamic statsItemStatus;
