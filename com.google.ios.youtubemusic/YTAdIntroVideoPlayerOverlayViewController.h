...
@protocol YTAdPlayerOverlayDelegate, YTAdVideoPlayerOverlayDelegate, YTPlayerOverlayDelegate, YTResponder, YTVideoPlayerOverlayDelegate;

@interface YTAdIntroVideoPlayerOverlayViewController : UIViewController <YTAdVideoPlayerOverlayProtocol>
{
    int _playerViewLayout;
    _Bool disallowQualitySwitch;
...
@property(nonatomic) int foregroundAudioOnlyPlaybackReason; // @synthesize foregroundAudioOnlyPlaybackReason;
@property(nonatomic) _Bool externalPlaybackActive; // @synthesize externalPlaybackActive;
@property(nonatomic) _Bool disallowQualitySwitch; // @synthesize disallowQualitySwitch;
