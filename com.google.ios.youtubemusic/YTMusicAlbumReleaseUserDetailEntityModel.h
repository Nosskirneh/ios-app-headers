...
@class NSData, NSDictionary, NSString, YTIMusicAlbumReleaseUserDetailEntity, YTMusicAlbumReleaseEntityModel;
...
@interface YTMusicAlbumReleaseUserDetailEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMusicAlbumReleaseUserDetailEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMusicAlbumReleaseUserDetailEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
