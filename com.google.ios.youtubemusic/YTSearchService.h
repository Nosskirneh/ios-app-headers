...
@protocol YTAdInnerTubeConfig;

@interface YTSearchService : YTBaseInnerTubeRequestService <YTInnerTubeUIService>
{
    YTApiaryResourceParser *_resourceParser;
    id <YTAdInnerTubeConfig> _adInnerTubeConfig;
    long long _innerTubeSearchService;
}

+ (long long)searchServiceFromConfig:(id)arg1;
- (void).cxx_destruct;
- (void)clearCaches;
