...
#import "YTCommonButton-Protocol.h"
#import "YTPageStyling-Protocol.h"
#import "YTRightNavigationButtonProtocol-Protocol.h"

@class NSArray, NSString, UIColor, UIView;

@interface YTQTMButton : QTMButton <YTCommonButton, YTRightNavigationButtonProtocol, YTPageStyling>
{
...
- (void)setBorderForStyle:(int)arg1;
