...
@class BuyflowPage, NSMutableArray, OrchIntegratorCallbackData, OrchResponseContext, OrchSecureDataHeader, OrchUiError;
...
@property(retain, nonatomic) OrchIntegratorCallbackData *clientCallbackData; // @dynamic clientCallbackData;
...
@property(nonatomic) _Bool hasClientCallbackData; // @dynamic hasClientCallbackData;
...
@property(retain, nonatomic) BuyflowPage *initialPage; // @dynamic initialPage;
