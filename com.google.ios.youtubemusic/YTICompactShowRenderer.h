...
@class NSData, NSMutableArray, NSString, YTICommand, YTIFormattedString, YTIMainAppCompactRendererStyle, YTIMenuSupportedRenderers, YTIShowThumbnailSupportedRenderers, YTIStandaloneBadgeSupportedRenderers;

@interface YTICompactShowRenderer : GPBMessage
{
}
