...
@class GWAButtonView, GWAComponentGroup, NSArray, NSString, OAStackView, UIColor, UIImage;
@protocol GWACardComponentDelegate, GWAFlowSectionDelegate;

@interface GWAButtonFlowSection : NSObject <GWAButtonViewDelegate, GWADependencyGraphComponent, GWAFormComponentDelegate, GWAFlowSection>
{
...
- (id)initWithButton:(id)arg1 context:(id)arg2;
