...
- (void)__setComponentWeak:(id)arg1;
- (void)__setComponentStrong:(id)arg1;
- (id)__component;
- (_Bool)isEqualToDiffableObject:(id)arg1;
- (id)diffIdentifier;
@property(nonatomic) __weak id <YTScrollFocusableItem> scrollFocusableItem;
...
- (CDStruct_ac21a0f6)lockToRootIfNeededForLayout;
- (_Bool)locked_shouldLayoutFromYogaRoot;
- (void)calculateLayoutFromYogaRoot:(CDStruct_42a63532)arg1;
- (void)invalidateCalculatedYogaLayout;
- (void)updateYogaMeasureFuncIfNeeded;
- (_Bool)shouldHaveYogaMeasureFunc;
- (void)setupYogaCalculatedLayout;
- (id)layoutForYogaNode;
@property _Bool yogaLayoutInProgress;
@property(retain, nonatomic) ASLayout *yogaCalculatedLayout;
- (id)yogaParent;
...
@property(retain, nonatomic) NSArray *yogaChildren;
- (id)yogaRoot;
