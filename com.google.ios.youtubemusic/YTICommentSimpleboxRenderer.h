...
@class NSData, NSMutableArray, NSString, YTIBackstageImageCreationSupportedRenderers, YTIBackstageVideoLinkSupportedRenderers, YTIButtonSupportedRenderers, YTICommand, YTIFormattedString, YTIPollCreationSupportedRenderers, YTIRenderer, YTIThumbnailDetails, YTIZeroStepChannelCreationSupportedRenderers;
