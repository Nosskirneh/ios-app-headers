...
@class NSMutableArray, NSString, POEMEmailExtendedData, SGWPPMPersonFieldMetadata;
...
@property(retain, nonatomic) POEMEmailExtendedData *extendedData; // @dynamic extendedData;
