...
@class GIMMe, NSString, YTMSettings, YTReachabilityController, YTWatchHistoryService;

@interface YTMSetWatchHistoryPausedSettingEndpointCommand : NSObject <YTCommandHandler>
{
