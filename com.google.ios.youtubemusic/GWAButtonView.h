...
@class GWADependencyGraph, NSMutableArray, NSString, OrchButton, QTMColorGroup, UIButton;
@protocol GWAButtonViewDelegate, GWAFormComponentDelegate;

@interface GWAButtonView : OAStackView <GWACollectionViewCell, GWAResultingComponent, GWATriggerComponent, GWAFormComponent>
{
