...
@class NSString, UIDragInteraction, UIPanGestureRecognizer, UIPinchGestureRecognizer;
...
@interface YTPlayerView : UIView <UIGestureRecognizerDelegate, UIDragInteractionDelegate, YTPageStyleProvider, YTPlayerViewLayoutProtocol>
{
    ...
    UIView<MLPlayerViewProtocol> *_pipRenderingView;
}
...
@property(retain, nonatomic) UIView<MLPlayerViewProtocol> *pipRenderingView; // @synthesize pipRenderingView=_pipRenderingView;
...
- (void)setRenderingViewHidden:(_Bool)arg1;
