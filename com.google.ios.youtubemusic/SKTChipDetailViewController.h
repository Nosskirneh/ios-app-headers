...
@class NSLayoutConstraint, QTMButton, SKTContact, SKTNetworkImageView, UIButton, UILabel;
...
@interface SKTChipDetailViewController : UIViewController
{
    ...
    SKTNetworkImageView *_avatarView;
...
@property(nonatomic) __weak SKTNetworkImageView *avatarView; // @synthesize avatarView=_avatarView;
...
- (void)viewDidLoad;
- (id)initWithContact:(id)arg1 uiOptions:(id)arg2 analyticsProvider:(id)arg3;
