...
@class NSArray, NSData, NSDictionary, NSString, YTChannelEntityModel, YTIPlaylistVideoEntity, YTVideoEntityModel;
...
@interface YTPlaylistVideoEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIPlaylistVideoEntity *_protoBuf;
}

@property(copy, nonatomic) YTIPlaylistVideoEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
- (id)copy;
- (void)channelContributorWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
@property(readonly, nonatomic) YTChannelEntityModel *channelContributor;
- (void)videoEntityWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
@property(readonly, nonatomic) YTVideoEntityModel *videoEntity;
- (_Bool)isEqualToEntity:(id)arg1;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;
@property(readonly, nonatomic) NSArray *parametersArray;
