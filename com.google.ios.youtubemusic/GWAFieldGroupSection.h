...
#import "GWAFormComponentDelegate-Protocol.h"
#import "GWALinkViewDelegate-Protocol.h"
#import "GWAUIFieldGroupingViewDelegate-Protocol.h"

@class GWAComponentGroup, GWAFlowContext, GWATintedImageView, GWAUIFieldGroupingView, NSArray, NSString, OrchUiFieldGrouping, UIColor, UIImage, UIStackView;
@protocol GWACardComponentDelegate, GWAFlowSectionDelegate;

@interface GWAFieldGroupSection : NSObject <GWADependencyGraphComponent, GWAFormComponentDelegate, GWALinkViewDelegate, GWAUIFieldGroupingViewDelegate, GWAFlowSection>
{
