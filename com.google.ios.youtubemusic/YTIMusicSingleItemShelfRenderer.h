...
@class NSData, NSMutableArray, NSString, YTIAccessibilitySupportedDatas, YTICommand, YTIFormattedString, YTIMusicBackgroundOverlayStyle, YTIRenderer;

@interface YTIMusicSingleItemShelfRenderer : GPBMessage <YTInnerTubeSectionRenderer>
{
}
