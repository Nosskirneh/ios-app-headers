...
@property(nonatomic) _Bool collectionExceptionsEnabled; // @dynamic collectionExceptionsEnabled;
...
@property(nonatomic) _Bool hasCollectionExceptionsEnabled; // @dynamic hasCollectionExceptionsEnabled;
