...
@class NSArray, NSData, NSString, YTContactEntityModel, YTIChatMessageTextType;
@protocol YTEntityStore;

@interface YTChatMessageTextTypeModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIChatMessageTextType *_protoBuf;
}

@property(copy, nonatomic) YTIChatMessageTextType *protoBuf; // @synthesize protoBuf=_protoBuf;
