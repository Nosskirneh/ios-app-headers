...
@interface MDXCastScreenSession : MDXScreenSession <GCKRemoteMediaClientListener, GCKRequestDelegate, GCKSessionManagerListener, MDXCastYouTubeChannelDelegate>
{
