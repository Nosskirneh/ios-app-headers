...
@class NSData, NSMutableArray, NSString, YTICommand, YTIFormattedString, YTIIosClientOfflineData, YTIMenuSupportedRenderers, YTIMusicListPlaylistOfflineabilitySupportedRenderers, YTIMusicListPlaylistThumbnailSupportedRenderers;

@interface YTIMusicListPlaylistRenderer : GPBMessage <YTMOfflinePlaylistIDProtocol>
{
}

+ (id)descriptor;
+ (id)ytm_musicListPlaylistRendererWithOfflinePlaylist:(id)arg1 useWatchEndpoint:(_Bool)arg2;
...
@property(retain, nonatomic) YTIMusicListPlaylistOfflineabilitySupportedRenderers *offlineability; // @dynamic offlineability;
...
@property(retain, nonatomic) YTIMusicListPlaylistThumbnailSupportedRenderers *thumbnailRenderer; // @dynamic thumbnailRenderer;
