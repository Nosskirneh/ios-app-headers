...
@class GIMMe, NSMutableDictionary, NSMutableSet, NSString, YTAdState, YTDAIAdBreakStateLoggingController, YTDAIAdsLoggingController, YTPlaybackData, YTVideoTimeline;
@protocol YTAdsPlaybackCoordinatorDelegate, YTAdsPlaybackProtocol, YTInstreamAdsController, YTResponder;

@interface YTDAIAdsCoordinator : NSObject <YTResponder>
{
    ...
    NSMutableSet *_activeAdbreakRequests;
    id <YTResponder> _parentResponder;
    YTVideoTimeline *_currentTimeline;
    GIMMe *_gimme;
...
@property(readonly, nonatomic) YTVideoTimeline *currentTimeline; // @synthesize currentTimeline=_currentTimeline;
...
- (double)getAdBreakLengthFromCuepoint:(id)arg1;
- (_Bool)shouldEnableDaiForAirplay;
- (void)clearCurrentTimeline;
- (id)createTimelineWithContentPlaybackData:(id)arg1 withAdBreakStateLoggingController:(id)arg2;
...
- (void)adDidProgressWithMLTime:(CDStruct_d60ef703)arg1 withAdCPN:(id)arg2;
