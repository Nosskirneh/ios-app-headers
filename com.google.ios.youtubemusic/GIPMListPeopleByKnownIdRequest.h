...
@class GIPMContactLookupOptions, GIPMMergedPersonSourceOptions, GIPMPeopleContext, GIPMRequestMask, GIPRExtensionSet, GPBEnumArray, NSMutableArray;

@interface GIPMListPeopleByKnownIdRequest : GPBMessage
{
}
...
@property(retain, nonatomic) GIPMContactLookupOptions *contactLookupOptions; // @dynamic contactLookupOptions;
