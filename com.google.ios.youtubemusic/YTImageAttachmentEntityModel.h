...
@class NSArray, NSData, NSDictionary, NSString, YTIImageAttachmentEntity;
...
@property(readonly, nonatomic) NSArray *sourcesArray; // @synthesize sourcesArray=_sourcesArray;
