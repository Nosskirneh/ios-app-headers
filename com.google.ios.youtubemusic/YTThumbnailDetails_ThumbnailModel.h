...
@class NSData, NSString, YTIThumbnailDetails_Thumbnail;
...
@interface YTThumbnailDetails_ThumbnailModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIThumbnailDetails_Thumbnail *_protoBuf;
}

@property(copy, nonatomic) YTIThumbnailDetails_Thumbnail *protoBuf; // @synthesize protoBuf=_protoBuf;
