...
#import "YTOfflinePlaylistSyncControllerDelegate-Protocol.h"
...
@interface YTOfflinePlaylistController : NSObject <YTHotConfigObserver, YTOfflineImageControllerObserver, YTOfflineVideoControllerObserver, YTOfflinePlaylistSyncControllerDelegate>
{
...
- (void)constructThumbnailsURLsForPlaylists:(id)arg1;
