...
@class MLAudioDecoderFactory, MLOnesieFormatData, MLVideoDecoderFactory, NSMutableArray, NSSet, NSString, YTIHamplayerHotConfig, YTIOnesieHotConfig;
...
- (void)doneAppendingMediaData;
- (void)doneAppendingMediaDataForFormatKey:(id)arg1;
