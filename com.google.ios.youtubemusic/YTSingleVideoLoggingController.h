...
@protocol MLPlayer, YTSingleVideoLoggingControllerDelegate, YTSingleVideoObservable, YTVSSController;
...
- (void)activateVSSControllerWithPlayerStatus:(id)arg1 playlistID:(id)arg2 autoplay:(_Bool)arg3 timelineSection:(id)arg4;
...
- (void)activatePlaybackLoggingWithPlayerStatus:(id)arg1 playlistID:(id)arg2 autoplay:(_Bool)arg3 playbackLoggingDelegate:(id)arg4 timelineSection:(id)arg5;
@property(readonly, nonatomic) YTVSSControllerState *VSSControllerStateCopy;
@property(readonly, nonatomic) MLQOEError *fatalError;
- (id)initWithPlayer:(id)arg1 playbackData:(id)arg2 singleVideoObservable:(id)arg3 playerVisibility:(int)arg4;
