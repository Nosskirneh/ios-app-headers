...
@interface FLAnimatedImageView : UIImageView
{
    ...
    _Bool _isUserPaused;
    UIImage<FLAnimatedImage> *_animatedImage;
...
@property(retain, nonatomic) UIImage<FLAnimatedImage> *animatedImage; // @synthesize animatedImage=_animatedImage;
- (void).cxx_destruct;
