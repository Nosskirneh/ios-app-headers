...
@class NSData, NSMutableArray, YTIMenuSupportedRenderers, YTIResponseContext;

@interface YTIGetContactMenuResponse : GPBMessage
{
}
...
@property(retain, nonatomic) YTIMenuSupportedRenderers *contents; // @dynamic contents;
