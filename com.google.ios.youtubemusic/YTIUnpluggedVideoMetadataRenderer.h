...
@class NSData, NSMutableArray, NSString, YTICommand, YTIFormattedString, YTIIcon, YTIMenuSupportedRenderers, YTIThumbnailDetails, YTIUnpluggedSubscribeButtonSupportedRenderers;
...
@property(nonatomic) int corpusType; // @dynamic corpusType;
...
@property(nonatomic) _Bool hasCorpusType; // @dynamic hasCorpusType;
...
@property(nonatomic) _Bool hasSourceThumbnail; // @dynamic hasSourceThumbnail;
