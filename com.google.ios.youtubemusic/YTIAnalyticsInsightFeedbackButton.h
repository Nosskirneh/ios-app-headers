...
@interface YTIAnalyticsInsightFeedbackButton : GPBMessage
{
}
...
@property(nonatomic) _Bool hasShowFollowup; // @dynamic hasShowFollowup;
...
@property(nonatomic) _Bool showFollowup; // @dynamic showFollowup;
