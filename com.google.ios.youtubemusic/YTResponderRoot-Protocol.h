...
@protocol MDXServices, YTDataServices, YTIdentityGlobals, YTNavigationProtocol, YTOfflineServices;

@protocol YTResponderRoot <YTResponder>
@property(readonly, nonatomic) NSArray *eventGroupHandlers;
@property(nonatomic) __weak id <YTIdentityGlobals> identityGlobals;
@property(nonatomic) __weak id <MDXServices> MDXServices;
@property(nonatomic) __weak id <YTOfflineServices> offlineServices;
