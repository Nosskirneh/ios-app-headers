...
@interface FCSZIncrementBatch_RootSpec_MobileExpId : GPBMessage
{
}
...
@property(nonatomic) _Bool hasUseMobilespec; // @dynamic hasUseMobilespec;
@property(nonatomic) _Bool useMobilespec; // @dynamic useMobilespec;
