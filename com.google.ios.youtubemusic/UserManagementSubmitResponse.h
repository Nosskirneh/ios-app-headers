...
@class NSString, OrchResponseContext, OrchSecureDataHeader, OrchUiError, UserManagementPage;
...
@property(retain, nonatomic) UserManagementPage *nextPage; // @dynamic nextPage;
