...
@class NSMutableArray, YTIResponseContext, YTIYPCCancelRecurrenceSupportedRenderers;
...
@property(retain, nonatomic) YTIYPCCancelRecurrenceSupportedRenderers *messageRenderer; // @dynamic messageRenderer;
