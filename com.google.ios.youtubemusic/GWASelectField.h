...
@class GWATextFieldTitleView, GWAUnderlineView, NSArray, NSString, UIBarButtonItem, UIImageView, UILabel, UIPickerView, UIToolbar;
@protocol GWASelectFieldDelegate;

@interface GWASelectField : UIView <UIPickerViewDelegate, UIPickerViewDataSource>
{
    _Bool _isEditing;
