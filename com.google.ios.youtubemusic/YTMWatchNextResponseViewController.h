...
@class GIMMe, NSString, UINavigationController, YTIWatchNextResponse, YTMLightsourcePalette, YTMQueueCollectionViewController, YTMQueueController, YTMTodayWidgetController, YTMWatchPageLoggingController;
@protocol YTInnerTubeUIService, YTMServices, YTPlayerServices, YTResponder;
