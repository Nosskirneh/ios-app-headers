...
+ (id)descriptor;
+ (id)ytm_playlistPanelRendererWithPlaylistID:(id)arg1 playlistTitle:(id)arg2 channelName:(id)arg3 offlineVideos:(id)arg4 currentIndex:(unsigned long long)arg5 offlineMode:(_Bool)arg6;
+ (id)ytm_playlistPanelRendererWithOfflinePlaylist:(id)arg1 offlineVideos:(id)arg2 currentIndex:(unsigned long long)arg3 offlineMode:(_Bool)arg4;
...
- (unsigned long long)ytm_videoRenderersCount;
- (id)ytm_queueItems;
- (id)ytm_queueItemAtIndex:(unsigned long long)arg1;
- (id)ytm_queueItemForVideoID:(id)arg1;
- (void)ytm_removeItemAtIndex:(unsigned long long)arg1;
- (void)ytm_insertVideo:(id)arg1 atIndex:(unsigned long long)arg2;
- (int)ytm_automixTunerSetting;
- (void)ytm_selectFirstVideoWithID:(id)arg1;
- (unsigned long long)ytm_indexOfVideoWithID:(id)arg1;
...
@property(nonatomic) _Bool hasShuffleToggleButton; // @dynamic hasShuffleToggleButton;
