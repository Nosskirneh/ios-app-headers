...
@class NSData, NSString, YTAccessibilityIdModel, YTIAccessibilityData;
...
@interface YTAccessibilityDataModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    YTAccessibilityIdModel *_identifier;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIAccessibilityData *_protoBuf;
}

@property(copy, nonatomic) YTIAccessibilityData *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTAccessibilityIdModel *identifier; // @synthesize identifier=_identifier;
- (void).cxx_destruct;
