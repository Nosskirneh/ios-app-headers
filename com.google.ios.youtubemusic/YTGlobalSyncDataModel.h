...
@class NSData, YTIGlobalSyncData;
@protocol YTEntityStore;

@interface YTGlobalSyncDataModel : NSObject <NSCopying, NSMutableCopying>
{
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIGlobalSyncData *_protoBuf;
}

@property(copy, nonatomic) YTIGlobalSyncData *protoBuf; // @synthesize protoBuf=_protoBuf;
