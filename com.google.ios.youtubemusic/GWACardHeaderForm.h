...
@class GWACardHeaderView, GWAComponentGroup, GWADependencyGraph, GWAFlowContext, NSArray, NSMutableArray, NSString, OrchCardHeader, UIColor, UIImage;
...
- (id)value;
- (id)initWithCardHeader:(id)arg1 context:(id)arg2;
