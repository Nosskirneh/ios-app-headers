...
#import "FIRCoreConfigurable-Protocol.h"
...
@interface FIRMessaging : NSObject <FIRMessagingInstanceProvider, FIRCoreConfigurable, FIRComponentRegistrant, FIRMessagingClientDelegate, FIRMessagingReceiverDelegate, GULReachabilityDelegate>
{
...
@property(nonatomic) _Bool useMessagingDelegateForDirectChannel;
