...
@interface YTISettingsEnableDisableButtonRenderer : GPBMessage
{
}
...
@property(nonatomic) _Bool hasIsTargetEnabled; // @dynamic hasIsTargetEnabled;
@property(copy, nonatomic) NSString *identifier; // @dynamic identifier;
@property(nonatomic) _Bool isTargetEnabled; // @dynamic isTargetEnabled;
