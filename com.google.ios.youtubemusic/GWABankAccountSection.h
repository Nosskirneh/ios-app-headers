...
@class GWAComponentGroup, GWAFlowContext, GWAUiFieldConfiguration, NSArray, NSMutableDictionary, NSString, OrchBankAccountForm, UIColor, UIImage;
@protocol GWACardComponentDelegate, GWAFlowSectionDelegate, NSCopying;

@interface GWABankAccountSection : NSObject <GOOTextFieldValidator, GWAFocusDelegate, GWASelectFieldViewDelegate, GWAFlowSection>
{
    NSArray *_fields;
