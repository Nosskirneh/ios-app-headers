...
@class MessageSet, NSString, SGWPPAffinityMetadata;
...
@property(retain, nonatomic) MessageSet *candidatePayload; // @dynamic candidatePayload;
...
@property(nonatomic) _Bool hasCandidatePayload; // @dynamic hasCandidatePayload;
