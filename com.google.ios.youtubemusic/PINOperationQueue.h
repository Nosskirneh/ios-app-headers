...
- (id)scheduleOperation:(CDUnknownBlockType)arg1 withPriority:(unsigned long long)arg2 identifier:(id)arg3 coalescingData:(id)arg4 dataCoalescingBlock:(CDUnknownBlockType)arg5 completion:(CDUnknownBlockType)arg6;
...
- (id)scheduleOperation:(CDUnknownBlockType)arg1 withPriority:(unsigned long long)arg2;
- (id)addOperation:(CDUnknownBlockType)arg1 withPriority:(unsigned long long)arg2;
- (id)scheduleOperation:(CDUnknownBlockType)arg1;
