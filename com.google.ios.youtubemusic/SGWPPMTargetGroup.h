...
@class NSMutableArray, NSString, SGWPPMTargetGroupMetadata;

@interface SGWPPMTargetGroup : GPBMessage
{
}
...
@property(retain, nonatomic) SGWPPMTargetGroupMetadata *metadata; // @dynamic metadata;
