...
@class NSData, NSMutableArray, NSString, YTICommand, YTIFormattedString, YTIIcon, YTIIosClientOfflineData, YTILikeButtonSupportedRenderers, YTIMenuSupportedRenderers, YTIMusicListVideoOfflineabilitySupportedRenderers, YTIMusicListVideoSwipeSupportedRenderers, YTIMusicListVideoThumbnailSupportedRenderers;

@interface YTIMusicListVideoRenderer : GPBMessage <YTMOfflinePlaylistIDProtocol, YTMOfflineVideoIDProtocol>
{
}

+ (id)descriptor;
+ (id)ytm_musicListVideoRendererWithOfflineVideo:(id)arg1 playlistId:(id)arg2 index:(unsigned long long)arg3 explicitOfflineEnabled:(_Bool)arg4;
