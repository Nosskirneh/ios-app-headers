...
@class YTIMediaBrowseLoadTreeSupportedRenderers, YTIResponseContext;

@interface YTIMediaBrowseLoadTreeResponse : GPBMessage
{
}
...
@property(retain, nonatomic) YTIMediaBrowseLoadTreeSupportedRenderers *root; // @dynamic root;
