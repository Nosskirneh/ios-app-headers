...
@class NSData, YTICommand, YTIFormattedString, YTIIcon, YTIMenuSupportedRenderers, YTIMusicRadioThumbnailSupportedRenderers, YTIMusicWideRadioThumbnailSupportedRenderers;
...
@property(retain, nonatomic) YTIMusicWideRadioThumbnailSupportedRenderers *thumbnail; // @dynamic thumbnail;
