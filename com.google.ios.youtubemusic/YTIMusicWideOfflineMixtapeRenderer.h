...
@class NSData, NSMutableArray, NSString, YTIAccessibilitySupportedDatas, YTICommand, YTIFormattedString, YTIIosClientOfflineData, YTIMenuSupportedRenderers, YTIMusicWideOfflineMixtapeThumbnailSupportedRenderers;
...
+ (id)ytm_musicWideOfflineMixtapeRendererWithOfflinePlaylist:(id)arg1 offlineVideos:(id)arg2 shouldUseRemixStyle:(_Bool)arg3 shuffleEnabled:(_Bool)arg4;
