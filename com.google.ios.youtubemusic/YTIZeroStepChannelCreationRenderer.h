...
@class NSData, YTIFormattedString, YTIZeroStepChannelCreationSupportedContinuations;
...
@property(retain, nonatomic) YTIZeroStepChannelCreationSupportedContinuations *continuation; // @dynamic continuation;
