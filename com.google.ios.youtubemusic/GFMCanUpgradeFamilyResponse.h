...
@class GFMApiResponseHeader, GFMPage, GPBEnumArray, NSData;
...
@property(nonatomic) _Bool canUpgradeFamily; // @dynamic canUpgradeFamily;
...
@property(nonatomic) _Bool hasCanUpgradeFamily; // @dynamic hasCanUpgradeFamily;
