...
@class NSData, NSMutableArray, NSString, YTIActiveViewDisplayMeasurement, YTICommand, YTICompactPromotedVideoCTASupportedRenderers, YTIFormattedString, YTIMainAppCompactRendererStyle, YTIMenuSupportedRenderers, YTIThumbnailDetails;

@interface YTICompactPromotedVideoRenderer : GPBMessage
{
}
...
@property(retain, nonatomic) YTICompactPromotedVideoCTASupportedRenderers *ctaRenderer; // @dynamic ctaRenderer;
...
@property(nonatomic) _Bool hasRemoveBottomSeparator; // @dynamic hasRemoveBottomSeparator;
...
@property(nonatomic) _Bool removeBottomSeparator; // @dynamic removeBottomSeparator;
