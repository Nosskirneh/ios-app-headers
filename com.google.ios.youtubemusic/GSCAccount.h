...
@property(readonly, nonatomic) NSArray *delegatedPlusPages;
@property(readonly, copy, nonatomic) NSArray *delegatedPlusPageIds;
@property(readonly, copy, nonatomic) NSString *plusPageAuthorizerGaiaId;
