...
@class HAMDASHAdaptationSetBuilder, HAMDASHMPDSegmentIndexBuilder, NSString;

@interface HAMDASHAdaptationSetElementParser : HAMDASHBaseElementParser
{
    NSString *_MIMEType;
    HAMDASHMPDSegmentIndexBuilder *_segmentIndexBuilder;
    NSString *_initializationTemplate;
    HAMDASHAdaptationSetBuilder *_builder;
}

@property(readonly, nonatomic) HAMDASHAdaptationSetBuilder *builder; // @synthesize builder=_builder;
