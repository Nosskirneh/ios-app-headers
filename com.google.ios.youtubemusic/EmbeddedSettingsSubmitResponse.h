...
@class EmbeddedSettingsPage, NSString, OrchResponseContext, OrchSecureDataHeader, OrchUiError;
...
@property(nonatomic) _Bool hasRedirectToURL; // @dynamic hasRedirectToURL;
@property(nonatomic) _Bool hasSecureHeader; // @dynamic hasSecureHeader;
@property(retain, nonatomic) EmbeddedSettingsPage *nextPage; // @dynamic nextPage;
@property(copy, nonatomic) NSString *redirectToURL; // @dynamic redirectToURL;
