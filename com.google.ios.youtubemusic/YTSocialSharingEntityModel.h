...
@class NSData, NSDictionary, NSString, YTChatSetEntityModel, YTISocialSharingEntity, YTSocialSharingSyncTokenModel;
@protocol YTEntityStore;

@interface YTSocialSharingEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    NSString *_key;
    ...
    YTISocialSharingEntity *_protoBuf;
}

@property(copy, nonatomic) YTISocialSharingEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
- (id)copy;
- (void)chatSetWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
@property(readonly, nonatomic) YTChatSetEntityModel *chatSet;
