...
#import "GFMIBaseViewController.h"

#import "GKSCallToActionPanelDelegate-Protocol.h"
...
@protocol GFMISendInvitationsDelegate, SKTSendKitCoreService, SKTShareSheet;
...
@interface GFMISendInvitationsViewController : GFMIBaseViewController <GKSCallToActionPanelDelegate, SKTShareSheetDelegate>
{
    ...
    id <SKTSendKitCoreService> _sendKitCoreService;
...
@property(readonly, nonatomic) id <SKTSendKitCoreService> sendKitCoreService; // @synthesize sendKitCoreService=_sendKitCoreService;
