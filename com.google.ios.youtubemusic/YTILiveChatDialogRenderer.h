...
@class NSData, NSMutableArray, YTIFormattedString, YTILiveChatDialogConfirmButtonSupportedRenderers;
...
@property(retain, nonatomic) YTILiveChatDialogConfirmButtonSupportedRenderers *confirmButton; // @dynamic confirmButton;
