...
- (void)synchronizeIfNeeded:(id)arg1;
...
@property(nonatomic) _Bool forceAVSwitchPill;
...
@property(nonatomic) unsigned long long crashDeadlockMinidumpCount;
...
- (id)manualQualitySelectionStickyCeilingExpirationDate;
...
- (void)clearManualQualitySelection;
- (void)setManualQualitySelectionWithChosenResolution:(int)arg1 precedingResolution:(int)arg2 eventDate:(id)arg3 stickyCeilingDuration:(double)arg4;
...
- (void)setHasUsedYTImageServiceImpl:(_Bool)arg1;
- (_Bool)hasUsedYTImageServiceImpl;
