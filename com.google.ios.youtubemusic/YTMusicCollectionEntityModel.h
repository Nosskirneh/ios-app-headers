...
@class NSData, NSDictionary, NSString, YTIMusicCollectionEntity;
...
@interface YTMusicCollectionEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMusicCollectionEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMusicCollectionEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
