...
@class MDXAdSessionState, MDXChannelMessageRouter, MDXChannelObserverProxy, MDXVirtualVolumeController, NSArray, NSHashTable, NSMutableArray, NSString, YTCPN, YTIAudioTrack, YTMonotonicDate, YTTimedAction;
@protocol MDXChannel, MDXScreen, MDXScreenSessionConnectionDelegate;

@interface MDXScreenSession : NSObject <MDXChannelObserver, MDXVirtualVolumeControllerDelegate, YTLastActionObserver, YTUserChangedObserver, YTSystemNotificationsObserver, MDXQueueController, MDXScreenPlaybackController>
{
    NSMutableArray *_messageQueue;
    YTTimedAction *_messageTimedAction;
    double _reconnectionStart;
    YTTimedAction *_reconnectionTimedAction;
    double _connectionStartedTimeInterval;
...
@property(nonatomic) __weak id <MDXScreenSessionConnectionDelegate> connectionDelegate; // @synthesize connectionDelegate=_connectionDelegate;
...
@property(readonly, nonatomic) NSString *currentCaptionTrackVSSID; // @synthesize currentCaptionTrackVSSID=_currentCaptionTrackVSSID;
...
- (_Bool)shouldFetchAdInfo;
- (_Bool)isFijiSkippableAdEnabled;
- (_Bool)isFijiEnabled;
- (void)loadAdInfoWithVideoID:(id)arg1;
...
- (void)notifySubtitlesTrackDidChangeWithVSSID:(id)arg1;
...
- (void)prepareToReconnectAfterErrorWithDelay:(double)arg1 loggingCause:(int)arg2;
- (void)disconnectWithUserAction:(_Bool)arg1;
- (void)disconnectWithUserAction:(_Bool)arg1 loggingCause:(int)arg2;
- (void)stopScreenApp;
- (void)leaveScreenApp;
