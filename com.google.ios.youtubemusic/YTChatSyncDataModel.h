...
@class NSData, NSString, YTIChatSyncData;
@protocol YTEntityStore;

@interface YTChatSyncDataModel : NSObject <NSCopying, NSMutableCopying>
{
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIChatSyncData *_protoBuf;
}

@property(copy, nonatomic) YTIChatSyncData *protoBuf; // @synthesize protoBuf=_protoBuf;
