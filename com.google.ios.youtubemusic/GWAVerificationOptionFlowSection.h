...
@class GWAComponentGroup, GWAFlowContext, GWAInfoMessageView, NSArray, NSData, NSString, UIColor, UIImage;
@protocol GWACardComponentDelegate, GWAFlowSectionDelegate;

@interface GWAVerificationOptionFlowSection : NSObject <GWASelectorOptionDelegate, GWAFlowSection>
{
    NSArray *_options;
