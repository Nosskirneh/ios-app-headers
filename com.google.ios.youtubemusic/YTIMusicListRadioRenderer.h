...
@class NSData, YTICommand, YTIFormattedString, YTIIcon, YTIMenuSupportedRenderers, YTIMusicListRadioThumbnailSupportedRenderers, YTIMusicRadioThumbnailSupportedRenderers;
...
@property(retain, nonatomic) YTIMusicListRadioThumbnailSupportedRenderers *thumbnail; // @dynamic thumbnail;
