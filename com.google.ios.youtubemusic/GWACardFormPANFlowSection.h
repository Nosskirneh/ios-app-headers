...
@class GWAComponentGroup, GWACreditCardTextFieldView, GWAFlowContext, GWATextFieldFormatter, NSArray, NSString, OrchCardForm, OrchFormFieldMessage, OrchPanCategory, QTMButton, UIColor, UIImage;
@protocol GWACardComponentDelegate, GWACardScanningViewControllerDelegate, GWAFlowSectionDelegate;

@interface GWACardFormPANFlowSection : NSObject <GOOTextFieldValidator, GWAFocusDelegate, UITextFieldDelegate, GWAFlowSection>
{
