...
@class MLOfflineVideoDownloadController, MLVideoDownloadTask, NSError, NSString;

@protocol MLOfflineVideoDownloadDelegate <NSObject>
- (void)offlineDownloadController:(MLOfflineVideoDownloadController *)arg1 didFinishBackgroundTaskResotorationWithTask:(MLVideoDownloadTask *)arg2;
