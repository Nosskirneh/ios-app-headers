...
@class NSData, NSMutableArray, NSString, YTICommand, YTIExternalAdStreamData, YTIFormattedString, YTIOfflineFrequencyCap, YTIRenderer, YTIVideoAdOverlaySupportedRenderers, YTIVideoAdTracking, YTIVideoInteractionsAndProgressCommands;
