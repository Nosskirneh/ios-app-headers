...
@class NSMutableArray, NSString, YTICommand, YTICreatorVideoDetailHeaderButtonSupportedRenderers, YTIFormattedString, YTIRenderer, YTIThumbnailDetails, YTIVideoManagerPrivacyDisplay, YTIVideoManagerVideoMetrics;
...
@property(nonatomic) _Bool hasHeaderButton; // @dynamic hasHeaderButton;
@property(nonatomic) _Bool hasHeaderButtonToastText; // @dynamic hasHeaderButtonToastText;
...
@property(nonatomic) _Bool hasScheduledDate; // @dynamic hasScheduledDate;
...
@property(retain, nonatomic) YTICreatorVideoDetailHeaderButtonSupportedRenderers *headerButton; // @dynamic headerButton;
@property(retain, nonatomic) YTIFormattedString *headerButtonToastText; // @dynamic headerButtonToastText;
...
@property(retain, nonatomic) YTIFormattedString *scheduledDate; // @dynamic scheduledDate;
