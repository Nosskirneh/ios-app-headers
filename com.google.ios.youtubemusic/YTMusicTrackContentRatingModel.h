...
@class NSData, YTIMusicTrackContentRating;
...
@interface YTMusicTrackContentRatingModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIMusicTrackContentRating *_protoBuf;
}

@property(copy, nonatomic) YTIMusicTrackContentRating *protoBuf; // @synthesize protoBuf=_protoBuf;
