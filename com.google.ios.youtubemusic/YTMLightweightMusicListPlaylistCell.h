...
@class NSString, QTMButton, YTFormattedStringLabel, YTIMusicListPlaylistRenderer, YTImageView, YTMOfflinePlaylistStatusController, YTMPlaylistThumbnailOverlayView, YTMTransferButton;

@interface YTMLightweightMusicListPlaylistCell : YTLightweightSwipeableCell <YTMOfflinePlaylistStatusControllerObserver, YTThumbnailMapping>
{
    YTIMusicListPlaylistRenderer *_renderer;
...
- (void)setAvatarThumbnailImage:(id)arg1;
- (void)layoutSubviews;
