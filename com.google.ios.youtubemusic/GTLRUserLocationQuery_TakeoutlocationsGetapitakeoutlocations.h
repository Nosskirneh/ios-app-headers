...
@interface GTLRUserLocationQuery_TakeoutlocationsGetapitakeoutlocations : GTLRUserLocationQuery
{
}
...
@property(nonatomic) long long firstTimestampMs; // @dynamic firstTimestampMs;
@property(nonatomic) long long gmsVersion; // @dynamic gmsVersion;
@property(nonatomic) _Bool isLowRam; // @dynamic isLowRam;
@property(nonatomic) long long lastTimestampMs; // @dynamic lastTimestampMs;
...
@property(nonatomic) _Bool teleportFilteringEnabled; // @dynamic teleportFilteringEnabled;
