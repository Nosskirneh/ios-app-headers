...
@interface YTIGamingCollectionShelfRenderer : GPBMessage
{
}
...
@property(nonatomic) _Bool hasShowAllButton; // @dynamic hasShowAllButton;
@property(nonatomic) _Bool hasTrackingParams; // @dynamic hasTrackingParams;
@property(retain, nonatomic) YTIButtonSupportedRenderers *showAllButton; // @dynamic showAllButton;
