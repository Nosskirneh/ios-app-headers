...
@class NSData, NSString, YTICommand, YTICompactLinkHintSupportedRenderers, YTIFormattedString, YTIIcon, YTIThumbnailDetails;
...
@property(nonatomic) _Bool hasSecondaryNotificationText; // @dynamic hasSecondaryNotificationText;
