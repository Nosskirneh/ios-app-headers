...
@class NSString, YTIChannelSubMenuSupportedContinuations, YTICommand;

@interface YTIChannelSubMenuItem : GPBMessage
{
}
...
@property(retain, nonatomic) YTIChannelSubMenuSupportedContinuations *continuation; // @dynamic continuation;
