...
#import "MLFairPlayKeyLookupHelperLoggingDelegate-Protocol.h"
#import "MLHLSProxyDelegate-Protocol.h"

@class GIMMe, MLFairPlayKeyLookupHelper, MLHLSFormatSelectionStrategy, MLHLSMasterPlaylist, MLHLSPlaylistService, MLHLSPlaylistVideoSplicer, MLHLSProxy, MLStreamingData, MLVideo, NSSet, NSString, YTIHlsProxyConfig, YTNetworkRetryConfig, YTSystemNotifications;
@protocol MLHLSPlaylistCacheProtocol, MLPlayerConfig;

@interface MLHLSStreamSelector : MLStreamSelector <MLHLSProxyDelegate, MLFairPlayKeyLookupHelperLoggingDelegate>
{
    MLVideo *_video;
    MLHLSProxy *_proxy;
    ...
    MLFairPlayKeyLookupHelper *_fairPlayKeyLookupHelper;
    YTSystemNotifications *_systemNotifications;
    NSSet *_itagsExcludedFromAutomaticSelection;
...
- (void)keyLookupHelper:(id)arg1 hasNonFatalError:(id)arg2;
- (id)segmentTimeline;
