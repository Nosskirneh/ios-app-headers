...
#import "YTKoreanAgeVerificationViewControllerDelegate-Protocol.h"
...
- (void)refreshAndVerifyContentWithContentCheckOk:(_Bool)arg1 playerRequestParams:(id)arg2;
...
- (void)dealloc;
- (id)initWithVideoID:(id)arg1 playerResponse:(id)arg2 parentResponder:(id)arg3;
