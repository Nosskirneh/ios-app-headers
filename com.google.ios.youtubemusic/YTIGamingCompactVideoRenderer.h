...
@class NSData, NSMutableArray, NSString, YTIAssociatedGameSupportedRenderers, YTICommand, YTIFormattedString, YTIGamingCompactVideoRenderer_GamingCompactVideoOfflineabilitySupportedRenderers, YTIMenuSupportedRenderers, YTIThumbnailDetails, YTIUpcomingEventData;

@interface YTIGamingCompactVideoRenderer : GPBMessage
{
}
...
@property(retain, nonatomic) YTIGamingCompactVideoRenderer_GamingCompactVideoOfflineabilitySupportedRenderers *offlineability; // @dynamic offlineability;
