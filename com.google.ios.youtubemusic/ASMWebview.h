...
@class ASMAppBarBridge, ASMClientInfoBridge, ASMConsistencyBridge, ASMFloatingActivityIndicator, ASMInternalBridge, ASMScreenContext, ASMUDCBridge, ASMUIBridge, GIDASCErrorView, NSString, NSURL, WKWebView;
...
- (void)sendUserToSafariViewControllerWithURL:(id)arg1;
