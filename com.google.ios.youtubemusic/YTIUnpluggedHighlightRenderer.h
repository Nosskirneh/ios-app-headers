...
@class NSData, NSMutableArray, NSString, YTIBadgeSupportedRenderers, YTIFormattedString, YTINamedValue, YTIThumbnailDetails, YTIUnpluggedHighlightClip, YTIUnpluggedHighlightFilter, YTIUnpluggedHighlightRank, YTIUnpluggedLensClip;
...
@property(nonatomic) _Bool hasMediaTimeClip; // @dynamic hasMediaTimeClip;
...
@property(nonatomic) _Bool hasUtcClip; // @dynamic hasUtcClip;
...
@property(retain, nonatomic) YTIUnpluggedHighlightClip *mediaTimeClip; // @dynamic mediaTimeClip;
...
@property(retain, nonatomic) YTIUnpluggedHighlightClip *utcClip; // @dynamic utcClip;
