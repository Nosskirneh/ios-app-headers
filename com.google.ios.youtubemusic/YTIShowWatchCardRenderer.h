...
@class NSData, NSMutableArray, YTICommand, YTIFormattedString, YTIStandaloneBadgeSupportedRenderers, YTIWatchCardCallToActionSupportedRenderers, YTIWatchCardRelatedData;

@interface YTIShowWatchCardRenderer : GPBMessage
{
}
