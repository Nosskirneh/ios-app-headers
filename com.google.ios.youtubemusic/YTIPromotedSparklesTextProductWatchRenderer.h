...
@class NSData, NSMutableArray, YTIActiveViewDisplayMeasurement, YTIPromotedSparklesTextProductContent, YTIRenderer;
...
@property(retain, nonatomic) YTIPromotedSparklesTextProductContent *content; // @dynamic content;
