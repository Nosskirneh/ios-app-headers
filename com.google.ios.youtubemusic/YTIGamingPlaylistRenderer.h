...
@class NSData, NSMutableArray, NSString, YTICommand, YTIFormattedString, YTIMenuSupportedRenderers, YTIPlaylistThumbnailSupportedRenderers;

@interface YTIGamingPlaylistRenderer : GPBMessage
{
}
