...
@property(retain, nonatomic) YTIFormattedString *advertiserText; // @dynamic advertiserText;
...
@property(nonatomic) _Bool hasAdvertiserText; // @dynamic hasAdvertiserText;
...
@property(nonatomic) _Bool hasSeparatorText; // @dynamic hasSeparatorText;
...
@property(retain, nonatomic) YTIFormattedString *separatorText; // @dynamic separatorText;
