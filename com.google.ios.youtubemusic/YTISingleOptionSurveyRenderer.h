...
#import "YTSurveyPromosheetViewModel-Protocol.h"

@class NSArray, NSData, NSMutableArray, NSString, YTIButtonSupportedRenderers, YTICommand, YTIFormattedString, YTISurveyOrientation, YTISurveyRendererDisplayStart;
...
@property(retain, nonatomic) YTISurveyRendererDisplayStart *displayStart; // @dynamic displayStart;
...
@property(nonatomic) _Bool hasDisplayStart; // @dynamic hasDisplayStart;
