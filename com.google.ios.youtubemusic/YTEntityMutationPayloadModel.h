...
@class NSData, YTIEntityMutationPayload;
...
@interface YTEntityMutationPayloadModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIEntityMutationPayload *_protoBuf;
}

@property(copy, nonatomic) YTIEntityMutationPayload *protoBuf; // @synthesize protoBuf=_protoBuf;
