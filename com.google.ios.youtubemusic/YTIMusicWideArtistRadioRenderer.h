...
@class NSData, YTICommand, YTIFormattedString, YTIMenuSupportedRenderers, YTIMusicWideArtistRadioThumbnailSupportedRenderers;
...
@property(retain, nonatomic) YTIMusicWideArtistRadioThumbnailSupportedRenderers *thumbnailRenderer; // @dynamic thumbnailRenderer;
