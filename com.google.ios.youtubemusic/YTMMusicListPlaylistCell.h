...
@class NSString, QTMButton, UILongPressGestureRecognizer, YTFormattedStringLabel, YTIMusicListPlaylistRenderer, YTImageView, YTMBevelView, YTMOfflinePlaylistStatusController, YTMPlaylistThumbnailOverlayView, YTMTransferButton;
@protocol YTResponder;

@interface YTMMusicListPlaylistCell : YTMCollectionViewCell <YTMOfflinePlaylistStatusControllerObserver, YTCellActionProtocol, YTCollectionViewCellProtocol, YTReusableView, YTThumbnailMapping>
{
    YTIMusicListPlaylistRenderer *_entry;
    YTFormattedStringLabel *_titleLabel;
    YTFormattedStringLabel *_bylineLabel;
    UILongPressGestureRecognizer *_longPressGestureRecognizer;
    QTMButton *_actionButton;
    YTMPlaylistThumbnailOverlayView *_thumbnailOverlayView;
...
+ (double)thumbnailHeightForEntry:(id)arg1;
