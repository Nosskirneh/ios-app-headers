...
@class NSData, NSMutableArray, NSString, YTIBadgeSupportedRenderers, YTIButtonSupportedRenderers, YTICommand, YTIFormattedString, YTIScreenBasedVisibilityCondition, YTIThumbnailDetails, YTIUnpluggedButtonSupportedRenderers, YTIUnpluggedSubscribeButtonSupportedRenderers;
