...
@class NSString, UIButton, UILabel, UISlider, YTAirPlayView, YTPlayerBarMarkerView, YTStoryboardFrameView;
@protocol YTCommonButton, YTPlayerBarViewDelegate, YTPlayerBarViewResourcesProtocol, YTResponder;
...
@interface YTPlayerBarView : UIView <YTStoryboardControllerDelegate, YTPlayerScrubberProtocol, YTAirPlayViewDelegate, YTResponder>
{
    ...
    UIButton<YTCommonButton> *_fullscreenButton;
    UIButton<YTCommonButton> *_adChoicesButton;
    _Bool _adChoicesEnabled;
    UIButton<YTCommonButton> *_cardboardButton;
...
- (void)setPlayPauseReplayButtonHidden:(_Bool)arg1;
- (void)setCardboardEnabled:(_Bool)arg1;
- (void)setStoryboardEnabled:(_Bool)arg1;
- (void)setDelegate:(id)arg1;
- (void)setAdChoicesEnabled:(_Bool)arg1;
