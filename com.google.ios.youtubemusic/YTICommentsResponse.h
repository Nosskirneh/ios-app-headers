...
@class NSData, YTICommentsResponseSupportedRenderers, YTIContinuationSupportedRenderers, YTIResponseContext;
...
@property(retain, nonatomic) YTICommentsResponseSupportedRenderers *contents; // @dynamic contents;
