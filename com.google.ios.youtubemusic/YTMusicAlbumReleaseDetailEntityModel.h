...
@class NSArray, NSData, NSDictionary, NSString, YTIMusicAlbumReleaseDetailEntity, YTMusicAlbumReleaseEntityModel;
...
@interface YTMusicAlbumReleaseDetailEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMusicAlbumReleaseDetailEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMusicAlbumReleaseDetailEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
- (id)copy;
- (void)tracksArrayAtIndexes:(id)arg1 callbackQueue:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
