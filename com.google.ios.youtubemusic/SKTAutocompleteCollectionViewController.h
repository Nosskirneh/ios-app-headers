...
@protocol SKTMaximizedViewControllerOptions, SKTPeoplePickerDelegate;

@interface SKTAutocompleteCollectionViewController : SKTContactsCollectionViewController <SKTPeoplePicker, SKTContactsDataManagerDelegate, SKTSelectedContactsViewControllerDelegate, QTMCollectionViewModelDelegate>
{
    id <SKTPeoplePickerDelegate> peoplePickerDelegate;
...
@property(nonatomic) __weak id <SKTPeoplePickerDelegate> peoplePickerDelegate; // @synthesize peoplePickerDelegate;
- (void).cxx_destruct;
...
- (void)loadLayout;
- (void)loadModel;
- (id)initWithUiOptions:(id)arg1 contactsDataManager:(id)arg2 analyticsProvider:(id)arg3 selectedContactsVC:(id)arg4;
