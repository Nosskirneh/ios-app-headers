...
@class NSData, YTIVisibilityLoggingDirectives;
...
@interface YTVisibilityLoggingDirectivesModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIVisibilityLoggingDirectives *_protoBuf;
}

@property(copy, nonatomic) YTIVisibilityLoggingDirectives *protoBuf; // @synthesize protoBuf=_protoBuf;
