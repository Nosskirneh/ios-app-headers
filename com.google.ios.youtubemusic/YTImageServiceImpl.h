...
#import "YTElementsImageDownloader-Protocol.h"

@class GIMMe, NSHashTable, NSString, YTImageDiskCache, YTImageMemoryCache;
@protocol YTImageSelectionStrategy, YTThumbnailLatencyLogger;

@interface YTImageServiceImpl : YTImageService <ELMImageDownloader, YTElementsImageDownloader>
{
...
- (id)imageWithData:(id)arg1 loggingNonce:(id)arg2;
