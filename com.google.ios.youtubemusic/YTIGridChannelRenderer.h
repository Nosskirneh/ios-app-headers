...
@class NSData, NSMutableArray, NSString, YTIAssociatedGameSupportedRenderers, YTICommand, YTIFormattedString, YTIGridChannelSubscribeButtonSupportedRenderers, YTIMainAppGridRendererStyle, YTIMenuSupportedRenderers, YTIThumbnailDetails;
...
@property(retain, nonatomic) YTIGridChannelSubscribeButtonSupportedRenderers *subscribeButton; // @dynamic subscribeButton;
