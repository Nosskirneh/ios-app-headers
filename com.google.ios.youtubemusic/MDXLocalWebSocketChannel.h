...
#import "MDXChannel-Protocol.h"
#import "MDXWebSocketServerDelegate-Protocol.h"
...
+ (CDUnknownBlockType)payloadBlockWithServerEventType:(int)arg1 launchFailure:(id)arg2;
