...
#import "YTAdsSingleVideoObserverDelegate-Protocol.h"
...
@protocol MLCuepointObserver, MLVideoTimeline, YTAdsPlaybackCoordinatorDelegate, YTResponder, YTSingleVideoObservable;
...
- (void)singleVideoPlayerProgressWithMLTime:(CDStruct_d60ef703)arg1;
