...
@class NSArray, NSDate, NSMutableArray, NSMutableOrderedSet, NSMutableSet, NSSet, NSString, Reachability, SKTAddressBook, SKTAnalyticsProvider, SKTClientConfig, SKTLatencyTimer;
@protocol PDLPeopleDataService, PDLPhenotypeFlags, PDLSession, SKTContactsDataManagerDelegate, SKTSendKitCoreOptions;
...
- (void)dealloc;
@property(readonly, nonatomic) id <PDLPhenotypeFlags> populousExperimentFlags;
