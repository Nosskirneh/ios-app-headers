...
@class NSData, NSMutableArray, NSString, YTIBooleanFormFieldSupportedRenderers, YTIConfirmMultiRecipientShareDialogueSupportedRenderers, YTIFormattedString, YTIMessageInputSupportedRenderers, YTIRenderer, YTISharePanelHeaderSupportedRenderers, YTISharePanelIdentityConfirmationSupportedRenderers, YTISharePanelPromoSupportedRenderers;
...
@property(nonatomic) _Bool hasIdConfirmationDialog; // @dynamic hasIdConfirmationDialog;
...
@property(retain, nonatomic) YTISharePanelIdentityConfirmationSupportedRenderers *idConfirmationDialog; // @dynamic idConfirmationDialog;
