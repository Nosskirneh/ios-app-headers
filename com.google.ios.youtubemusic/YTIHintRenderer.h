...
@class NSArray, NSMutableArray, NSString, YTICommand, YTIFormattedString, YTIHintCondition, YTIHintContentSupportedRenderers, YTIHintDismiss, YTIHintRenderer_HintCap, YTIHintSuggestedPosition;
