...
@class AVAsset, AVPlayer, AVPlayerItem, AVURLAsset, GIMMe, MLFormat, NSDate, NSError, NSURL, YTIIosAvPlayerConfig, YTIIosAvPlayerHotConfig;
@protocol AVAssetResourceLoaderDelegate, HAMClock, MLAVAssetPlayerDelegate, MLFairPlayKeySessionProtocol, MLPlayerConfig, NSObject;
...
@interface MLAVAssetPlayer : NSObject
{
    ...
    id <MLFairPlayKeySessionProtocol> _keySession;
