...
@class NSMutableArray, YTIResponseContext, YTIVMVideoListSupportedContinuations;
...
@property(retain, nonatomic) YTIVMVideoListSupportedContinuations *continuation; // @dynamic continuation;
