...
@class NSMutableArray, YTIActionResult, YTICreateCommentResponseSupportedRenderers, YTIFrameworkUpdateTransport, YTIResponseContext;
...
@property(retain, nonatomic) YTICreateCommentResponseSupportedRenderers *contents; // @dynamic contents;
