...
@property(nonatomic) _Bool hasBackgroundIcon; // @dynamic hasBackgroundIcon;
...
@property(nonatomic) _Bool hasInterstitialColorPalette; // @dynamic hasInterstitialColorPalette;
