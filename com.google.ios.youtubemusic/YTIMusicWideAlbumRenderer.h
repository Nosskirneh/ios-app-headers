...
@class NSData, NSString, YTICommand, YTIFormattedString, YTIMenuSupportedRenderers, YTIMusicWideAlbumOfflineabilitySupportedRenderers, YTIMusicWideAlbumThumbnailSupportedRenderers;

@interface YTIMusicWideAlbumRenderer : GPBMessage <YTMOfflinePlaylistIDProtocol>
{
}
...
@property(retain, nonatomic) YTIMusicWideAlbumOfflineabilitySupportedRenderers *offlineability; // @dynamic offlineability;
@property(readonly) Class superclass;
@property(retain, nonatomic) YTIMusicWideAlbumThumbnailSupportedRenderers *thumbnailRenderer; // @dynamic thumbnailRenderer;
