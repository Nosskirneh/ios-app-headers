...
#import "YTCorrectedQuery-Protocol.h"
...
@property(nonatomic) _Bool hasResultsFor; // @dynamic hasResultsFor;
@property(nonatomic) _Bool hasTrackingParams; // @dynamic hasTrackingParams;
@property(nonatomic) _Bool hasWithoutQuotes; // @dynamic hasWithoutQuotes;
@property(readonly) unsigned long long hash;
@property(retain, nonatomic) YTIFormattedString *resultsFor; // @dynamic resultsFor;
@property(readonly) Class superclass;
@property(copy, nonatomic) NSData *trackingParams; // @dynamic trackingParams;
@property(retain, nonatomic) YTIFormattedString *withoutQuotes; // @dynamic withoutQuotes;
