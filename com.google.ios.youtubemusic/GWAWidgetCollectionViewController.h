...
@class GOOFlexibleHeaderViewController, GOOHeaderNavigationView, GWACollectionViewModel, GWADependencyGraph, GWAPageDetails, GWASubmitAction, GWAWidgetOptions, GWAWidgetSubmitter, GWAWidgetViewModel, NSMutableArray, NSMutableDictionary, NSString, QTMColorGroup, UIViewController;
...
@interface GWAWidgetCollectionViewController : MDCCollectionViewController <GOOHeaderNavigationParentViewController, GWAWidgetViewModelDelegate, GWAResultingComponent, GWATriggerComponent, GWAWidgetSubmitterDelegate, GWAFlow, GWAFlowSectionDelegate>
{
    ...
    NSMutableArray *_modelIndexToCollectionSectionIndexArray;
...
- (unsigned long long)indexInCollecionForSection:(id)arg1;
