...
@class GIMMe, NSString, YTInteractionLoggingController;
...
- (void).cxx_destruct;
- (void)logErrorWithPayloadBlock:(CDUnknownBlockType)arg1;
- (id)dumpViewHierarchy;
- (void)extractCallerInfo:(CDUnknownBlockType)arg1;
- (CDUnknownBlockType)payloadBlockWithError:(int)arg1 model:(id)arg2 requestedIndex:(long long)arg3 availabledItems:(long long)arg4;
