...
@class AVSampleBufferAudioRenderer, AVSampleBufferRenderSynchronizer, GIMMe, NSString;
@protocol HAMAudioSessionDelegate, HAMClock, HAMFormat, HAMRootMediaSource, HAMSampleBufferSource, HAMTrackRendererDelegate;

@interface HAMSBARAudioTrackRenderer : HAMBaseTrackRenderer <HAMAudioSessionEventObserver, HAMSampleBufferSourceDelegate, HAMSystemNotificationsObserver, HAMAudioTrackRenderer>
{
    id <HAMClock> _clock;
