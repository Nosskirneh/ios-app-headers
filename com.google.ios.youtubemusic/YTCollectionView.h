...
@interface YTCollectionView : UICollectionView <YTPageStyling, YTCellActionConfirmationCollectionViewProtocol, YTScrollBubbleCollectionViewProtocol>
{
...
- (id)initWithFrame:(struct CGRect)arg1 collectionViewLayout:(id)arg2 lazilyLoadActivityIndicator:(_Bool)arg3;
