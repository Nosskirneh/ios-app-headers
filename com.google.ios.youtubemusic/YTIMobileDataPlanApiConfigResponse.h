...
@class YTIMobileDataPlanApiSupportedConfigs, YTIResponseContext;

@interface YTIMobileDataPlanApiConfigResponse : GPBMessage
{
}
...
@property(retain, nonatomic) YTIMobileDataPlanApiSupportedConfigs *config; // @dynamic config;
