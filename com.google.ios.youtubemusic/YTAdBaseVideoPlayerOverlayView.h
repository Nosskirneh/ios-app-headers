...
@interface YTAdBaseVideoPlayerOverlayView : YTAdBasePlayerOverlayView <UIGestureRecognizerDelegate, YTResponder, YTVideoPlayerOverlayGestureRecognizerDelegate>
{
