...
@class NSData, NSMutableArray, YTIAccessibilitySupportedDatas, YTIFormattedString, YTIIcon, YTIRenderer, YTIThumbnailDetails;
...
@property(nonatomic) _Bool hasLogoIcon; // @dynamic hasLogoIcon;
