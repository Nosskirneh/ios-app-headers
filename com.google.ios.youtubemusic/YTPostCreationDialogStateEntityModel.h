...
@class NSData, NSDictionary, NSString, YTIPostCreationDialogStateEntity;
...
@interface YTPostCreationDialogStateEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIPostCreationDialogStateEntity *_protoBuf;
}

@property(copy, nonatomic) YTIPostCreationDialogStateEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
