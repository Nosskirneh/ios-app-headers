...
@class MDCInkView, NSMutableDictionary, NSString, QTMColorGroup, UIColor;
...
+ (id)flatButton;
+ (Class)layerClass;
+ (id)gks_buttonWithObject:(id)arg1;
+ (id)gwa_ocrButtonWithColorGroup:(id)arg1 style:(unsigned long long)arg2;
+ (id)ytm_specialtyButtonFromButtonRenderer:(id)arg1 backgroundColor:(id)arg2 textColor:(id)arg3 borderColor:(id)arg4 iconColor:(id)arg5;
+ (id)ytm_flatButtonWithTitle:(id)arg1 image:(id)arg2 selectedImage:(id)arg3 accessibilityLabel:(id)arg4 accessibilityIdentifier:(id)arg5;
+ (id)ytm_flatRectangularButton;
+ (id)ytm_raisedButtonWithTitle:(id)arg1 image:(id)arg2 selectedImage:(id)arg3 accessibilityLabel:(id)arg4 accessibilityIdentifier:(id)arg5;
+ (id)ytm_likeButtonWithColor:(id)arg1;
+ (id)ytm_actionButton;
+ (id)ytm_largeFloatingButtonWithImage:(id)arg1 selectedImage:(id)arg2 accessibilityLabel:(id)arg3 accessibilityIdentifier:(id)arg4;
+ (id)ytm_largeFlatRoundButtonWithImage:(id)arg1 selectedImage:(id)arg2 accessibilityLabel:(id)arg3 accessibilityIdentifier:(id)arg4;
+ (id)ytm_flatRoundButtonWithImage:(id)arg1 selectedImage:(id)arg2 accessibilityLabel:(id)arg3 accessibilityIdentifier:(id)arg4;
+ (id)ytm_greySpecialtyButtonFromButtonRenderer:(id)arg1;
+ (id)ytm_whiteSpecialtyButtonFromButtonRenderer:(id)arg1;
...
- (void)ytm_setSelected:(_Bool)arg1 crossFadeDuration:(double)arg2;
- (void)ytm_setImage:(id)arg1 selectedImage:(id)arg2 accessibilityLabel:(id)arg3 accesssibilityIdentifier:(id)arg4;
