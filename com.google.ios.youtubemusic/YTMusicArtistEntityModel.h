...
@class NSData, NSDictionary, NSString, YTIMusicArtistEntity, YTMusicArtistDetailEntityModel, YTMusicArtistUserDetailEntityModel, YTThumbnailDetailsModel;
...
@interface YTMusicArtistEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMusicArtistEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMusicArtistEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
