...
@interface YTIConversationPlaylistItemRenderer : GPBMessage
{
}
...
@property(nonatomic) _Bool hasPlaylistAuthorName; // @dynamic hasPlaylistAuthorName;
...
@property(copy, nonatomic) NSString *playlistAuthorName; // @dynamic playlistAuthorName;
