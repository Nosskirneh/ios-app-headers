...
@property(nonatomic) _Bool collapsedShelfAllowed; // @dynamic collapsedShelfAllowed;
...
@property(nonatomic) _Bool forceCollapsedShelf; // @dynamic forceCollapsedShelf;
@property(nonatomic) _Bool hasCollapsedShelfAllowed; // @dynamic hasCollapsedShelfAllowed;
...
@property(nonatomic) _Bool hasForceCollapsedShelf; // @dynamic hasForceCollapsedShelf;
