...
@class NSData, NSString, YTICommand, YTIFormattedString, YTIMenuSupportedRenderers, YTIMusicNarrowAlbumOfflineabilitySupportedRenderers, YTIMusicNarrowAlbumThumbnailSupportedRenderers;

@interface YTIMusicNarrowAlbumRenderer : GPBMessage <YTMOfflinePlaylistIDProtocol>
{
}
...
@property(retain, nonatomic) YTIMusicNarrowAlbumOfflineabilitySupportedRenderers *offlineability; // @dynamic offlineability;
@property(readonly) Class superclass;
@property(retain, nonatomic) YTIMusicNarrowAlbumThumbnailSupportedRenderers *thumbnailRenderer; // @dynamic thumbnailRenderer;
