...
@class NSData, YTIMusicAlbumReleaseContentRating;
...
@interface YTMusicAlbumReleaseContentRatingModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIMusicAlbumReleaseContentRating *_protoBuf;
}

@property(copy, nonatomic) YTIMusicAlbumReleaseContentRating *protoBuf; // @synthesize protoBuf=_protoBuf;
