...
@class GIMMe, NSString, YTGlobalConfig, YTInstreamAdSingleVideoObserver, YTInstreamAdTrackingController, YTInstreamAdsCoordinator, YTPlayerCurrentAdsState, YTUserDefaults, YTVideoAdsOverlayCoordinator;
@protocol MLCuepointObserver, MLVideoTimeline, YTAdsPlaybackCoordinatorDelegate, YTResponder;
