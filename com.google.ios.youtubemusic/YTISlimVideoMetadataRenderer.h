...
@class NSData, NSMutableArray, NSString, YTICommand, YTIFormattedString, YTIRenderer, YTISlimMetadataOfflineButtonTooltipSupportedRenderers, YTISlimOwnerSupportedRenderers, YTIStandaloneBadgeSupportedRenderers, YTIVideoMetadataRowContainerSupportedRenderers;
