...
@class NSData, YTICommand, YTIFormattedString, YTIMenuSupportedRenderers, YTIMusicNarrowArtistRadioThumbnailSupportedRenderers;
...
@property(retain, nonatomic) YTIMusicNarrowArtistRadioThumbnailSupportedRenderers *thumbnailRenderer; // @dynamic thumbnailRenderer;
