...
@class NSData, YTAddFromPhonebookLinkModel, YTContactEntityModel, YTIChatMessageLinkType;
@protocol YTEntityStore;

@interface YTChatMessageLinkTypeModel : NSObject <NSCopying, NSMutableCopying>
{
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    YTAddFromPhonebookLinkModel *_addFromPhonebookLink;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIChatMessageLinkType *_protoBuf;
}

@property(copy, nonatomic) YTIChatMessageLinkType *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTAddFromPhonebookLinkModel *addFromPhonebookLink; // @synthesize addFromPhonebookLink=_addFromPhonebookLink;
- (void).cxx_destruct;
...
@property(readonly, nonatomic) _Bool viewYouMayKnowLink;
@property(readonly, nonatomic) _Bool sendInviteLink;
@property(readonly, nonatomic) NSData *text;
@property(readonly, nonatomic) int subTypeOneOfCase;
- (id)init;
