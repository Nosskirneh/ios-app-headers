...
+ (id)descriptor;
+ (id)playlistVideoRendererWithOfflineVideoData:(id)arg1 playlistID:(id)arg2 index:(unsigned long long)arg3 useOfflineWatchNavigationEndpoint:(_Bool)arg4;
+ (id)playlistVideoRendererWithOfflineVideo:(id)arg1 playlistID:(id)arg2 index:(unsigned long long)arg3 offlineMode:(_Bool)arg4 useOfflineWatchNavigationEndpoint:(_Bool)arg5;
