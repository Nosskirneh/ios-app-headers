...
- (id)createDiscoveryLoggingSessionWithDiscoveryCriteria:(id)arg1 wifiBSSID:(id)arg2 analyticsEnabled:(_Bool)arg3;
- (void)cancelAllReportTimers;
- (id)generateFakeReceiverMetricsIDWithDeviceID:(id)arg1 asGuestMode:(_Bool)arg2;
...
- (id)createPrecacheActivity:(id)arg1 messageType:(long long)arg2 error:(id)arg3 requestTimestamp:(double)arg4;
- (id)createTCPProbingResult:(id)arg1 invocationReason:(long long)arg2 probingResult:(int)arg3 discoveryCriteria:(id)arg4 connectionError:(id)arg5;
...
- (void)logKeyExchangeRequestWithResult:(long long)arg1 requestTimestamp:(double)arg2 error:(id)arg3;
- (void)logFailedPrecacheActivity:(id)arg1 messageType:(long long)arg2 error:(id)arg3 requestTimestamp:(double)arg4;
- (void)logSuccessfulPrecacheActivity:(id)arg1 messageType:(long long)arg2 requestTimestamp:(double)arg3;
...
- (void)logSessionEnd:(long long)arg1;
- (void)logSessionResumed;
- (void)logSessionResuming:(id)arg1 applicationID:(id)arg2 reason:(long long)arg3;
...
- (void)logAbortedTCPProbingResult:(id)arg1 invocationReason:(long long)arg2 discoveryCriteria:(id)arg3;
- (void)logFailedTCPProbingResult:(id)arg1 invocationReason:(long long)arg2 discoveryCriteria:(id)arg3 error:(id)arg4;
- (void)logSuccessfulTCPProbingResult:(id)arg1 invocationReason:(long long)arg2 discoveryCriteria:(id)arg3;
...
- (void)logDiscoveryStopWithReason:(long long)arg1;
- (void)logDiscoveryPing;
- (void)logDiscoveryStartWithDiscoveryCriteria:(id)arg1 wifiBSSID:(id)arg2 analyticsEnabled:(_Bool)arg3;
