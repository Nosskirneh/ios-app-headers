...
@class GPBEnumArray, NSData, YTIButtonSupportedRenderers, YTIFlowBodySupportedRenderers, YTIFlowProgressSupportedRenderers, YTIFormattedString;
...
@property(retain, nonatomic) GPBEnumArray *bodyImagesArray; // @dynamic bodyImagesArray;
@property(readonly, nonatomic) unsigned long long bodyImagesArray_Count; // @dynamic bodyImagesArray_Count;
