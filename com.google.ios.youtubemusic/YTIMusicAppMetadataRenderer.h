...
@property(nonatomic) _Bool hasIsVoicePromptEnabled; // @dynamic hasIsVoicePromptEnabled;
...
@property(nonatomic) _Bool isVoicePromptEnabled; // @dynamic isVoicePromptEnabled;
