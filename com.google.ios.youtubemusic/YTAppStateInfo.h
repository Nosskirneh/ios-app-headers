...
@interface YTAppStateInfo : NSObject <NSCoding>
{
    ...
    NSDate *_deadlockDetectedDate;
}

@property(retain) NSDate *deadlockDetectedDate; // @synthesize deadlockDetectedDate=_deadlockDetectedDate;
@property _Bool deadlockDetected; // @synthesize deadlockDetected=_deadlockDetected;
