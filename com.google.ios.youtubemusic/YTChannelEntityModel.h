...
@class NSData, NSDictionary, NSString, YTIChannelEntity, YTThumbnailDetailsModel;
...
@interface YTChannelEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIChannelEntity *_protoBuf;
}

@property(copy, nonatomic) YTIChannelEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
