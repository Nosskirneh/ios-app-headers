...
#import "ASMPromoItemContentViewDelegate-Protocol.h"
...
@interface ASMDynamicMenuViewController : QTMCollectionViewController <UICollectionViewDelegate, ASMPromoItemContentViewDelegate, QTMCollectionViewStyleDelegate, GOOWebViewControllerDelegate, GOOFlexibleHeaderParentViewController, ASMHeaderDelegate>
{
    long long _screenID;
