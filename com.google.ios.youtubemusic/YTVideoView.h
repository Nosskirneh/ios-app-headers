...
@class FLXLayout, NSString, UIButton, UILongPressGestureRecognizer, YTBadge, YTBadgesView, YTEngagementToolbarView, YTFeedActionBarView, YTFormattedStringLabel, YTImageView, YTLabel, YTPostFeedEntryView, YTQTMButton, YTStandaloneBadgeView, YTVideoSubtitleView, YTVideoThumbnailView;
@protocol GA11YMixinImpl, YTCellLinkDelegate, YTCommonButton, YTFeedActionBarDelegate, YTVideoViewModel;
...
@interface YTVideoView : UIView <GA11YMixinEmbedder, UIGestureRecognizerDelegate, YTCellActionProtocol, YTCellLinkProtocol, YTFeedActionBarProtocol, YTInlineMutedPlaybackProtocol, YTPageStyling, YTReusableView, YTThumbnailMapping, YTWatchTransitionViewProtocol>
{
    ...
    UIButton<YTCommonButton> *_callToActionButton;
...
@property(readonly, nonatomic) UIButton<YTCommonButton> *callToActionButton; // @synthesize callToActionButton=_callToActionButton;
