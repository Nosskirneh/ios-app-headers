...
@class CAShapeLayer, MDCInkLayer, MDCLegacyInkLayer, NSString, UIColor;
@protocol MDCInkViewDelegate;

@interface MDCInkView : UIView <CALayerDelegate, MDCInkLayerDelegate>
{
    ...
    MDCInkLayer *_activeInkLayer;
}

+ (id)injectedInkViewForView:(id)arg1;
+ (Class)layerClass;
@property(retain, nonatomic) MDCInkLayer *activeInkLayer; // @synthesize activeInkLayer=_activeInkLayer;
...
@property(readonly, nonatomic) MDCLegacyInkLayer *inkLayer;
