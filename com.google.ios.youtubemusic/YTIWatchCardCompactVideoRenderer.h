...
@class NSData, NSMutableArray, NSString, YTICommand, YTIFormattedString, YTIMainAppCompactRendererStyle, YTIMenuSupportedRenderers, YTIThumbnailDetails;
...
@property(nonatomic) _Bool hasSerialId; // @dynamic hasSerialId;
...
@property(copy, nonatomic) NSString *serialId; // @dynamic serialId;
