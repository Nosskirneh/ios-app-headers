...
@class NSData, NSString, YTIForegroundChatData;
@protocol YTEntityStore;

@interface YTForegroundChatDataModel : NSObject <NSCopying, NSMutableCopying>
{
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIForegroundChatData *_protoBuf;
}

@property(copy, nonatomic) YTIForegroundChatData *protoBuf; // @synthesize protoBuf=_protoBuf;
