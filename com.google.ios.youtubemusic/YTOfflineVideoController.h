...
#import "MLOfflineVideoDownloadDelegate-Protocol.h"
#import "YTHotConfigObserver-Protocol.h"
#import "YTOfflineGELEventCacheProtocol-Protocol.h"
#import "YTOfflineImageControllerObserver-Protocol.h"
#import "YTOfflineVideoAdPlaylistProvider-Protocol.h"
#import "YTOfflineVideoProvider-Protocol.h"
#import "YTRetryTaskConfig-Protocol.h"

@class GIMMe, MLOfflineVideoDownloadController, NSDate, NSHashTable, NSString, YTOfflineDataService, YTOfflineImageController;
...
+ (id)videoForPlayerResponse:(id)arg1;
...
- (_Bool)isRecoverableDownloadErrorInRelaxedStrategy:(id)arg1;
- (_Bool)isRecoverableFailureInRelaxedStrategy:(int)arg1;
- (_Bool)relaxedRetriesEnabled;
- (id)offlineGELEventController;
- (_Bool)isTerminalOfflineVideoStatus:(int)arg1;
- (_Bool)isDownloadingOfflineVideoStatus:(int)arg1;
- (id)currentDate;
...
- (void)setVideoStatusForID:(id)arg1 videoStatus:(int)arg2 failedDownloadError:(id)arg3 responseBlock:(CDUnknownBlockType)arg4 errorBlock:(CDUnknownBlockType)arg5;
- (void)setVideoStatusForID:(id)arg1 videoStatus:(int)arg2 responseBlock:(CDUnknownBlockType)arg3 errorBlock:(CDUnknownBlockType)arg4;
...
- (void)offlineDownloadController:(id)arg1 didFinishBackgroundTaskResotorationWithTask:(id)arg2;
- (void)offlineDownloadDidEnterBackgroundWithVideoID:(id)arg1;
- (void)offlineDownloadBackgroundTaskDidExpire;
- (void)handleDownloadFailureWithVideoID:(id)arg1 error:(id)arg2;
