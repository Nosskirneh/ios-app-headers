...
@interface YTICreatorMonetizationStateRenderer : GPBMessage
{
}
...
@property(retain, nonatomic) NSMutableArray *shortMessageArray; // @dynamic shortMessageArray;
@property(readonly, nonatomic) unsigned long long shortMessageArray_Count; // @dynamic shortMessageArray_Count;
