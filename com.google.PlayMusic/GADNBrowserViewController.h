...
@class GADNEventContext, GADNWebViewController, NSString, NSURL, UIActivityIndicatorView, UIBarButtonItem, UIToolbar;
@protocol GADNBrowserViewControllerDelegate;
...
@interface GADNBrowserViewController : UIViewController <GADNWebViewControllerDelegate, GADNPresenting>
{
    ...
    id <GADNBrowserViewControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <GADNBrowserViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
