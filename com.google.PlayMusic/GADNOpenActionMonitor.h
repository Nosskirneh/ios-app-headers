...
#import "GADNBrowserViewControllerDelegate-Protocol.h"
#import "GADNWebAdViewDelegate-Protocol.h"

@class GADNAd, GADNClickProtection, GADNObserverCollection, NSMapTable, NSString;

@interface GADNOpenActionMonitor : NSObject <GADNBrowserViewControllerDelegate, GADNWebAdViewDelegate>
{
    GADNAd *_ad;
...
- (void)browser:(id)arg1 openURLInSafari:(id)arg2;
