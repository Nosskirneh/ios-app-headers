...
@interface GTLRSJQuery_ExploreGettabs : GTLRSJQuery
{
}
...
@property(nonatomic) long long numItems; // @dynamic numItems;
@property(copy, nonatomic) NSString *tabs; // @dynamic tabs;
