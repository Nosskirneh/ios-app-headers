...
@class GADNAdChoicesView, GADNMediaView, GADNNativeAssetViewTracker, GADNOverlayView, GADNUnifiedNativeAd, NSArray, NSString;

@interface GADNUnifiedNativeAdView : UIView <GADNNativeAdViewOverlayProtocol>
{
