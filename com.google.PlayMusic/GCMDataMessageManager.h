...
@class GCMClient, GCMDelayedMessageQueue, GCMRmqManager, GCMSyncMessageManager, NSString;
...
@property(retain, nonatomic) GCMDelayedMessageQueue *delayedMessagesQueue; // @synthesize delayedMessagesQueue=_delayedMessagesQueue;
@property(nonatomic) __weak id <GCMDataMessageManagerDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) __weak GCMSyncMessageManager *syncMessageManager; // @synthesize syncMessageManager=_syncMessageManager;
@property(nonatomic) __weak GCMRmqManager *rmq2Manager; // @synthesize rmq2Manager=_rmq2Manager;
@property(nonatomic) __weak GCMClient *client; // @synthesize client=_client;
- (void).cxx_destruct;
