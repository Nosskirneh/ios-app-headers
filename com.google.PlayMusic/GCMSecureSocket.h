...
@class GCMPacketQueue, NSInputStream, NSMutableData, NSOutputStream, NSRunLoop, NSString;
...
@property(retain, nonatomic) GCMPacketQueue *packetQueue; // @synthesize packetQueue=_packetQueue;
...
@property(nonatomic) __weak id <GCMSecureSocketDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)performWrite;
