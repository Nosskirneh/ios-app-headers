...
@interface GTLRSJQuery_ConfigList : GTLRSJQuery
{
}
...
@property(copy, nonatomic) NSString *readStrategy; // @dynamic readStrategy;
@property(copy, nonatomic) NSString *tier; // @dynamic tier;
@property(nonatomic) _Bool useTargeting; // @dynamic useTargeting;
