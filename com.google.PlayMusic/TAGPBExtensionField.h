...
- (unsigned long long)computeTAGPBSerializedSizeIncludingTag:(CDUnion_c05604a2)arg1;
- (unsigned long long)computeTAGPBSerializedSizeNoTag:(CDUnion_c05604a2)arg1;
- (void)writeTAGPBValue:(CDUnion_c05604a2)arg1 noTagToCodedOutputStream:(id)arg2;
- (void)writeTAGPBValue:(CDUnion_c05604a2)arg1 includingTagToCodedOutputStream:(id)arg2;
