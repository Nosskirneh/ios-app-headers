...
@interface GTLRUserLocationQuery_UsersettingsSetapiremotedevicesettings : GTLRUserLocationQuery
{
}

+ (id)queryWithObject:(id)arg1 deviceTag:(long long)arg2 reportingEnabled:(_Bool)arg3 targetDeviceTag:(long long)arg4;
...
@property(copy, nonatomic) NSString *historySource; // @dynamic historySource;
...
@property(nonatomic) _Bool reportingEnabled; // @dynamic reportingEnabled;
@property(copy, nonatomic) NSString *reportingSource; // @dynamic reportingSource;
@property(nonatomic) long long targetDeviceTag; // @dynamic targetDeviceTag;
