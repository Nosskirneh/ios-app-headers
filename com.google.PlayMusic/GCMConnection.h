...
#import "GCMSecureSocketDelegate-Protocol.h"

@class GCMDataMessageManager, GCMRmqManager, GCMSecureSocket, NSMutableArray, NSMutableDictionary, NSRunLoop, NSString;
...
@property(retain, nonatomic) GCMSecureSocket *socket; // @synthesize socket=_socket;
...
@property(nonatomic) __weak id <GCMConnectionDelegate> delegate; // @synthesize delegate=_delegate;
