...
@class GADNWebViewController, NSMutableArray, NSString;
...
+ (void)loadWithHTMLURL:(id)arg1 webViewConfiguration:(id)arg2 eventContext:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void).cxx_destruct;
...
- (void)loadHTMLURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
