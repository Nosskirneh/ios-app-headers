...
@interface MDCSnackbarMessageView : UIView <CAAnimationDelegate>
{
    UIFont *_messageFont;
    UIFont *_buttonFont;
...
@property(retain, nonatomic) UIColor *snackbarMessageViewTextColor;
...
- (void)initializeMDCSnackbarMessageViewButtons:(id)arg1;
