...
@class GADNAdChoicesView, GADNMediaView, GADNNativeAppInstallAd, GADNNativeAssetViewTracker, GADNOverlayView, NSArray, NSString;

@interface GADNNativeAppInstallAdView : UIView <GADNNativeAdViewOverlayProtocol>
{
