...
@class NSString;
@protocol OGLAnalyticsAccountMenuDelegate, OGLAnalyticsAccountParticleDiscDelegate, OGLAnalyticsDefaultAccountDelegate, OGLAnalyticsDrawerAccountHeaderDelegate, OGLAnalyticsExpressSignInDelegate, OGLAnalyticsPrivacyPolicyToSDelegate, OGLAnalyticsProtocol;
