...
@property(nonatomic) int cellOperatorMccmnc; // @dynamic cellOperatorMccmnc;
...
@property(nonatomic) int fallbackMode; // @dynamic fallbackMode;
...
@property(nonatomic) _Bool hasCellOperatorMccmnc; // @dynamic hasCellOperatorMccmnc;
...
@property(nonatomic) _Bool hasFallbackMode; // @dynamic hasFallbackMode;
...
@property(nonatomic) _Bool hasMobileNetworkClass; // @dynamic hasMobileNetworkClass;
...
@property(nonatomic) int mobileNetworkClass; // @dynamic mobileNetworkClass;
