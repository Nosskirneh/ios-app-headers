...
@class GOOAlertView, NSString, SSOActivityShieldView, SSOIdentity, SSOService, UIViewController;

@interface ASMRemoveAccountController : NSObject <GOOAlertViewDelegate, SSOInterfaceControllerDelegate>
{
