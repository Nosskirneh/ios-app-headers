...
@class NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString, PMVAFHTTPBodyPart;

@interface PMVAFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    PMVAFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) PMVAFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
