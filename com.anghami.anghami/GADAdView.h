...
@class GADAd, GADAdViewActiveViewReporter, GADAdViewState, GADAdViewVideoController, GADClearcutLogger, GADVideoPlayer, GADWebView, GADWiggleGestureRecognizer, NSMutableDictionary, NSOperationQueue, NSString, NSURL, UIGestureRecognizer, UIScrollView, UIViewController;
