...
- (void)initialTimestampWithCompletion:(CDUnknownBlockType)arg1;
- (id)initialTimestamp;
...
- (void)setLatitude:(double)arg1 longitude:(double)arg2 horizontalAccuracy:(float)arg3 altitude:(double)arg4 verticalAccuracy:(float)arg5 speed:(float)arg6 bearing:(float)arg7 timeStamp:(id)arg8;
