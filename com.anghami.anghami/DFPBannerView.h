...
+ (id)extraParameters;
+ (id)extraParametersWithoutAuthParams;
+ (id)loadAdWithUnitID:(id)arg1 multipleSizes:(id)arg2 delegate:(id)arg3 params:(id)arg4;
+ (id)loadAdWithUnitID:(id)arg1 size:(struct CGSize)arg2 delegate:(id)arg3 params:(id)arg4;
+ (id)loadAdWithUnitID:(id)arg1 size:(struct CGSize)arg2 delegate:(id)arg3;
+ (id)loadAdWithUnitID:(id)arg1 size:(struct CGSize)arg2;
...
- (void)loadWithAdUnitID:(id)arg1 delegate:(id)arg2 params:(id)arg3;
- (void)preventNonDFPGestures;
- (void)removeBounciness;
