...
@protocol BranchDelegate, OS_dispatch_semaphore;
...
- (_Bool)handleUniversalDeepLink_private:(id)arg1 fromSelf:(_Bool)arg2;
- (_Bool)application:(id)arg1 openURL:(id)arg2 options:(id)arg3;
- (_Bool)application:(id)arg1 openURL:(id)arg2 sourceApplication:(id)arg3 annotation:(id)arg4;
- (_Bool)handleSchemeDeepLink_private:(id)arg1 fromSelf:(_Bool)arg2;
