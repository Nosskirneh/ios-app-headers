...
+ (id)handlerWithConfig:(id)arg1 sessionParametersActionsArray:(id)arg2 deviceToken:(id)arg3;
...
- (void)writeActivityStateS:(id)arg1 changesInStateBlock:(CDUnknownBlockType)arg2;
- (void)writeActivityStateI:(id)arg1;
- (_Bool)updateActivityStateI:(id)arg1 now:(double)arg2;
- (_Bool)isToUpdatePackagesI:(id)arg1;
...
- (void)updateState:(_Bool)arg1 pausingMessage:(id)arg2 remainsPausedMessage:(id)arg3 unPausingMessage:(id)arg4;
- (_Bool)hasChangedState:(_Bool)arg1 nextState:(_Bool)arg2 trueMessage:(id)arg3 falseMessage:(id)arg4;
- (id)adid;
- (_Bool)isEnabled;
...
- (id)initWithConfig:(id)arg1 sessionParametersActionsArray:(id)arg2 deviceToken:(id)arg3;
