...
#import "PMVAFMultipartFormData-Protocol.h"

@class NSMutableURLRequest, PMVAFMultipartBodyStream;

@interface PMVAFStreamingMultipartFormData : NSObject <PMVAFMultipartFormData>
{
    NSMutableURLRequest *_request;
    PMVAFMultipartBodyStream *_bodyStream;
    unsigned long long _stringEncoding;
}

@property(nonatomic) unsigned long long stringEncoding; // @synthesize stringEncoding=_stringEncoding;
@property(retain, nonatomic) PMVAFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
