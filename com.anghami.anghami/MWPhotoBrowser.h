...
#import "ANGArtistOverlayTapDelegate-Protocol.h"
#import "UIActionSheetDelegate-Protocol.h"
#import "UIScrollViewDelegate-Protocol.h"

@class CAGradientLayer, MBProgressHUD, MPMoviePlayerViewController, MWGridViewController, NSArray, NSMutableArray, NSMutableSet, NSString, NSTimer, UIActivityIndicatorView, UIActivityViewController, UIBarButtonItem, UIColor, UIImage, UIImageView, UIScrollView, UIToolbar;
...
@interface MWPhotoBrowser : UIViewController <UIScrollViewDelegate, UIActionSheetDelegate, ANGArtistOverlayTapDelegate>
{
    ...
    _Bool _placeToolBarItemsOnRightBar;
    _Bool _overrideBackground;
...
@property(nonatomic) _Bool overrideBackground; // @synthesize overrideBackground=_overrideBackground;
@property(nonatomic) _Bool placeToolBarItemsOnRightBar; // @synthesize placeToolBarItemsOnRightBar=_placeToolBarItemsOnRightBar;
...
- (void)hideAnghamiNavBar:(_Bool)arg1;
...
- (void)tilePagesImmediate:(_Bool)arg1;
- (void)tilePages;
...
- (id)artistForPhotoAtIndex:(unsigned long long)arg1;
...
- (void)viewDidUnload;
- (void)didTapOverlay;
- (id)artistOverlayAtIndex:(unsigned long long)arg1;
- (void)setBackgroundBlurredImage:(id)arg1;
...
- (id)initWithAnghamiPhotos:(id)arg1;
