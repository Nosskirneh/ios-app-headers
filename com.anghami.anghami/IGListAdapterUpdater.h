...
- (void)performUpdateWithCollectionView:(id)arg1 fromObjects:(id)arg2 toObjectsBlock:(CDUnknownBlockType)arg3 animated:(_Bool)arg4 objectTransitionBlock:(CDUnknownBlockType)arg5 completion:(CDUnknownBlockType)arg6;
