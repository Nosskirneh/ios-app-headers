...
@class ANGSong, AVAssetWriter, AVAssetWriterInput, AVAssetWriterInputPixelBufferAdaptor, AVCaptureMovieFileOutput, CIContext, NSArray, NSDate, NSMutableArray, NSString, NSURL, SCAudioConfiguration, SCRecorder, SCVideoConfiguration;
...
@interface SCRecordSession : NSObject
{
    ...
    CDStruct_1b6d18a9 _totalVideoTime;
}
...
@property(readonly, nonatomic) CDStruct_1b6d18a9 totalVideoTime; // @synthesize totalVideoTime=_totalVideoTime;
...
- (CDStruct_1b6d18a9)_appendTrack:(id)arg1 toCompositionTrack:(id)arg2 atTime:(CDStruct_1b6d18a9)arg3 withBounds:(CDStruct_1b6d18a9)arg4 isVideo:(_Bool)arg5;
