...
- (void)initialTimestampWithCompletion:(void (^)(NSDate *))arg1;
...
- (void)setLatitude:(double)arg1 longitude:(double)arg2 horizontalAccuracy:(float)arg3 altitude:(double)arg4 verticalAccuracy:(float)arg5 speed:(float)arg6 bearing:(float)arg7 timeStamp:(NSDate *)arg8;
@end
