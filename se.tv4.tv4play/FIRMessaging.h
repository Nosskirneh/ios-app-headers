...
@class FIRInstanceID, FIRMessagingClient, FIRMessagingDataMessageManager, FIRMessagingPubSub, FIRMessagingReceiver, FIRMessagingRmqManager, FIRMessagingSyncMessageManager, FIRReachabilityChecker, NSData, NSMutableSet, NSString, NSUserDefaults;
