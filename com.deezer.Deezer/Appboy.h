...
@class ABKFeedController, ABKInAppMessageController, ABKLocationManager, ABKManager, ABKPersistentData, ABKPushNotificationManager, ABKSessionManager, ABKTriggerManager, ABKUser, NSString;
@protocol ABKAppboyEndpointDelegate, ABKIDFADelegate, ABKPushURIDelegate, ABKURLDelegate;

@interface Appboy : NSObject
{
    _Bool _useNUITheming;
    ABKUser *_user;
...
@property(nonatomic) __weak id <ABKPushURIDelegate> appboyPushURIDelegate; // @synthesize appboyPushURIDelegate=_appboyPushURIDelegate;
@property(nonatomic) _Bool useNUITheming; // @synthesize useNUITheming=_useNUITheming;
