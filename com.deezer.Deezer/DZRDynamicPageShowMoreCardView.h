...
@class DZRDynamicPageShadeView, NSString, UIImageView, UILabel, UITapGestureRecognizer, UIView;
@protocol DZRDynamicPageAction;

@interface DZRDynamicPageShowMoreCardView : UICollectionReusableView <DZRDynamicPageSupplementaryView>
{
