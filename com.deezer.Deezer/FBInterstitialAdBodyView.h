...
@class CAShapeLayer, FBAdAudioMuteButton, FBAdPlacementDefinition, FBAdVideoProgressBar, FBAdViewabilityValidator, FBGradientView, FBInterstitialAdMediaView, FBInterstitialAdTextView, FBNativeAdDataModel, NSNumber, NSString, UIButton;
...
- (void)destroyAd;
- (void)processVideoControlEvent:(long long)arg1;
