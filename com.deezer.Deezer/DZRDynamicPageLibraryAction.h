...
@interface DZRDynamicPageLibraryAction : NSObject <DZRDynamicPageAction>
{
    NSString *_name;
    NSString *_kind;
...
+ (id)removeFromLibraryActionWithName:(id)arg1 options:(id)arg2;
+ (id)addToLibraryActionWithName:(id)arg1 options:(id)arg2;
...
- (void).cxx_destruct;
- (void)performAction;
- (id)initWithKind:(id)arg1 name:(id)arg2 options:(id)arg3;
