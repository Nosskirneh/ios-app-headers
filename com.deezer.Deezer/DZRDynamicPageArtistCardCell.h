...
@class DZRDynamicPageOnAirLabel, DZRDynamicPageShadeView, DZREdgeInsetsLabel, NSString, NSURL, UILabel, UIView, _TtC6Deezer16IllustrationView;
@protocol DZRDynamicPageItem;

@interface DZRDynamicPageArtistCardCell : UICollectionViewCell <DZRDynamicPageCell>
{
...
+ (id)cellIdentifier;
@property(retain, nonatomic) NSURL *medallionURL; // @synthesize medallionURL=_medallionURL;
