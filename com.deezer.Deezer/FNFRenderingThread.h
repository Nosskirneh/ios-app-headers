...
+ (id)renderingThreadAllowingAppInactivePlayback:(_Bool)arg1 andShouldSyncBeforeRunloopStop:(_Bool)arg2;
...
- (void)dealloc;
- (id)initAllowingAppInactivePlayback:(_Bool)arg1 andShouldSyncBeforeRunloopStop:(_Bool)arg2;
