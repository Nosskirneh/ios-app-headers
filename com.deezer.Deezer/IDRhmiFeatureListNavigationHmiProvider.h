...
@property(readonly) IDButton *entryButtonIDRhmiFeatureListNavigation; // @synthesize entryButtonIDRhmiFeatureListNavigation=_entryButtonIDRhmiFeatureListNavigation;
