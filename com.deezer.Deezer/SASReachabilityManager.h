...
@property(readonly, nonatomic, getter=isNetworkReachableViaWiFi) _Bool reachableViaWiFi;
@property(readonly, nonatomic, getter=isNetworkReachableViaWWAN) _Bool reachableViaWWAN;
@property(readonly, nonatomic, getter=isNetworkReachable) _Bool reachable;
- (void)dealloc;
- (id)init;
