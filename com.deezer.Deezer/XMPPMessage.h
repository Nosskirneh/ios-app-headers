...
+ (id)omemo_messageWithKeyData:(id)arg1 iv:(id)arg2 senderDeviceId:(unsigned int)arg3 toJID:(id)arg4 payload:(id)arg5 elementId:(id)arg6 xmlNamespace:(unsigned long long)arg7;
...
- (id)init;
- (id)omemo_deviceListFromPEPUpdate:(unsigned long long)arg1;
...
- (id)nick;
- (id)storageHints;
- (id)nameForStorageHint:(long long)arg1;
- (void)addStorageHint:(long long)arg1;
