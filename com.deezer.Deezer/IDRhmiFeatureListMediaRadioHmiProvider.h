...
@interface IDRhmiFeatureListMediaRadioHmiProvider : NSObject <IDHmiProvider>
{
    ...
    IDButton *_entryButtonIDRhmiFeatureListMediaRadio;
...
@property(readonly) IDButton *entryButtonIDRhmiFeatureListMediaRadio; // @synthesize entryButtonIDRhmiFeatureListMediaRadio=_entryButtonIDRhmiFeatureListMediaRadio;
