...
@protocol FNFAVPlayerItem, FNFPlayerAudioDecoder;
...
- (id)initWithDisplayEngine:(id)arg1 configs:(CDStruct_b31ca263)arg2 asyncTimebase:(_Bool)arg3 enableOpus:(_Bool)arg4;
