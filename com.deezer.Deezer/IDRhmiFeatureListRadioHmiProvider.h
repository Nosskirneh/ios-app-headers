...
@interface IDRhmiFeatureListRadioHmiProvider : NSObject <IDHmiProvider>
{
    IDMultimediaInfo *_multimediaInfo;
    IDStatusBar *_hmiStatusBar;
    IDButton *_entryButtonIDRhmiFeatureListRadio;
...
@property(readonly) IDButton *entryButtonIDRhmiFeatureListRadio; // @synthesize entryButtonIDRhmiFeatureListRadio=_entryButtonIDRhmiFeatureListRadio;
