...
@class IDA4AConnection, IDA4AConnectionMonitor, IDA4AProtocol, IDA4AProxyInfo, IDBackgroundTask, IDExternalAccessorySelector, IDJSONRPCNotification, IDJSONRPCRequest, NSConditionLock, NSMutableSet, NSSet, NSString;
