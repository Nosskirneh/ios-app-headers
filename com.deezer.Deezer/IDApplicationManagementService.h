...
@class NSString;
@protocol IDApplicationManagementServiceDataSource, IDApplicationManagementServiceDelegate;
...
@property __weak id <IDApplicationManagementServiceDataSource> dataSource; // @synthesize dataSource=_dataSource;
