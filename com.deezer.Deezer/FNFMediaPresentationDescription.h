...
+ (id)presentationDescriptionWithContentsOfXml:(id)arg1 mpdUrl:(id)arg2 vp9Enabled:(_Bool)arg3 opusEnabled:(_Bool)arg4 error:(id *)arg5;
+ (id)presentationDescriptionWithContentsOfXml:(id)arg1 mpdUrl:(id)arg2 segmentsFromEndToStartForLive:(unsigned int)arg3 secondsFromEndToStartForLive:(unsigned int)arg4 enableSecondsFromEndToStartForLive:(_Bool)arg5 error:(id *)arg6;
