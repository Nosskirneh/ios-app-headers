...
@interface FBSDKServerConfiguration : NSObject <FBSDKCopying, NSSecureCoding>
{
    ...
    _Bool _appIndexingTriggerEnabled;
...
@property(readonly, nonatomic, getter=isAppIndexingTriggerEnabled) _Bool appIndexingTriggerEnabled; // @synthesize appIndexingTriggerEnabled=_appIndexingTriggerEnabled;
...
- (id)initWithAppID:(id)arg1 appName:(id)arg2 loginTooltipEnabled:(_Bool)arg3 loginTooltipText:(id)arg4 defaultShareMode:(id)arg5 advertisingIDEnabled:(_Bool)arg6 implicitLoggingEnabled:(_Bool)arg7 implicitPurchaseLoggingEnabled:(_Bool)arg8 appIndexingTriggerEnabled:(_Bool)arg9 systemAuthenticationEnabled:(_Bool)arg10 nativeAuthFlowEnabled:(_Bool)arg11 dialogConfigurations:(id)arg12 dialogFlows:(id)arg13 timestamp:(id)arg14 errorConfiguration:(id)arg15 sessionTimeoutInterval:(double)arg16 defaults:(_Bool)arg17 loggingToken:(id)arg18 smartLoginOptions:(unsigned long long)arg19 smartLoginBookmarkIconURL:(id)arg20 smartLoginMenuIconURL:(id)arg21 updateMessage:(id)arg22;
- (id)init;
