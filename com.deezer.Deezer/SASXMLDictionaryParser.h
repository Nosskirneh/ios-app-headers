...
@class NSError, NSMutableArray, NSMutableDictionary, NSMutableString, NSString;
...
+ (id)sharedInstance;
@property(retain, nonatomic) NSError *parsingError; // @synthesize parsingError=_parsingError;
...
- (void)endText;
- (id)sas_dictionaryWithFile:(id)arg1;
- (id)sas_dictionaryWithString:(id)arg1;
- (id)sas_dictionaryWithData:(id)arg1;
- (id)sas_dictionaryWithParser:(id)arg1;
