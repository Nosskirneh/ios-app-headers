...
@interface FBAdWKWebViewBrowserController : UIViewController <FBAdBrowserViewController, FBAdBrowserSessionDataGeneration, WKNavigationDelegate>
{
    ...
    NSURL *_urlToLoadAfterCookieInjection;
}

+ (void)initialize;
@property(retain, nonatomic) NSURL *urlToLoadAfterCookieInjection; // @synthesize urlToLoadAfterCookieInjection=_urlToLoadAfterCookieInjection;
@property(nonatomic) _Bool cookiesInjected; // @synthesize cookiesInjected=_cookiesInjected;
