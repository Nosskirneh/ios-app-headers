...
@protocol FNFAVPlayer, FNFPlayerRefactoredDisplayEngine, FNFPlayerRenderer;

@interface FNFPlayerGLES2Layer : CAEAGLLayer <FNFPlayerDisplayLayer>
{
    ...
    id <FNFPlayerRefactoredDisplayEngine> _displayEngine;
...
- (void)displayEmptyBuffer:(_Bool)arg1 atTime:(CDStruct_1b6d18a9)arg2 preventPlayback:(_Bool)arg3;
...
- (id)initWithConfigs:(CDStruct_2fd9fc7b)arg1;
