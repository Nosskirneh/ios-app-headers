...
+ (id)omemo_iqFetchBundleForDeviceId:(unsigned int)arg1 jid:(id)arg2 elementId:(id)arg3 xmlNamespace:(unsigned long long)arg4;
+ (id)omemo_iqDeleteNode:(id)arg1 elementId:(id)arg2;
+ (id)omemo_iqFetchNode:(id)arg1 to:(id)arg2 elementId:(id)arg3;
+ (id)omemo_iqPublishBundle:(id)arg1 elementId:(id)arg2 xmlNamespace:(unsigned long long)arg3;
+ (id)omemo_iqPublishDeviceIds:(id)arg1 elementId:(id)arg2 xmlNamespace:(unsigned long long)arg3;
+ (id)omemo_iqFetchDeviceIdsForJID:(id)arg1 elementId:(id)arg2 xmlNamespace:(unsigned long long)arg3;
+ (id)disableNotificationsElementWithJID:(id)arg1 node:(id)arg2 elementId:(id)arg3;
+ (id)disableNotificationsElementWithJID:(id)arg1 node:(id)arg2;
+ (id)enableNotificationsElementWithJID:(id)arg1 node:(id)arg2 options:(id)arg3 elementId:(id)arg4;
+ (id)enableNotificationsElementWithJID:(id)arg1 node:(id)arg2 options:(id)arg3;
...
- (id)init;
- (id)pubsubid;
- (id)omemo_bundle:(unsigned long long)arg1;
