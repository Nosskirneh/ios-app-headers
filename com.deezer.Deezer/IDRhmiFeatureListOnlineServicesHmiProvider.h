...
@interface IDRhmiFeatureListOnlineServicesHmiProvider : NSObject <IDHmiProvider>
{
    IDMultimediaInfo *_multimediaInfo;
    IDStatusBar *_hmiStatusBar;
    IDButton *_entryButtonIDRhmiFeatureListOnlineServices;
...
@property(readonly) IDButton *entryButtonIDRhmiFeatureListOnlineServices; // @synthesize entryButtonIDRhmiFeatureListOnlineServices=_entryButtonIDRhmiFeatureListOnlineServices;
