...
@interface DZRDynamicPageMatch : NSObject <DZRDynamicPageItem>
{
    _Bool _available;
    ...
    long long _type;
    id <_TtP6Deezer12Illustration_> _homeTeamIllustration;
    id <_TtP6Deezer12Illustration_> _visitorTeamIllustration;
}

@property(retain, nonatomic) id <_TtP6Deezer12Illustration_> visitorTeamIllustration; // @synthesize visitorTeamIllustration=_visitorTeamIllustration;
@property(retain, nonatomic) id <_TtP6Deezer12Illustration_> homeTeamIllustration; // @synthesize homeTeamIllustration=_homeTeamIllustration;
