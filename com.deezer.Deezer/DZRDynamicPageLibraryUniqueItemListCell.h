...
@class DZRDynamicPagePlayButton, DZRDynamicPageShadeView, NSString, UILabel, UIView, _TtC6Deezer16IllustrationView;
@protocol DZRDynamicPageItem;

@interface DZRDynamicPageLibraryUniqueItemListCell : UICollectionViewCell <DZRUpdatableCell, DZRDynamicPageCell>
{
