...
@class DDXMLElement, GCDAsyncSocket, GCDMulticastDelegate, NSArray, NSCountedSet, NSData, NSDate, NSError, NSMutableArray, NSMutableDictionary, NSString, XMPPIDTracker, XMPPJID, XMPPParser, XMPPPresence, XMPPSRVResolver;
@protocol OS_dispatch_queue, OS_dispatch_source, XMPPCustomBinding, XMPPSASLAuthentication, XMPPStreamDelegate;
...
@property(readonly, nonatomic) GCDAsyncSocket *asyncSocket; // @synthesize asyncSocket;
