...
@class DZRDynamicPageOnAirLabel, DZRDynamicPagePlayButton, DZRDynamicPageShadeView, DZREdgeInsetsLabel, NSString, UILabel, UIView, _TtC6Deezer16IllustrationView;
@protocol DZRDynamicPageItem;

@interface DZRDynamicPageMixLargeCardCell : UICollectionViewCell <DZRUpdatableCell, DZRDynamicPageCell>
{
    ...
    UIView *_coverLabelsContainer;
    UILabel *_coverTitleLabel;
    UILabel *_coverSubtitleLabel;
...
@property(retain, nonatomic) UILabel *coverSubtitleLabel; // @synthesize coverSubtitleLabel=_coverSubtitleLabel;
@property(retain, nonatomic) UILabel *coverTitleLabel; // @synthesize coverTitleLabel=_coverTitleLabel;
@property(retain, nonatomic) UIView *coverLabelsContainer; // @synthesize coverLabelsContainer=_coverLabelsContainer;
...
- (void)coverInnerLayoutWithImageSize:(double)arg1;
- (void)iPadLayout;
- (void)iPhoneLayout;
- (void)layoutSubviews;
- (id)nonEmptyCoverLabels;
- (id)nonEmptyLabels;
- (id)allCoverLabels;
- (id)allLabels;
