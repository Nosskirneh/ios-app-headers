...
@class IDA4AProxyInfo, IDAppManifest, IDApplicationManagementService, IDAudioService, IDBackgroundTask, IDCdsService, IDEtchSession, IDHmiService, IDPiaService, IDScheduler, IDVehicleInfo, NSOperationQueue, NSURL, NSUndoManager;
