...
@interface DZRDynamicPageTitleReusableView : UICollectionReusableView <DZRDynamicPageSupplementaryView>
{
    UILabel *_titleLabel;
...
- (void)taped:(id)arg1;
- (double)titleKernValueForStyle:(long long)arg1;
- (void)applyTitleStyle:(long long)arg1;
