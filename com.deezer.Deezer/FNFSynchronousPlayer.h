...
@class NSError;
@protocol FNFAssetForPlayer, FNFClock, FNFPlayerAudioDecoder, FNFPlayerAudioEngine, FNFPlayerCaptionParser, FNFPlayerDisplayEngine, FNFSynchronousPlayerDelegate, OS_dispatch_queue;
...
@interface FNFSynchronousPlayer : NSObject <FNFPlayerDisplayEngineDelegate>
{
    ...
    _Bool _resetAudioQueueWhenStalling;
...
- (void)play;
- (id)description;
- (id)initWithDisplayEngine:(id)arg1 configs:(CDStruct_b31ca263)arg2 audioEngine:(id)arg3 audioDecoder:(id)arg4 clock:(id)arg5 runningQueue:(id)arg6 muted:(_Bool)arg7 asyncTimebase:(_Bool)arg8;
- (void)dealloc;
