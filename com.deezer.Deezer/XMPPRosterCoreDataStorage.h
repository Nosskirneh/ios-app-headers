...
+ (id)sharedInstance;
- (void).cxx_destruct;
- (void)getSubscription:(id *)arg1 ask:(id *)arg2 nickname:(id *)arg3 groups:(id *)arg4 forJID:(id)arg5 xmppStream:(id)arg6;
...
- (void)beginRosterPopulationForXMPPStream:(id)arg1 withVersion:(id)arg2;
