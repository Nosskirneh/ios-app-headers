...
@class IDA4AProtocol, IDAppManifest, IDBackgroundTask, IDBclManager, IDExternalAccessorySelector, IDMessagingService, IDProtocolSelector, IDRhmiAppSwitcher, IDRhmiFeatureInfoSyncService, IDRhmiLegacyFeatureSwitcher, IDVehicleInfo, IDVehicleInformationRetriever, IDVersionInfo, NSConditionLock, NSString, UIApplication;
...
@property(retain, nonatomic) IDRhmiFeatureInfoSyncService *syncService; // @synthesize syncService=_syncService;
...
- (id)initWithCurrentSystemVersion:(id)arg1 legacyCommunicationProtocolSupport:(_Bool)arg2 allRequiredProtocolsForMultisessionSupport:(_Bool)arg3 uiApplication:(id)arg4 externalAccessorySelector:(id)arg5 protocolSelector:(id)arg6 bclManager:(id)arg7;
- (id)init;
