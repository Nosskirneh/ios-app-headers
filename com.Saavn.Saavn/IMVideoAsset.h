...
#import "IMVastMediaFileUtilDelegate-Protocol.h"
...
@property(nonatomic) _Bool isSecondPageVideoAsset; // @synthesize isSecondPageVideoAsset=_isSecondPageVideoAsset;
