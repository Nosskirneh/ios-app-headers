...
@class AKFAdvancedUIActionController, AKFAppEventsLogger, AKFTheme, NSArray, NSMutableArray, NSString;
@protocol AKFAdvancedUIManager, AKFLoginController, AKFViewControllerDelegate;

@interface AKFNavigationController : UINavigationController <AKFViewController>
{
    AKFAdvancedUIActionController *_actionController;
...
- (void)_back;
- (void)_applyTheme:(id)arg1 toViewController:(id)arg2;
- (void)_applyTheme:(id)arg1;
- (void)_applyConfiguringToViewViewController:(id)arg1;
- (void)_applyAdvancedUIManager:(id)arg1 toViewController:(id)arg2;
- (void)_applyAdvancedUIManager:(id)arg1;
