...
@class MATMoatWebViewAndBridge, NSHashTable, NSMutableArray, NSString;
...
@interface MATMoatAnalytics : NSObject
{
    ...
    MATMoatWebViewAndBridge *_globalDisplayWebView;
...
@property(retain) MATMoatWebViewAndBridge *globalDisplayWebView; // @synthesize globalDisplayWebView=_globalDisplayWebView;
