...
@class MATMoatWebViewAndBridge, NSArray, NSMutableDictionary, NSString, NSTimer, UIView;
...
@interface MATMoatVideoTracker : MATMoatBaseTracker
{
    ...
    MATMoatWebViewAndBridge *_mWebViewAndBridge;
    NSTimer *_timer;
...
@property(retain) MATMoatWebViewAndBridge *mWebViewAndBridge; // @synthesize mWebViewAndBridge=_mWebViewAndBridge;
