...
@class IMPLCrashReportProcessorInfo, NSDate, NSString;

@interface IMPLCrashReportSystemInfo : NSObject
{
...
@property(readonly, nonatomic) IMPLCrashReportProcessorInfo *processorInfo; // @synthesize processorInfo=_processorInfo;
