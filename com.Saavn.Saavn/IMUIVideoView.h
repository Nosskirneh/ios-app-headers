...
@interface IMUIVideoView : IMUIView <IMTimerDelegate, IMUIInflator>
{
    ...
    _Bool _fgBgKvoRegistered;
    _Bool _audioRerouteKvoRegistered;
    float _pauseAfter;
...
+ (Class)layerClass;
@property(nonatomic) _Bool audioRerouteKvoRegistered; // @synthesize audioRerouteKvoRegistered=_audioRerouteKvoRegistered;
@property(nonatomic) _Bool fgBgKvoRegistered; // @synthesize fgBgKvoRegistered=_fgBgKvoRegistered;
