...
@class CAShapeLayer, FBAdAudioMuteButton, FBAdPlacementDefinition, FBAdVideoProgressBar, FBAdViewabilityValidator, FBGradientView, FBInterstitialAdMediaView, FBInterstitialAdTextView, FBNativeAdDataModel, FBNativeAdMultiProductDataModel, NSNumber, NSString, UIButton;
@protocol FBInterstitialAdBodyViewDelegate;

@interface FBInterstitialAdBodyView : UIView <FBInterstitialAdMediaViewDelegate, FBAdViewabilityValidatorDelegate>
{
    ...
    CAShapeLayer *_mediaViewMaskLayer;
...
@property(nonatomic) __weak CAShapeLayer *mediaViewMaskLayer; // @synthesize mediaViewMaskLayer=_mediaViewMaskLayer;
