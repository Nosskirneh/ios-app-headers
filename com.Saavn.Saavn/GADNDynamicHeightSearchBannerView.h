...
@class GADNWebViewController, NSString;
@protocol GADNDynamicHeightSearchBannerViewDelegate;

@interface GADNDynamicHeightSearchBannerView : UIView <GADNWebViewControllerDelegate, UIGestureRecognizerDelegate>
{
