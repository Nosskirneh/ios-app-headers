...
@class IMAdUnit, NSData, NSDictionary, NSString;

@protocol IMAdUnitDelegate <NSObject>

@optional
- (void)imNativeAdUnit:(IMAdUnit *)arg1 audioStateChanged:(_Bool)arg2;
- (void)adUnit:(IMAdUnit *)arg1 failedToGetSignalsWithErrorCode:(int)arg2 andDescription:(NSString *)arg3;
- (void)adUnit:(IMAdUnit *)arg1 didGetSignals:(NSData *)arg2;
