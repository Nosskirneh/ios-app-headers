...
#import "IMIASViewability-Protocol.h"
#import "IMMoatViewability-Protocol.h"
#import "IMRenderViewDelegate-Protocol.h"
#import "IMTimerDelegate-Protocol.h"

@class IMAdStore, IMAdsConfig, IMIASViewability, IMMoatViewability, IMRenderView, IMRequest, IMTimerManager, NSData, NSDictionary, NSNumber, NSString, UIColor;
...
@interface IMAdUnit : NSObject <IMRenderViewDelegate, IMMoatViewability, IMIASViewability, IMConfigDelegate, IMTimerDelegate, IMAdStoreDelegate>
{
    ...
    NSNumber *_bidValue;
    IMRequest *_getSignalsRequest;
    unsigned long long _getSignalsStartTime;
    unsigned long long _getSignalsEndTime;
    struct CGRect _frame;
    struct CGRect _safeAreaFrame;
}

+ (void)logMonetizationDisabledWithAdType:(id)arg1 andComponentType:(id)arg2;
@property(nonatomic) unsigned long long getSignalsEndTime; // @synthesize getSignalsEndTime=_getSignalsEndTime;
@property(nonatomic) unsigned long long getSignalsStartTime; // @synthesize getSignalsStartTime=_getSignalsStartTime;
@property(retain, nonatomic) IMRequest *getSignalsRequest; // @synthesize getSignalsRequest=_getSignalsRequest;
...
- (void)adStore:(id)arg1 failedToFetchAnAdWithErrorCode:(int)arg2 andDescription:(id)arg3;
- (void)adStore:(id)arg1 fetchedAdFromCacheWithResponse:(id)arg2 impId:(id)arg3 insertionTS:(id)arg4 vastTag:(id)arg5 clientID:(id)arg6 requestId:(id)arg7;
...
- (void)adStore:(id)arg1 didLoadAdWithResponse:(id)arg2 impId:(id)arg3 insertionTS:(id)arg4 vastTag:(id)arg5 clientID:(id)arg6 requestId:(id)arg7;
...
- (void)adFailed;
- (void)adAvailable;
- (void)adFailedSignals;
- (void)adFetchedSignals;
- (void)adFetchingSignals;
- (void)loading;
- (void)created;
- (void)sendCallbackForFailedToFetchSignals:(int)arg1 description:(id)arg2;
