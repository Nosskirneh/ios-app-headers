...
@class MATMoatBridge, UIView, UIWebView, WKWebView;
@protocol MATMoatBridgeProtocol;
...
@interface MATMoatWebTracker : MATMoatBaseTracker
{
    ...
    MATMoatBridge<MATMoatBridgeProtocol> *_webBridge;
}
...
@property(retain) MATMoatBridge<MATMoatBridgeProtocol> *webBridge; // @synthesize webBridge=_webBridge;
