...
@class IMPLCrashReportSymbolInfo;

@interface IMPLCrashReportStackFrameInfo : NSObject
{
    unsigned long long _instructionPointer;
    IMPLCrashReportSymbolInfo *_symbolInfo;
}

@property(readonly, nonatomic) IMPLCrashReportSymbolInfo *symbolInfo; // @synthesize symbolInfo=_symbolInfo;
