...
@property(nonatomic) long long requestFormat; // @dynamic requestFormat;
@property(nonatomic) long long responseFormat; // @dynamic responseFormat;
@property(retain, nonatomic) NSString *securityLabel; // @dynamic securityLabel;
@property(nonatomic) long long securityLevel; // @dynamic securityLevel;
