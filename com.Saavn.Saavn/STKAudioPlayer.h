...
@interface STKAudioPlayer : NSObject <STKDataSourceDelegate>
{
    ...
    _Bool waiting;
    _Bool playerUnexpectedError;
    _Bool currentAudioStillPlaying;
    double requestedSeekTime;
    _Bool disposeWasRequested;
    _Bool seekToTimeWasRequested;
    int stopReason;
    _Bool _bufferingCompleted;
    int _state;
...
@property _Bool bufferingCompleted; // @synthesize bufferingCompleted=_bufferingCompleted;
- (void).cxx_destruct;
- (_Bool)isInternalStateError;
...
- (float)getGainForEqualizerBand:(int)arg1;
