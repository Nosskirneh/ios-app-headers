...
@class FBAdPlayableView, FBAdTimer, FBPlayableIntroScreenView, NSString;
@protocol FBAdPlayableViewControllerDelegate;

@interface FBAdPlayableViewController : UIViewController <FBRewardedVideoAdInternalController, FBAdPlayableViewDelegate>
{
