...
@class GADNActionURLHandler, GADNEventContext, GADNObserverCollection, GADNWebViewConfiguration, GADNWebViewController, NSOperationQueue, NSString;
@protocol GADNWebAdViewDelegate;

@interface GADNWebAdView : GADNView <UIGestureRecognizerDelegate, GADNWebViewControllerDelegate, GADNJavascriptEvaluating>
{
