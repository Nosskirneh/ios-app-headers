...
@class MATMoatWKWebViewBridge, NSString, WKWebView;

@interface MATMoatWebViewAndBridge : NSObject <WKNavigationDelegate>
{
    _Bool _amCleanedUp;
    WKWebView *_webView;
    MATMoatWKWebViewBridge *_webBridge;
...
@property(retain) MATMoatWKWebViewBridge *webBridge; // @synthesize webBridge=_webBridge;
