...
@class GADAd, GADAdFetcher, GADInterstitial, GADMAdNetworkConfig, GADMConfig, GADMRewardBasedVideoAdNetworkConnector, GADRequest, GADSlotStatistics, NSDictionary, NSMutableArray, NSMutableDictionary, NSString;
