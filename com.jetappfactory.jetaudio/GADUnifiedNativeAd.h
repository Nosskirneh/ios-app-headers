...
#import "GADNativeAdUnconfirmedClickDelegate-Protocol.h"

@class GADNativeAd, GADNativeAdImage, GADVideoController, NSArray, NSDecimalNumber, NSDictionary, NSString, UIViewController;
@protocol GADNativeAdSourceAttributing><GADOverlayViewSource, GADUnifiedNativeAdDelegate, GADUnifiedNativeAdUnconfirmedClickDelegate, OS_dispatch_queue;
