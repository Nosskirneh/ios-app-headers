...
@class GADAd, GADAdViewActiveViewReporter, GADAdViewState, GADAdViewVideoController, GADClearcutLogger, GADPrecacheGMSGHandler, GADVideoConfiguration, GADVideoPlayer, GADWebView, GADWebViewConfiguration, NSMutableDictionary, NSOperationQueue, NSString, NSURL, UIGestureRecognizer, UIScrollView, UIViewController;
