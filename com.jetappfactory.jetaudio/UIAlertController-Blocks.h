...
+ (id)showActionSheetInViewController:(id)arg1 withTitle:(id)arg2 message:(id)arg3 cancelButtonTitle:(id)arg4 destructiveButtonTitle:(id)arg5 otherButtonTitles:(id)arg6 buttonImagesNames:(id)arg7 popoverPresentationControllerBlock:(CDUnknownBlockType)arg8 tapBlock:(CDUnknownBlockType)arg9;
...
+ (id)showInViewController:(id)arg1 withTitle:(id)arg2 message:(id)arg3 preferredStyle:(long long)arg4 cancelButtonTitle:(id)arg5 destructiveButtonTitle:(id)arg6 otherButtonTitles:(id)arg7 buttonImagesNames:(id)arg8 popoverPresentationControllerBlock:(CDUnknownBlockType)arg9 tapBlock:(CDUnknownBlockType)arg10;
