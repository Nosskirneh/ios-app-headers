...
@interface REFrostedViewController : UIViewController
{
    ...
    long long _verticalOffset;
    long long _menuBottomMargin;
...
@property(nonatomic) long long menuBottomMargin; // @synthesize menuBottomMargin=_menuBottomMargin;
@property(nonatomic) long long verticalOffset; // @synthesize verticalOffset=_verticalOffset;
