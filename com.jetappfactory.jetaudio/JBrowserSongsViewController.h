...
@interface JBrowserSongsViewController : JBrowserViewController_Base <MGSwipeTableCellDelegate, UISearchBarDelegate>
{
    NSArray *mSongs;
    NSArray *mSearchResults;
    UIImage *mDefArtwork;
    MPMediaItemCollection *mQueryForPlaylist;
...
- (void)viewDidLoad;
- (void)setQueryForPlaylist:(id)arg1 title:(id)arg2 sortKey:(id)arg3;
