...
@protocol SPTGaiaHomeDeviceFlagsProvider, SPTGaiaSettingsProvider, SPTPlayer, SPTUserNotificationsRegistrar;

@interface SPTGaiaHomeDeviceAutomaticTransitionManager : NSObject <SPTNetworkConnectivityControllerObserver, SPTGaiaDeviceStateManagerObserver, SPTGaiaHomeDeviceLocalNotificationHandler>
{
