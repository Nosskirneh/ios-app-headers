...
#import "SPTPodcastBrowseViewModelFetcher-Protocol.h"

@class NSString, SPTDataLoader, SPTDataLoaderFactory;
@protocol SPTFeatureFlagSignal, SPTPodcastBrowseTimeZoneProvider, SPTPodcastBrowseViewModelBuilderProvider, SPTPodcastTestManager;

@interface SPTPodcastBrowseHubsRendererViewModelFetcher : NSObject <SPTDataLoaderDelegate, SPTPodcastBrowseViewModelFetcher>
{
    _Bool _nftEnabled;
    id <SPTPodcastBrowseViewModelBuilderProvider> _viewModelBuilderProvider;
    ...
    NSString *_featureID;
    NSString *_pageURI;
    id <SPTPodcastBrowseTimeZoneProvider> _timeZoneProvider;
}

@property(readonly, nonatomic) id <SPTPodcastBrowseTimeZoneProvider> timeZoneProvider; // @synthesize timeZoneProvider=_timeZoneProvider;
...
@property(readonly, nonatomic) id <SPTPodcastBrowseViewModelBuilderProvider> viewModelBuilderProvider; // @synthesize viewModelBuilderProvider=_viewModelBuilderProvider;
- (void).cxx_destruct;
...
- (id)initWithViewModelBuilderProvider:(id)arg1 dataLoaderFactory:(id)arg2 genre:(id)arg3 podcastTestManager:(id)arg4 nftEnabledSignal:(id)arg5 locale:(id)arg6 offset:(unsigned long long)arg7 sourceIdentifier:(id)arg8 featureID:(id)arg9 pageURI:(id)arg10 timeZoneProvider:(id)arg11;
