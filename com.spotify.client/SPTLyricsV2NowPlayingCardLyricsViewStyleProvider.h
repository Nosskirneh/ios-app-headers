...
@interface SPTLyricsV2NowPlayingCardLyricsViewStyleProvider : NSObject <SPTLyricsV2LyricsViewStyleProvider>
{
...
- (void).cxx_destruct;
- (id)lyricsViewStyle;
- (id)initWithTheme:(id)arg1 colors:(id)arg2 isLyricsEastAsian:(_Bool)arg3;
