...
@class GLUECalendarThumbnailView, GLUEImageView, GLUELabel, NSLayoutConstraint, NSString, SPTFreeTierArtistPinnedItemCommentPlaceholderView, SPTFreeTierArtistPinnedItemCommentView;

@interface SPTFreeTierArtistPinnedItemRowView : UIView <GLUEStyleable>
{
    NSString *_titleText;
    ...
    NSLayoutConstraint *_commentViewOnLoadLeadingConstraint;
    NSLayoutConstraint *_commentViewAfterLoadLeadingConstraint;
...
@property(retain, nonatomic) NSLayoutConstraint *commentViewAfterLoadLeadingConstraint; // @synthesize commentViewAfterLoadLeadingConstraint=_commentViewAfterLoadLeadingConstraint;
@property(retain, nonatomic) NSLayoutConstraint *commentViewOnLoadLeadingConstraint; // @synthesize commentViewOnLoadLeadingConstraint=_commentViewOnLoadLeadingConstraint;
