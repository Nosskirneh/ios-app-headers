...
@protocol SPTHubConfiguration, SPTHubExternalDataLoaderFactory, SPTHubLocalContentProvider, SPTHubRegistrationToken, SPTHubRemoteContentURLResolver, SPTHubViewHandler;

@protocol SPTLegacyHubService <SPTService>
