...
#import "SPTAssistedCurationNavigationController.h"
...
@class GLUEAccessoryIconButton, NSString, NSURL, SPTAssistedCurationLogger, SPTAssistedCurationViewController, UIViewController<SPTSearch2RootViewControllerProtocol><SPTPageController>;
