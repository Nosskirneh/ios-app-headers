...
@class NSString, SPTFreeTierPlaylistLogger, UIViewController;
@protocol SPContextMenuFeature, SPTAlertController, SPTBarButtonItemManager, SPTCollectionPlatformConfiguration, SPTContextMenuPresenter, SPTFreeTierCreatePlaylistTestManager, SPTFreeTierPlaylistViewModel, SPTPageController;
