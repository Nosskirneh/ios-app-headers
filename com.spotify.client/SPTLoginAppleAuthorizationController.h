...
@class NSString, SPTAuthenticationHandler, SPTLoginAppleAuthorizationControllerLogger, SPTLoginAppleSignInTestManager;
...
- (id)initWithAuthenticationHandler:(id)arg1 navigationCoordinator:(id)arg2 testManager:(id)arg3 dialogController:(id)arg4 logger:(id)arg5;
