...
@protocol GLUEImageLoader, SPTGaiaDevicePickerContextMenuFlagsProvider><SPTGaiaHomeDeviceFlagsProvider, SPTLinkDispatcher;
...
- (id)initWithFlagsProvider:(id)arg1 iconMapper:(id)arg2 glueImageLoaderFactory:(id)arg3 savedDeviceManager:(id)arg4 linkDispatcher:(id)arg5;
