...
- (id)initWithDeviceManager:(id)arg1 airplayManager:(id)arg2 castManager:(id)arg3 theme:(id)arg4 feature:(id)arg5 networkConnectivityController:(id)arg6 player:(id)arg7 logCenter:(id)arg8 offlineModeState:(id)arg9 notificationCenter:(id)arg10 modalPresentationController:(id)arg11 crashReporter:(id)arg12;
