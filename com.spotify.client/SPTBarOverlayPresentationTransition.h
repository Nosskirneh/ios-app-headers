...
@class CADisplayLink, NSArray, NSString, UIView, UIViewController, UIViewController<SPTBarInteractiveTransitionParticipant>;
...
- (id)initWithPresenting:(_Bool)arg1 barViewController:(id)arg2 bottomTabBar:(id)arg3;
