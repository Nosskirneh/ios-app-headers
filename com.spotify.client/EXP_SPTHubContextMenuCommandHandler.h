...
@protocol EXP_SPTHubInteractionLogger, SPTContextMenuOptions, SPTContextMenuOptionsFactory, SPTContextMenuPresenterFactory;
...
- (id)initWithViewURI:(id)arg1 contextMenuLogContextIphone:(id)arg2 contextMenuLogContextIpad:(id)arg3 contextMenuOptionsFactory:(id)arg4 contextMenuPresenterFactory:(id)arg5 interactionLogger:(id)arg6;
