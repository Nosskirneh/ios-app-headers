...
#import "SPTNowPlayingContentContainingViewController.h"
#import "SPTNowPlayingContentViewControllerDelegate.h"
#import "SPTNowPlayingModeLayoutDelegate.h"
#import "SPTNowPlayingModeResolverObserver.h"
#import "SPTPlayerObserver.h"
#import "SPTShareScreenshotObserverManagerDataSource.h"

@class NSArray, NSHashTable, NSLayoutConstraint, NSMutableDictionary, NSString, SPTGLNowPlayingOverlayViewController, SPTLayoutConstraintBuilder, SPTNowPlayingContainerIdleMonitor, SPTNowPlayingContentViewProvider, SPTNowPlayingLogger, SPTNowPlayingModel, SPTNowPlayingOpenGLManager, SPTShareScreenshotObserverManager, SPTTheme, UIStackView, UIViewController<SPTNowPlayingContainedViewController>, UIViewController<SPTNowPlayingContentViewController>;

@interface SPTNowPlayingViewControllerV2 : UIViewController <SPTNowPlayingContainingViewController, SPTNowPlayingContainerIdleMonitorObserver, SPTNowPlayingContainerIdleMonitorReceiving, SPTNowPlayingContainerIdleMonitorLoggingDelegate, SPTPlayerObserver, SPTShareScreenshotObserverManagerDataSource, SPTNowPlayingModeResolverObserver, SPTNowPlayingContentViewControllerDelegate, SPTNowPlayingModeLayoutDelegate, SPTBarOverlayViewController, SPTNowPlayingContentContainingViewController>
{
    ...
    double _emptyFrameTopBoundary;
    double _emptyFrameBottomBoundary;
}

@property(nonatomic) _Bool canForceIdlePeriodBegin; // @synthesize canForceIdlePeriodBegin=_canForceIdlePeriodBegin;
@property(nonatomic) double emptyFrameBottomBoundary; // @synthesize emptyFrameBottomBoundary=_emptyFrameBottomBoundary;
@property(nonatomic) double emptyFrameTopBoundary; // @synthesize emptyFrameTopBoundary=_emptyFrameTopBoundary;
