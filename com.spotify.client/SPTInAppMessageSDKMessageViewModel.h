...
@interface SPTInAppMessageSDKMessageViewModel : NSObject <WKScriptMessageHandler>
{
...
@property(retain, nonatomic) id <SPTInAppMessageLogger> logger; // @synthesize logger=_logger;
