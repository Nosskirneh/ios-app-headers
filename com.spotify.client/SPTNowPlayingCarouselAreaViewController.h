...
@class NSString, SPTCarouselBackgroundBlurController, SPTNowPlayingCarouselContentUnitView, SPTNowPlayingCoverArtController, SPTNowPlayingLogger, SPTNowPlayingModel, SPTTheme, UIView;
@protocol SPTAdsManager, SPTImageLoaderFactory, SPTNowPlayingCarouselContentProviderRegistry, SPTNowPlayingCarouselInteractionEventObserver, SPTNowPlayingContainingViewController, SPTNowPlayingTestManager, SPTNowPlayingVideoManager, SPTUpsellManager, SPTVideoSurfaceManager;
