...
- (id)initWithURL:(id)arg1 dataLoaderFactory:(id)arg2 viewModelBuilderFactory:(id)arg3 hubs2TargetMigrationContentOperation:(id)arg4 emptyStatePropertiesProvider:(id)arg5 searchTestManager:(id)arg6 dateProvider:(id)arg7;
