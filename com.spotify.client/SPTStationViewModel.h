...
{
    _Bool _followButtonHiddenForStationsFlagValue;
    NSURL *_stationURL;
...
@property(nonatomic) _Bool followButtonHiddenForStationsFlagValue; // @synthesize followButtonHiddenForStationsFlagValue=_followButtonHiddenForStationsFlagValue;
...
- (id)initWithStationURL:(id)arg1 productState:(id)arg2 playbackService:(id)arg3 stationsService:(id)arg4 offlineModeState:(id)arg5 dataLoader:(id)arg6 dailyMixViewUtils:(id)arg7 radioTestManager:(id)arg8 explicitContentAccessManager:(id)arg9;
