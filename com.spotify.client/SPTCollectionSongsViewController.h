...
@class GLUEEntityRowStyle, NSObject<SPTCollectionSongsModel>, NSString, NSURL, SPTCollectionFilterSearchBar, SPTCollectionShuffleButtonContainer, SPTInfoView, SPTNetworkConnectivityController, SPTProgressView, SPTTableViewOfflineSwitchCell, UITableView;
