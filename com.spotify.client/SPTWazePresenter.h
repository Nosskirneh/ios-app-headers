...
@protocol GLUETheme, SPTBannerPresentationManager, SPTBannerPresentationManagerTicket, SPTExternalIntegrationDebugLog, SPTSlateBuilderProvider, SPTSlateManager;
...
- (id)initWithBannerPresentationManager:(id)arg1 slateManager:(id)arg2 slateBuilderProvider:(id)arg3 glueTheme:(id)arg4 viewModel:(id)arg5 debugLog:(id)arg6;
