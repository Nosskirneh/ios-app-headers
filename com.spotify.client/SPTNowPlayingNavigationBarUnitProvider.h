...
@class NSNotificationCenter, NSString, SPTNowPlayingEntityDecorationController, SPTNowPlayingLogger, SPTNowPlayingModel, SPTNowPlayingNavigationBarModel, SPTTheme, UIView;
