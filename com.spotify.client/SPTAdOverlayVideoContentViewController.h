...
@protocol NSObject, OS_dispatch_queue, SPTAVPlayerSource, SPTAdEventLogger, SPTAdOverlayContentUnitDelegate, SPTAdsManager, SPTNowPlayingContainingViewController, SPTPlayer, SPTSlateContentUnitDelegate, SPTVideoSurface, SPTVideoSurfaceManager;
...
- (void)dealloc;
- (id)initWithAdManager:(id)arg1 videoSurfaceManager:(id)arg2 videoPlayerSource:(id)arg3 player:(id)arg4 theme:(id)arg5 eventLogger:(id)arg6 featureChecker:(id)arg7;
