...
@class FBKVOController, NSObject<OS_dispatch_queue>, NSString, NSURL, SPTAdFeatureFlagChecks, SPTAdVideoBaseContentView, SPTTheme, UIView<SPTVideoSurface>, UIViewController<SPTNowPlayingContainingViewController>;
