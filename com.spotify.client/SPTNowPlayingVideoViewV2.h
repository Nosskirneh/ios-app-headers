...
@class NSLayoutConstraint, NSString, SPTNowPlayingDurationViewV2, SPTNowPlayingHeadUnitViewV2, SPTNowPlayingNavigationBarView, SPTNowPlayingNavigationButtonsView, SPTNowPlayingVideoFooterView, SPTNowPlayingVideoHeaderView, SPTTheme, UIActivityIndicatorView;
@protocol SPTNowPlayingVideoViewV2Delegate, SPTThemableViewLayoutDelegate, SPTVideoSurface;

@interface SPTNowPlayingVideoViewV2 : UIView <SPTVideoSurfaceDelegate, UIGestureRecognizerDelegate, SPTThemableView>
{
    ...
    SPTNowPlayingHeadUnitViewV2 *_headUnitView;
...
@property(readonly, nonatomic) SPTNowPlayingHeadUnitViewV2 *headUnitView; // @synthesize headUnitView=_headUnitView;
