...
@class MMKAESKeyGenerator;
@protocol MMKInternalSessionDelegate;

@interface MMKHandshakeBeginStrategy : MMKMessageStrategy
{
    id <MMKInternalSessionDelegate> _sessionDelegate;
    MMKAESKeyGenerator *_keyGenerator;
}

@property(retain, nonatomic) MMKAESKeyGenerator *keyGenerator; // @synthesize keyGenerator=_keyGenerator;
