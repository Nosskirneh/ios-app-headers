...
#import "SPTVoiceLibraryAudioRecorderFactory-Protocol.h"

@class AVAudioEngine, AVAudioFormat, AVAudioInputNode, NSString, SPTVoiceLibraryAudioLevelMonitor, SPTVoiceLibraryAudioUnitRecorder;
@protocol OS_dispatch_queue;

@interface SPTVoiceLibraryAudioEngineRecorderFactory : NSObject <SPTVoiceLibraryAudioRecorderFactory>
{
    _Bool _recording;
    double _sampleRate;
    NSObject<OS_dispatch_queue> *_audioSetupQueue;
    NSObject<OS_dispatch_queue> *_delegateQueue;
    SPTVoiceLibraryAudioLevelMonitor *_audioLevelMonitor;
    SPTVoiceLibraryAudioUnitRecorder *_audioRecorder;
...
@property(retain, nonatomic) SPTVoiceLibraryAudioUnitRecorder *audioRecorder; // @synthesize audioRecorder=_audioRecorder;
@property(retain, nonatomic) SPTVoiceLibraryAudioLevelMonitor *audioLevelMonitor; // @synthesize audioLevelMonitor=_audioLevelMonitor;
...
- (id)initWithSampleRate:(double)arg1 delegateQueue:(id)arg2;
