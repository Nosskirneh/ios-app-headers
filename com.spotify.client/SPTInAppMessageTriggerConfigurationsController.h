...
@protocol SPTDataLoaderCancellationToken, SPTInAppMessageTriggerConfigurationsControllerDelegate, SPTInAppMessageTriggerConfigurationsControllerObserver;

@interface SPTInAppMessageTriggerConfigurationsController : NSObject <SPTInAppMessageTriggerConfigurationsPrerequisitesObserver, SPTDataLoaderDelegate, SPTInAppMessageFeatureFlagChecksObserver, SPTInAppMessageTriggerEngineDelegate>
{
    _Bool _refreshing;
...
- (void)performRequestForUrl:(id)arg1 messageFormat:(id)arg2;
...
- (void)dealloc;
- (id)initWithPrerequisites:(id)arg1 configurationsDataLoader:(id)arg2 serviceLogger:(id)arg3 featureFlagChecker:(id)arg4;
