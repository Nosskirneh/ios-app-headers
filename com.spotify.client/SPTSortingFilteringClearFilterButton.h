...
@interface SPTSortingFilteringClearFilterButton : UIButton <GLUEStyleable>
{
    id <SPTSortingFilteringClearFiltersControlButtonStyle> _glueStyle;
...
@property(retain, nonatomic) id <SPTSortingFilteringClearFiltersControlButtonStyle> glueStyle; // @synthesize glueStyle=_glueStyle;
- (void).cxx_destruct;
