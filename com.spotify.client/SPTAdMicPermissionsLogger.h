...
@class NSString, SPTAdFocusManager;
@protocol SPTEventSender;

@interface SPTAdMicPermissionsLogger : NSObject <SPTAdFocusManagerObserver>
{
    _Bool _micPermGranted;
...
- (void)dealloc;
- (id)initWithEventSender:(id)arg1 focusManager:(id)arg2;
