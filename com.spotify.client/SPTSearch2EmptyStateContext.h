...
#import "SPTSearchFancyRecentsDataSourceDelegate-Protocol.h"

@class EXP_HUBViewModelBuilderFactory, NSString;
@protocol EXP_HUBViewModel, SPTPlayer, SPTSearch2ConnectivityMonitor, SPTSearch2ContextDelegate, SPTSearch2EmptyStatePropertiesProvider, SPTSearchFancyRecentsDataSource;
