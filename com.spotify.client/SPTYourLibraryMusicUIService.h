...
@protocol CollectionFeature, SPContextMenuFeature, SPTAssistedCurationUIService, SPTAudioPreviewService, SPTCollectionPlatformService, SPTContainerUIService, SPTCoreService, SPTEncoreIntegrationService, SPTFreeTierCollectionService, SPTFreeTierCreatePlaylistService, SPTFreeTierPreCurationService, SPTGLUEService, SPTImageLoaderRequestFactory, SPTNetworkService, SPTOfflineService, SPTPerformanceMetricsService, SPTPlayerFeature, SPTPlaylistPlatformService, SPTQuickScrollService, SPTSessionService, SPTShareFeature, SPTShelfService, SPTSnackbarService, SPTSortingFilteringService, SPTUIPresentationService, SPTYourLibraryMusicService, SPTYourLibraryService;
...
@interface SPTYourLibraryMusicUIService : SPTUIPageService
{
    ...
    id <SPTQuickScrollService> _quickScrollService;
}

+ (id)serviceIdentifier;
@property(nonatomic) __weak id <SPTQuickScrollService> quickScrollService; // @synthesize quickScrollService=_quickScrollService;
