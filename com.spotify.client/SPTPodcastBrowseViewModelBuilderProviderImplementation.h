...
#import "SPTPodcastBrowseViewModelBuilderProvider-Protocol.h"

@class NSString;
@protocol SPTHugsFactory;

@interface SPTPodcastBrowseViewModelBuilderProviderImplementation : NSObject <SPTPodcastBrowseViewModelBuilderProvider>
{
