...
#import "SPTContentEngagementOptionsTestManager-Protocol.h"
#import "SPTFeatureFlagSignalObserver-Protocol.h"

@class NSString, SPTContentEngagementOptionsLocalSettingsManager;
...
- (void)setupFlags;
- (void)dealloc;
- (id)initWithFeatureFlagFactory:(id)arg1 featureSettingsItemFactory:(id)arg2 localSettingsManager:(id)arg3;
