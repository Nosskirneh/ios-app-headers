...
@class NSString;
@protocol SPTAssistedCurationCardModel, SPTAssistedCurationCardViewModelDelegate, SPTAudioPreviewModel, SPTExplicitContentAccessManager;
...
- (_Bool)isTrackRatedExplicitAtIndexPath:(id)arg1;
...
- (void)dealloc;
- (id)initWithCardModel:(id)arg1 audioPreviewModel:(id)arg2 explicitContentAccessManager:(id)arg3;
