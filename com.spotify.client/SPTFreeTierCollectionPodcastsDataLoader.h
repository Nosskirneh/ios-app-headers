...
@class NSString;
@protocol SPTCollectionPlatformDataLoader, SPTCollectionPlatformDataLoaderRequestToken, SPTFreeTierCollectionRangeDataLoaderDelegate;

@interface SPTFreeTierCollectionPodcastsDataLoader : NSObject <SPTFreeTierCollectionRangeDataLoader>
{
