...
@protocol SPTAudioDriverController, SPTEqualizerModelDelegate, SPTGaiaDeviceStateManager, SPTLocalSettings;
...
+ (id)defaultValues;
+ (id)equalizerModelWithLocalSettings:(id)arg1 audioDriverController:(id)arg2 gaiaDeviceStateManager:(id)arg3 audioSession:(id)arg4;
...
- (id)initWithLocalSettings:(id)arg1 audioDriverController:(id)arg2 gaiaDeviceStateManager:(id)arg3 audioSession:(id)arg4;
