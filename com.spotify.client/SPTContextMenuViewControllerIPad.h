...
@class CALayer, GLUEEntityRowStyle, NSArray, NSString, NSURL, SPTTableView, UIImage, UIView, UIView<SPTContextMenuHeader>;
...
- (void)setupLeadingAccessoryForCell:(id)arg1 imageURL:(id)arg2 placeholderImage:(id)arg3 indexPath:(id)arg4;
