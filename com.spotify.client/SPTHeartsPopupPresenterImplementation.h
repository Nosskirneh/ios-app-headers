...
#import "SPTHeartsPopupViewDelegate.h"
#import "UIGestureRecognizerDelegate.h"

@class NSLayoutConstraint, NSString, NSTimer, SPTHeartsContextURI, SPTHeartsPopupTheme, SPTHeartsPopupView, SPTHeartsTrackURI, UIView;

@interface SPTHeartsPopupPresenterImplementation : NSObject <SPTHeartsPopupViewDelegate, UIGestureRecognizerDelegate, SPTHeartsPopupPresenter>
{
...
- (void)handleUndoViewDismissWithSender:(id)arg1;
- (void)handleTouchUpOutsideRecognizerTapped:(id)arg1;
- (void)handlePopupViewTouchUpInside:(id)arg1;
- (void)popupView:(id)arg1 didDeselectRecommendation:(id)arg2;
- (void)popupView:(id)arg1 didSelectRecommendation:(id)arg2;
- (void)presentationDidFinish:(id)arg1;
- (void)userInteractionDismissPopupView;
