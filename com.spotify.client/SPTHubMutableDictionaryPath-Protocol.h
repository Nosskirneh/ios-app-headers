...
@class NSDictionary;
@protocol NSCopying, SPTHubDictionaryActionButtonIconAlignmentPath, SPTHubDictionaryActionButtonSizePath, SPTHubDictionaryActionButtonStylePath, SPTHubDictionaryBoolPath, SPTHubDictionaryDatePath, SPTHubDictionaryDictionaryPath, SPTHubDictionaryDoublePath, SPTHubDictionaryHeaderViewStylePath, SPTHubDictionaryIconPath, SPTHubDictionaryImageDecorationPath, SPTHubDictionaryImageStylePath, SPTHubDictionaryItemTypePath, SPTHubDictionaryStringPath, SPTHubDictionaryTargetTypePath, SPTHubDictionaryURLPath, SPTHubDictionaryUnsignedIntegerPath, SPTHubMutableDictionaryPath;
