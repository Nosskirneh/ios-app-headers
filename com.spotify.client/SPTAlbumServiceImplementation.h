...
@protocol CollectionFeature, SPContextMenuFeature, SPTCollectionPlatformService, SPTContainerService, SPTContextDispatchService, SPTContributingArtistsService, SPTCoreService, SPTExplicitContentService, SPTFeatureFlagSignal, SPTFeatureFlaggingService, SPTFreeTierService, SPTFreeTierTestManager, SPTGLUEService, SPTNavigationFeature, SPTNetworkService, SPTPageRegistrationToken, SPTPerformanceMetricsService, SPTPlayerFeature, SPTSessionService, SPTSettingsFeature, SPTShareFeature, SPTShelfService, SPTSpotlightService, SPTSwiftAlbumService, SPTUIPresentationService, UpsellFeature;
...
@interface SPTAlbumServiceImplementation : NSObject <SPTFeatureFlagSignalObserver, SPTAlbumService>
{
    ...
    id <SPTSwiftAlbumService> _swiftAlbumService;
...
@property(nonatomic) __weak id <SPTSwiftAlbumService> swiftAlbumService; // @synthesize swiftAlbumService=_swiftAlbumService;
