...
@class NSArray, NSMutableArray, NSMutableDictionary, NSString, SPTDataLoader, SPTDataLoaderRequest, SPTFreeTierTasteOnboardingArtistCellStyle, SPTFreeTierTasteOnboardingArtistPickerViewLogger, SPTFreeTierTasteOnboardingCurator, SPTFreeTierTasteOnboardingGenreCellStyle, SPTFreeTierTasteOnboardingOfflineStateAggregateManager, SPTFreeTierTasteOnboardingSession, SPTFreeTierTasteOnboardingTheme, SPTPopupManager, UICollectionView, UICollectionViewFlowLayout, UIImage;
@protocol GLUEImageLoader, GLUEStyle, SPTFollowModelFactory, SPTFreeTierTasteOnboardingArtistPickerViewModelDelegate, SPTFreeTierTasteOnboardingTestManager;
...
- (id)followTitleTextForRepeatVisit:(_Bool)arg1 requiredCount:(unsigned long long)arg2;
