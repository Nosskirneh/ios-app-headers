...
#import "SPTUpsellManagerObserver-Protocol.h"

@class NSString, NSURL, SPTPlayerTrack, UIApplication;
@protocol PlaylistFeature, SPTNowPlayingFeedbackBarModelDelegate, SPTNowPlayingFeedbackManager, SPTPSXTestManager, SPTPlayer, SPTUpsellManager;
