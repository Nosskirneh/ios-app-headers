...
#import "SPTPlaylistActionDelegate-Protocol.h"
#import "SPTPlaylistAdditionalSectionDelegate-Protocol.h"
#import "SPTPlaylistInfoViewContainerDelegate-Protocol.h"
#import "SPTPlaylistMetadataViewDelegate-Protocol.h"
#import "SPTPlaylistTrackCellConfiguratorDelegate-Protocol.h"
#import "SPTPlaylistViewModelDelegate-Protocol.h"
...
@class GLUEButton, NSDictionary, NSLayoutConstraint, NSString, NSURL, SPTEntityTableHeaderView, SPTLayoutConstraintBuilder, SPTNetworkConnectivityController, SPTPerformanceMetricsViewLoggerImageLoaderObserver, SPTPlayInsteadViewModel, SPTPlayerState, SPTPlaylistHeaderActionBarView, SPTPlaylistLogger, SPTPlaylistMetadataViewImplementation, SPTPlaylistSortMenuButton, SPTPlaylistTestManager, SPTPlaylistTrackCellConfigurator, SPTProgressView, SPTSearchBar, SPTShareScreenshotObserverManager, SPTTableViewOfflineSwitchCell, UIAlertAction, UIAlertController, UIBarButtonItem, UIButton, UILabel, UIView;
@protocol GLUETheme, PlaylistFeature, SPContextMenuFeature, SPTAbbaFeatureFlags, SPTAdsManager, SPTBannerPresentationManager, SPTBarButtonItemManager, SPTBrowseRedirectButtonProvider, SPTCollectionLogger, SPTCollectionPlatformTestManager, SPTContextMenuOptions, SPTContextMenuPresenter, SPTExplicitContentAccessManager, SPTImageLoader, SPTInstrumentationMapper, SPTModalPresentationController, SPTNavigationRouter, SPTOfflineModeState, SPTOnDemandUpsell, SPTPageContainer, SPTPlayer, SPTPlayerQueue, SPTPlaylistAdditionalSection, SPTPlaylistInfoViewProtocol, SPTPlaylistViewModel, SPTProductState, SPTShareFeature, SPTShelves, SPTSponsoredContextViewModel, SPTSpotlightIndex, SPTUpsellManager, SPTViewLogger;

@interface PlaylistViewController : SPTableViewController <UISearchBarDelegate, UITextFieldDelegate, SPContentInsetViewController, SPTPlaylistMetadataViewDelegate, SPTNavigationControllerNavigationBarState, SPTPlaylistActionDelegate, SPTPlaylistAdditionalSectionDelegate, SPTImageLoaderDelegate, SPTThemableViewLayoutDelegate, SPTEntityTableHeaderViewDelegate, SPTContextMenuViewControllerDelegate, SPTOfflineModeStateObserver, SPTProductStateObserver, SPTOfflineSwitchDelegate, SPTOnDemandUpsellProtocol, SPTBarButtonItemManagerObserver, SPTPlaylistInfoViewContainerDelegate, SPTPlayerObserver, SPTInstrumentationInteractionMediatorColleague, SPTShareScreenshotObserverManagerDataSource, SPTShareableContext, SPTExplicitContentEnabledStateObserver, SPTPlaylistViewModelDelegate, SPTPageController, SPTPlaylistTrackCellConfiguratorDelegate>
{
