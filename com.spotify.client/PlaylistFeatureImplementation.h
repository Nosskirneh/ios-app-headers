...
@protocol ProfileFeature, SPContextMenuFeature, SPTAbbaService, SPTAdsService, SPTBannerFeature, SPTBrowsePlatformService, SPTBrowseRedirectButtonProvider, SPTCollectionLogger, SPTCollectionPlatformService, SPTCollectionSortingEntityManager, SPTContainerService, SPTContainerUIService, SPTCoreService, SPTExplicitContentService, SPTFeatureFlagSignal, SPTFeatureFlaggingService, SPTFormatListPlatformRegistration, SPTFormatListPlatformService, SPTFreeTierEducationService, SPTFreeTierService, SPTGLUEService, SPTInstrumentationService, SPTNavigationFeature, SPTNetworkService, SPTNuxService, SPTPageRegistrationToken, SPTPerformanceMetricsService, SPTPlayerFeature, SPTPlaylistExtenderService, SPTPlaylistPlatformService, SPTSessionService, SPTSettingsFeature, SPTShareFeature, SPTShelfService, SPTSpotlightService, SPTUIPresentationService, SPTURIDispatchService, UpsellFeature;
...
@interface PlaylistFeatureImplementation : NSObject <SPTFeatureFlagSignalObserver, SPTService, PlaylistFeature>
{
    ...
    id <SPTPlaylistExtenderService> _playlistExtenderService;
...
@property(nonatomic) __weak id <SPTPlaylistExtenderService> playlistExtenderService; // @synthesize playlistExtenderService=_playlistExtenderService;
...
- (id)provideAdditionalSectionForEntityURL:(id)arg1;
