...
- (id)initWithItemModelEntity:(id)arg1 isPlayingTrack:(_Bool)arg2 isOffline:(_Bool)arg3 isPlaybackRestricted:(_Bool)arg4 isPremiumOnlyFeatureEnabled:(_Bool)arg5 testManager:(id)arg6 showAlbumNameOnSongEntities:(_Bool)arg7;
