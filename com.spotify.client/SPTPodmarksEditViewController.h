...
@class GLUEButton, GLUELabel, NSString, NSURL, SPTLayoutConstraintBuilder, SPTPodcastLogger, SPTPodmark, SPTSharePodmarkView, UIButton, UIImage, UITextView, UIView;
@protocol GLUETheme, SPTImageLoader, SPTPodmarksEditViewControllerDelegate;
...
- (void)viewDidLoad;
- (id)initWithEpisodeURL:(id)arg1 imageLoader:(id)arg2 theme:(id)arg3 podcastLogger:(id)arg4;
