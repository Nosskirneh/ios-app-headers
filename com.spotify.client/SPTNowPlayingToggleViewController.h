...
@class NSHashTable, NSString, NSURL, SPTNavigationManager, SPTNowPlayingBackgroundUnitProvider, SPTNowPlayingContainerIdleMonitor, SPTNowPlayingLogger, SPTNowPlayingModel, SPTNowPlayingScrollViewController, SPTPlayerState, SPTStatusBarToken, SPTTheme, UIView, UIViewController<SPTQueueEnabling>;
...
- (void)viewDidLoad;
- (void)dealloc;
- (id)initWithModel:(id)arg1 playerViewController:(id)arg2 queueViewController:(id)arg3 scrollViewController:(id)arg4 theme:(id)arg5 player:(id)arg6 navigationManager:(id)arg7 backgroundUnitProvider:(id)arg8 heartsPopupPresenter:(id)arg9 testManager:(id)arg10 logger:(id)arg11 queueLogger:(id)arg12;
