...
@protocol SPTAlbumViewModelCollectionDelegate, SPTAlbumViewModelPlaybackDelegate, SPTClientSettings, SPTCollectionPlatform, SPTCollectionPlatformDataLoaderRequestToken, SPTCollectionPlatformTestManager, SPTContributingArtistsService, SPTExplicitContentAccessManager, SPTOfflineManager, SPTPlayer, SPTProductState, SPTUIPresentationService, SPTUpsellManager;
