...
@class NSArray, NSString, NSURL, SPTNowPlayingCarouselGradientView, SPTNowPlayingHeartIndicatorView, SPTNowPlayingVideoTimer, SPTPlayerTrack, UIActivityIndicatorView, UIButton, UIImage, UIImageView, UIView<SPTNowPlayingCoverArtContentView>, UIView<SPTVideoSurface>;
...
@interface SPTNowPlayingCoverArtViewCell : UIView <SPTImageLoaderDelegate, SPTVideoSurfaceDelegate, SPTNowPlayingCoverArtContentViewDelegate, SPTNowPlayingVideoTimerDelegate>
{
    ...
    UIView *_overlayView;
    SPTNowPlayingHeartIndicatorView *_heartIndicatorView;
...
@property(retain, nonatomic) SPTNowPlayingHeartIndicatorView *heartIndicatorView; // @synthesize heartIndicatorView=_heartIndicatorView;
...
- (void)addHeartIndicatorViewForTrack:(id)arg1;
...
@property(readonly, nonatomic) _Bool shouldShowHeartIndicatorView;
- (void)layoutSubviews;
- (id)initWithFrame:(struct CGRect)arg1 imageLoader:(id)arg2 videoSurfaceManager:(id)arg3 testManager:(id)arg4;
