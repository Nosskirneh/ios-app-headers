...
@class NSMutableArray, NSString, NSURL, SPSession, SPTDataLoader, SPTInfinitePlaybackAlertController, SPTInfinitePlaybackContext, SPTNetworkConnectivityController, SPTRadioAutoplayOfflineLogger, SPTRadioLogger, SPTRadioPlaybackService;
...
- (void)dealloc;
- (id)initWithPlayer:(id)arg1 playbackService:(id)arg2 localSettings:(id)arg3 session:(id)arg4 dataLoader:(id)arg5 networkConnectivity:(id)arg6 gaiaManager:(id)arg7 alertController:(id)arg8 logger:(id)arg9 offlineLogger:(id)arg10;
