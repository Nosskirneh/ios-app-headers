...
#import "SPTPodcastEpisodeStringFormatter-Protocol.h"
...
- (id)fixedPublicationAndDurationWithEpisode:(id)arg1 currentDate:(id)arg2;
...
- (id)relativePublicationAndDurationWithEpisode:(id)arg1 currentDate:(id)arg2;
