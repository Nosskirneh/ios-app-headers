...
- (void).cxx_destruct;
- (id)actionAccessibilityHintWithBanState:(_Bool)arg1 source:(unsigned long long)arg2;
...
- (id)actionNameForItemWithCollectionBanState:(_Bool)arg1 source:(unsigned long long)arg2;
- (id)actionIconColorForItemWithCollectionBanState:(_Bool)arg1 source:(unsigned long long)arg2;
