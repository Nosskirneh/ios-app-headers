...
@protocol HUBContentOperationDelegate, SPTFreeTierTrackUpsellTestManager;

@interface SPTFreeTierTrackUpsellContentOperation : NSObject <HUBContentOperation>
{
...
- (void).cxx_destruct;
- (void)addloggingForSecondaryCTAButtonDictionary:(id)arg1;
...
- (id)initWithUpsellTestManager:(id)arg1;
