...
@class FBKVOController, NSArray, NSHashTable, NSString, SPTVideoDisplayView, SPTVideoPlayerSource, SPTVideoPreferences, UIView;
@protocol SPTVideoKeyframeLoader, SPTVideoSurface, SPTVideoSurfaceManagerDataSource;
