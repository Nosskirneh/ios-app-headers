...
@class SPTSpeakerActivationLogger, SPTSpeakerActivationSuggestionV2PopupView, SPTSpeakerActivationSuggestionV2PopupViewModel;
@protocol GLUEImageLoader;

@interface SPTSpeakerActivationSuggestionV2PopupContentViewController : UIViewController
{
    SPTSpeakerActivationLogger *_logger;
    id <GLUEImageLoader> _glueImageLoader;
    SPTSpeakerActivationSuggestionV2PopupView *_popupView;
...
@property(retain, nonatomic) SPTSpeakerActivationSuggestionV2PopupView *popupView; // @synthesize popupView=_popupView;
