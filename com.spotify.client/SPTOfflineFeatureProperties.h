...
{
    _Bool _likedSongsInOfflineMusicContent;
...
@property(readonly, nonatomic) _Bool likedSongsInOfflineMusicContent; // @synthesize likedSongsInOfflineMusicContent=_likedSongsInOfflineMusicContent;
- (void).cxx_destruct;
- (id)propertyModels;
