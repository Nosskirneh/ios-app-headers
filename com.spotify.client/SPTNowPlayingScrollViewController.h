...
#import "SPTNowPlayingScrollViewModelDelegate.h"
#import "UICollectionViewDataSource.h"
#import "UICollectionViewDelegate.h"

@class NSNotificationCenter, NSString, SPTCarouselBackgroundBlurController, SPTCarouselBlurBackgroundView, SPTNowPlayingBackgroundGradientView, SPTNowPlayingContainerIdleMonitor, SPTNowPlayingContentCornersView, SPTNowPlayingScrollViewModel, SPTTheme, UICollectionView, UICollectionViewFlowLayout, UIViewController<SPTNowPlayingContentContainingViewController>;

@interface SPTNowPlayingScrollViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegate, SPTNowPlayingScrollViewModelDelegate, SPTNowPlayingModelObserver, SPTNowPlayingContainerIdleMonitorDelegate, SPTNowPlayingContainerIdleMonitorReceiving>
{
    ...
    _Bool _shouldSkipOffsetCorrection;
...
@property(nonatomic) _Bool shouldSkipOffsetCorrection; // @synthesize shouldSkipOffsetCorrection=_shouldSkipOffsetCorrection;
...
- (void)nowPlayingScrollViewModel:(id)arg1 didChangeComponentProviders:(id)arg2;
