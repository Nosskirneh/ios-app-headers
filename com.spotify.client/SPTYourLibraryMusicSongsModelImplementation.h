...
- (void)dealloc;
- (id)initWithCollectionPlatform:(id)arg1 recommendedTracksDataLoader:(id)arg2 clientSettings:(id)arg3 explicitContentAccessManager:(id)arg4 productState:(id)arg5 currentUsername:(id)arg6 filterSortManager:(id)arg7 testManager:(id)arg8 skippedRecommendedTracks:(id)arg9 externalFilterModel:(id)arg10;
