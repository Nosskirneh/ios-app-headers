...
@interface SPTHearablesSpacesRecommendations : NSObject <SPTHearablesRecommendationEngine>
{
...
- (void).cxx_destruct;
- (void)getRecommendationsFromURI:(id)arg1 sessionIdentifier:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
