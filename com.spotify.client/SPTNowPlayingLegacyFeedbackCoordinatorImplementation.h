...
#import "SPTNowPlayingLegacyFeedbackCoordinator.h"

@class NSString, SPTNowPlayingLegacyDailyMixFeedbackHandlerImplementation, SPTNowPlayingLegacyFormatListFeedbackHandlerImplementation, SPTNowPlayingLegacyRadioFeedbackHandlerImplementation, SPTTheme;
...
- (id)initWithContextMenuPresenterFactory:(id)arg1 dailyMixFeedbackModel:(id)arg2 radioRemoteControlPolicy:(id)arg3 formatListPlatformRemoteControlPolicyFactory:(id)arg4 feedbackViewModel:(id)arg5 theme:(id)arg6 psxTestManager:(id)arg7 snackBarPresenter:(id)arg8 collectionConfiguration:(id)arg9;
