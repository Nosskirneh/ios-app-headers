...
@protocol SPTDrivingNowPlayingSliderViewDataSource;

@interface SPTDrivingNowPlayingSliderView : SPTSliderWithLabel
{
    _Bool _trackingState;
    float _trackingSpeed;
    float _uncompensatedTrackingValue;
    id <SPTDrivingNowPlayingSliderViewDataSource> _dataSource;
...
@property(nonatomic) __weak id <SPTDrivingNowPlayingSliderViewDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void).cxx_destruct;
