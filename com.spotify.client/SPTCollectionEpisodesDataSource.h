...
@class NSString, SPTCollectionEpisodesActionViewModel, SPTCollectionEpisodesViewModel, SPTPodcastLogger, SPTShowContextMenuController, UIViewController;
@protocol SPTAlertController, SPTCollectionLogger, SPTFreeTierCollectionYourLibraryScrollProtocol, SPTImageLoader, SPTImageLoaderDelegate><SPTPageController><SPTCollectionEpisodesViewModelDelegate, SPTLinkDispatcher, SPTPodcastCollectionDataSourceUpdateDelegate, SPTPodcastContextMenuProvider, SPTPodcastEpisodeCellConfigurator, SPTPodcastTestManager, SPTShareFeature;

@interface SPTCollectionEpisodesDataSource : NSObject <SPTPodcastEpisodeTableViewCellDelegate, UITableViewDelegate, UITableViewDataSource, SPTFreeTierCollectionYourLibraryScrollDelegate>
{
