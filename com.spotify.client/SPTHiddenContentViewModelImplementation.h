...
#import "SPTHiddenContentModelDelegate.h"
#import "SPTHiddenContentViewModel.h"

@class NSArray<SPTHiddenContentArtistViewModel>, NSArray<SPTHiddenContentTrackViewModel>, NSError, NSString, SPTHiddenContentPerfLogger, SPTTheme;
