...
@protocol EXP_SPTHubsRendererFactory, GLUETheme, SPTBarButtonItemManager, SPTFreeTierTestManager, SPTHugsFactory, SPTPermissionsOnDemandState;
...
- (id)initWithComponentRegistry:(id)arg1 hubsRendererFactory:(id)arg2 hugsFactory:(id)arg3 contentOperationFactory:(id)arg4 commandHandlerFactory:(id)arg5 barButtonFactory:(id)arg6 glueTheme:(id)arg7 artistHubComponentsFactory:(id)arg8 onDemandState:(id)arg9 freeTierTestManager:(id)arg10 barButtonItemManager:(id)arg11;
