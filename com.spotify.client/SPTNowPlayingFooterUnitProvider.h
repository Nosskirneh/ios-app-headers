...
@class SPTNowPlayingLogger, SPTNowPlayingTrackMetadataQueue, SPTNowPlayingTrackPosition, SPTPlayerState, SPTTheme, UIApplication, UIView;
@protocol PlaylistFeature, SPTDailyMixManager, SPTDailyMixTestManager, SPTGaiaDevicesAvailableViewProvider, SPTGaiaManager, SPTKaraokeTestManager, SPTKaraokeUserInterfaceFactory, SPTNowPlayingManager, SPTNowPlayingTestManager, SPTPSXTestManager, SPTPersonalisedSetsNowPlayingFeedbackManagerFactory, SPTUpsellManager;
...
- (id)initWithPlayer:(id)arg1 gaiaManager:(id)arg2 nowPlayingManager:(id)arg3 testManager:(id)arg4 theme:(id)arg5 devicesAvailableViewProvider:(id)arg6 dailyMixManager:(id)arg7 dailyMixTestManager:(id)arg8 trackPositionModel:(id)arg9 trackMetadataQueue:(id)arg10 animationView:(id)arg11 psxTestManager:(id)arg12 playlistFeature:(id)arg13 upsellManager:(id)arg14 application:(id)arg15 personalisedSetsNowPlayingFeedbackManagerFactory:(id)arg16 logger:(id)arg17 karaokeUserInterfaceFactory:(id)arg18 karaokeTestManager:(id)arg19;
