...
#import "SPTCollectionRecentlyPlayedViewModelDelegate-Protocol.h"
...
@class GLUEEntityRowStyle, NSString, SPTCollectionRecentlyPlayedViewModel, SPTCollectionTheme, UIButton, UITableView;
@protocol GLUEImageLoader, GLUEStyleable, SPTCollectionLogger, SPTCollectionSupplementaryViewProvider, SPTViewLogger;
