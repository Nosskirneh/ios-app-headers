...
@class NSArray, NSDate, NSHashTable, NSMutableSet, NSString, SPTDataLoader, SPTPersistentCache;
@protocol OS_dispatch_queue, SPTDailyMixTestManager, SPTExplicitContentAccessManager, SPTRadioTestManager;
