...
@protocol SPContextMenuFeature, SPTGaiaManager, SPTNowPlayingManager, SPTNowPlayingNavigationBarModel, SPTNowPlayingTestManager, SPTPermissionsOnDemandState, SPTPodcastContextMenuProvider, SPTQueueLogger;
...
- (id)initWithModel:(id)arg1 navigationBarModel:(id)arg2 nowPlayingManager:(id)arg3 theme:(id)arg4 logger:(id)arg5 queueLogger:(id)arg6 testManager:(id)arg7 player:(id)arg8 notificationCentre:(id)arg9 gaiaManager:(id)arg10 contextMenuFeature:(id)arg11 podcastContextMenuProvider:(id)arg12 onDemandPermissionState:(id)arg13;
