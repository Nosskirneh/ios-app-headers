...
@class NSString, NSURL, SPTAdContextManager, SPTAdCosmosBridge, SPTAdFeatureFlagChecks, SPTAdFeaturedActionHandler, SPTAdFocusManager, SPTAdGlobalSettingsController, SPTAdLinkHandler, SPTAdMobileOverlayController, SPTAdMovementLogger, SPTAdNPVModeCreator, SPTAdNowPlayingManager, SPTAdOptInManager, SPTAdRegistry, SPTAdRegistryInformationManager, SPTAdRulesManager, SPTAdSponsoredSessionContentUnitProvider, SPTAdSponsoredSessionController, SPTAdStateLogger, SPTAdVideoEventReporter, SPTAdsActivityLogger, SPTAdsAutoDetectionController, SPTAdsMoatManager, SPTAdsViewModel, SPTAllocationContext, SPTInterruptionVideoEventReporter, SPTSponsoredContextManager;
@protocol CosmosFeature, FollowFeature, SPContextMenuFeature, SPTAbbaService, SPTAccessoryManagerService, SPTAdEventLogger, SPTAdsManager, SPTCollectionPlatformService, SPTContainerService, SPTContainerUIService, SPTCoreService, SPTCrashReporterService, SPTDebugService, SPTExternalIntegrationDriverDistractionService, SPTFreeTierService, SPTGLUEService, SPTLocalSettings, SPTNetworkService, SPTPlayer, SPTPlayerFeature, SPTPlaylistPlatformService, SPTResolver, SPTSessionService, SPTSettingsFeature, SPTURIDispatchService, SPTVideoFeature, SlateFeature;
