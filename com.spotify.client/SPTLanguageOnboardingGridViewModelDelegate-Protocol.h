...
- (void)viewModel:(SPTLanguageOnboardingGridViewModel *)arg1 didDeselectLanguageAtIndex:(unsigned long long)arg2;
- (void)viewModel:(SPTLanguageOnboardingGridViewModel *)arg1 didSelectLanguageAtIndex:(unsigned long long)arg2;
