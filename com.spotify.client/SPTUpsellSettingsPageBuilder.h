...
@protocol SPTAlertController, SPTFeatureSettingsItemFactory, SPTNavigationListProvider, SPTProductState, SPTSlateBuilderProvider, SPTSlateManager, SPTUpsellJSONPreviewParser, SPTUpsellLogger, SPTUpsellManager;
