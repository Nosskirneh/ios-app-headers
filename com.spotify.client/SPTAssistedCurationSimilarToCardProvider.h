...
@protocol SPTAssistedCurationCardsProviderDelegate, SPTAssistedCurationRecommendedTracksDataLoader, SPTCollectionPlatformDataLoader;
...
- (id)initWithAssistedCurationRecommendedTracksDataLoader:(id)arg1 collectionPlatformDataLoader:(id)arg2;
