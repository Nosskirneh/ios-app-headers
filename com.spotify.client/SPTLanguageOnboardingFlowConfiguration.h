...
@class SPTLanguageOnboardingDataLoader, SPTLanguageOnboardingLoggerFactory, SPTLanguageOnboardingTheme, SPTNetworkConnectivityController, SPTPopupManager;
@protocol GLUEImageLoader, SPTLanguageOnboardingTestManager, SPTModalPresentationController;
...
- (void).cxx_destruct;
- (id)initWithModalPresentationController:(id)arg1 languageOnboardingDataLoader:(id)arg2 languageOnboardingTheme:(id)arg3 imageLoader:(id)arg4 networkConnectivityController:(id)arg5 popupManager:(id)arg6 testManager:(id)arg7 loggerFactory:(id)arg8;
