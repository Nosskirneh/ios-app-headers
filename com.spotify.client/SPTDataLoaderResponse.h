...
@class NSArray, NSData, NSDate, NSDictionary, NSError, NSString, NSURLResponse, SPTDataLoaderRequest, SPTHeartsRecommendationList;
...
@property(readonly, nonatomic) NSDictionary *playerContext;
@property(readonly, nonatomic) SPTHeartsRecommendationList *heartsRecommendationList;
