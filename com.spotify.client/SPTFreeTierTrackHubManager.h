...
@protocol EXP_SPTHubsRendererFactory, GLUETheme, SPTGaiaUserInterfaceContextObserver, SPTHugsFactory;
...
- (id)initWithComponentRegistry:(id)arg1 hubsRendererFactory:(id)arg2 hugsFactory:(id)arg3 contentOperationFactory:(id)arg4 commandHandlerFactory:(id)arg5 barButtonFactory:(id)arg6 glueTheme:(id)arg7 gaiaObserverService:(id)arg8;
