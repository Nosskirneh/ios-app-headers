...
#import "EXP_SPTHubPagedContentOperationDelegate-Protocol.h"

@class NSString;
@protocol EXP_HUBContentOperationDelegate, EXP_HUBViewModelBuilder, EXP_SPTHubPagedContentOperation;
