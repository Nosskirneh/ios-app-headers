...
@class NSString, SPTNowPlayingCoverArtController, SPTNowPlayingCoverArtView, SPTNowPlayingLogger, SPTNowPlayingModel, SPTNowPlayingShowsFormatOverlayView, SPTTheme;
@protocol SPTAdsManager, SPTImageLoaderFactory, SPTNowPlayingCarouselContentProviderRegistry, SPTNowPlayingTestManager, SPTNowPlayingVideoManager, SPTUpsellManager, SPTVideoSurfaceManager;
...
- (void)viewDidLoad;
- (id)initWithModel:(id)arg1 imageLoaderFactory:(id)arg2 theme:(id)arg3 logger:(id)arg4 videoSurfaceManager:(id)arg5 nowPlayingVideoManager:(id)arg6 testManager:(id)arg7 upsellManager:(id)arg8 carouselRegistry:(id)arg9 adsManager:(id)arg10;
