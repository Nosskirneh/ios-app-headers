...
@class NSString;
@protocol SPTInteractionSenderLoggerFactory, SPTLogCenter, SPTPerformanceMetricsViewLoggerFactory;
...
@interface SPTHubLoggerFactoryImplementation : NSObject <SPTHubLoggerFactory>
{
    ...
    id <SPTInteractionSenderLoggerFactory> _interactionLoggerFactory;
}

@property(retain, nonatomic) id <SPTInteractionSenderLoggerFactory> interactionLoggerFactory; // @synthesize interactionLoggerFactory=_interactionLoggerFactory;
...
- (id)initWithLogCenter:(id)arg1 viewLoggerFactory:(id)arg2 interactionLoggerFactory:(id)arg3;
