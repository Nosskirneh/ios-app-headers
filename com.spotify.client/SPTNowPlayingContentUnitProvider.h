...
@class NSHashTable, NSString, SPTCarouselBackgroundBlurController, SPTNowPlayingLogger, SPTNowPlayingModel, SPTTheme, UIView;
@protocol SPTAdsManager, SPTImageLoaderFactory, SPTNowPlayingContentProviderRegistries, SPTNowPlayingTestManager, SPTNowPlayingVideoManager, SPTUpsellManager, SPTVideoSurfaceManager;
