...
#import "SPTFeedService.h"

@class NSString, SPTAllocationContext, SPTFeedFeatureFlagExposureLoggerImplementation, SPTFeedFeatureFlagsManager, SPTFeedHeartBeatManagerImplementation, SPTFeedHeartBeatRefreshStore;
