...
- (id)initWithServiceIdentifier:(id)arg1 remoteURLResolver:(id)arg2 hubsRendererFactory:(id)arg3 hugsFactory:(id)arg4 GLUETheme:(id)arg5 podcastImportViewControllerFactory:(id)arg6;
