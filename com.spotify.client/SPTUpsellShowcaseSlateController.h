...
@class NSString, SPTUpsellDismissAction, SPTUpsellGLUETheme, SPTUpsellLogMessageLogger, SPTUpsellShowcaseSlateViewModel;
@protocol SPTSlate, SPTSlateBuilderProvider, SPTSlateManager, SPTUpsellOverlayControllerDelegate;

@interface SPTUpsellShowcaseSlateController : NSObject <SPTSlateDelegate, SPTSlateDataSource, SPTUpsellOverlayContentViewDelegate, SPTUpsellOverlayController>
{
    _Bool _presented;
