...
@interface SPTProfileViewAllViewController : SPViewController <SPTBaseViewModelDelegate, SPObjectRepresentation, UITableViewDataSource, UITableViewDelegate, SPTPageController>
{
