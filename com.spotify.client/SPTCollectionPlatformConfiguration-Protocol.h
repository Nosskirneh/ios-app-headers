...
- (NSString *)actionAccessibilityHintWithBanState:(_Bool)arg1 source:(unsigned long long)arg2;
- (NSString *)actionNameForItemWithCollectionBanState:(_Bool)arg1 source:(unsigned long long)arg2;
- (UIColor *)actionIconColorForItemWithCollectionBanState:(_Bool)arg1 source:(unsigned long long)arg2;
- (long long)actionIconForItemWithCollectionBanState:(_Bool)arg1 source:(unsigned long long)arg2;
