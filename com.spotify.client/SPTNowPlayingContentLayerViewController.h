...
@class NSArray, NSMutableSet, NSNotificationCenter, NSString, SPTNowPlayingCarouselBackgroundBlurController, SPTNowPlayingContainerIdleMonitor, SPTNowPlayingContentLayerViewModel, SPTNowPlayingShowsFormatOverlayView, SPTObserverManager, SPTTheme, UICollectionView;
