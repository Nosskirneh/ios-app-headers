...
@interface SPTFancyRecentsItem : NSObject
{
    NSURL *_originURI;
    NSURL *_targetURI;
    NSString *_title;
...
+ (_Bool)isComponentModelVideoRow:(id)arg1;
...
- (_Bool)isEqualToFancyRecentsItem:(id)arg1;
- (id)dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1;
- (id)initWithOriginURI:(id)arg1 componentModel:(id)arg2;
- (id)initWithOriginURI:(id)arg1 targetURI:(id)arg2 title:(id)arg3 subtitle:(id)arg4 imageURI:(id)arg5 placeholderIconIdentifier:(id)arg6 style:(id)arg7;
