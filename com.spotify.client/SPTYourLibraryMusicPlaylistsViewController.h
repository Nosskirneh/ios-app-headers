...
#import "SPTQuickScrollViewDatasource-Protocol.h"
#import "SPTQuickScrollViewDelegate-Protocol.h"
...
@class NSString, NSURL, SPTProgressView, SPTTableView, SPTYourLibraryMusicEmptyView, SPTYourLibraryMusicFilterBarViewController, SPTYourLibraryMusicGLUETheme, SPTYourLibraryMusicPlaylistsCellConfigurator, UIView;
@protocol GLUEImageLoader, SPTPageContainer, SPTQuickScrollFactory, SPTQuickScrollView, SPTShareDragDelegateFactory, SPTSortingFilteringUIFactory, SPTViewLogger, SPTYourLibraryMusicPlaylistsViewModel, SPTYourLibraryPageDelegate, UITableViewDragDelegate;

@interface SPTYourLibraryMusicPlaylistsViewController : UIViewController <SPTYourLibraryMusicFilterBarViewControllerDelegate, SPTScrollToTopViewController, SPContentInsetViewController, SPTQuickScrollViewDatasource, SPTQuickScrollViewDelegate, UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, SPTPageController, SPTYourLibraryPage, SPTYourLibraryMusicPlaylistsViewModelDelegate, SPViewController>
{
    ...
    UIView<SPTQuickScrollView> *_quickScrollView;
...
@property(retain, nonatomic) UIView<SPTQuickScrollView> *quickScrollView; // @synthesize quickScrollView=_quickScrollView;
