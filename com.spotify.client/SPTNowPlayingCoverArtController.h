...
@protocol SPTAdsManager, SPTCarouselBackgroundBlurDelegate, SPTImageLoader, SPTImageLoaderFactory, SPTNowPlayingCoverArtControllerDelegate, SPTNowPlayingTestManager, SPTNowPlayingVideoManager, SPTVideoSurfaceManager;

@interface SPTNowPlayingCoverArtController : NSObject <SPTNowPlayingCoverArtModelDelegate, SPTNowPlayingCoverArtViewDataSource, SPTNowPlayingCoverArtViewDelegate, SPTNowPlayingCarouselContentProviderRegistryImplementationDelegate, SPTImageLoaderDelegate, UIGestureRecognizerDelegate>
{
    _Bool _visible;
