...
#import "SPTDeprecatedLegacyLinkDispatcher-Protocol.h"
...
@protocol SPTAlertController, SPTExternalLinkControllerCampaignDelegate, SPTURISchemeRegistry;

@interface SPTLinkDispatcherImplementation : NSObject <SPTExternalLinkControllerCampaignDelegate, SPTURISchemeDispatcherMessagingDelegate, SPTExternalLinkController, SPTLinkDispatcher, SPTDeprecatedLegacyLinkDispatcher>
{
    _Bool _loggedIn;
...
- (_Bool)DEPRECATED_navigateToURI:(id)arg1 sourceApplication:(id)arg2 annotation:(id)arg3 options:(long long)arg4;
