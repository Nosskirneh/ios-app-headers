...
@class NSString;
@protocol SPTClientSettings, SPTCollectionPlatformDataLoader, SPTCollectionPlatformDataLoaderRequestToken, SPTFreeTierCollectionMigration, SPTLocalSettings, SPTYourLibraryMusicFavoriteMixModelDelegate, SPTYourLibraryMusicTestManager;
...
- (void)updateModel;
- (void)loadModel;
- (id)initWithLocalSettings:(id)arg1 collectionPlatformDataLoader:(id)arg2 clientSettings:(id)arg3 freeTierCollectionMigration:(id)arg4 testManager:(id)arg5;
