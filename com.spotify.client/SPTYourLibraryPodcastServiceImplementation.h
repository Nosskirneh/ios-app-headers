...
@protocol SPTCollectionLogger, SPTCollectionPlatformService, SPTContainerService, SPTExplicitContentService, SPTGLUEService, SPTPerformanceMetricsService, SPTPlayerFeature, SPTPodcastFeature, SPTPodcastUIService, SPTRecentlyPlayedService, SPTSessionService, SPTYourLibraryService;
