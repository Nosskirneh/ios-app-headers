...
@class EXP_HUBComponentView, NSString, NSURL, SPTSwipeGestureRecognizer, UICollectionView;
@protocol EXP_SPTHubComponentModelURIResolver, EXP_SPTHubSwipeableTableViewCellComponentView, SPTShelves;
