...
#import "SPTArtistService-Protocol.h"
#import "SPTFeatureFlagSignalObserver-Protocol.h"

@class NSString, SPTAllocationContext, SPTArtistEndpointFactory, SPTArtistHubManager, SPTArtistResolverFactory, SPTArtistSettingsManager, SPTArtistTestManager;
@protocol CosmosFeature, EXP_SPTHubFrameworkService, FollowFeature, SPContextMenuFeature, SPTAbbaFeatureFlags, SPTAbbaService, SPTArtistUIService, SPTCollectionPlatformService, SPTContainerService, SPTCoreService, SPTCrashReporter, SPTCrashReporterService, SPTExplicitContentService, SPTFeatureFlagSignal, SPTFeatureFlaggingService, SPTFreeTierService, SPTGLUEService, SPTNavigationFeature, SPTNetworkService, SPTNowPlayingScrollService, SPTPageRegistrationToken, SPTPerformanceMetricsService, SPTResolver, SPTSessionService, SPTSettingsFeature, SPTShelfService, SPTUIPresentationService, SPTURIDispatchService;

@interface SPTArtistServiceImplementation : NSObject <SPTFeatureFlagSignalObserver, SPTArtistService>
{
    id <SPTAbbaFeatureFlags> _featureFlags;
    id <SPTFeatureFlagSignal> _legacyArtistFeatureEnabledSignal;
    id <SPTFeatureFlagSignal> _artistFollowHeaderEnabledSignal;
...
@property(retain, nonatomic) id <SPTFeatureFlagSignal> artistFollowHeaderEnabledSignal; // @synthesize artistFollowHeaderEnabledSignal=_artistFollowHeaderEnabledSignal;
...
- (void).cxx_destruct;
- (void)unregisterArtistService;
- (void)registerArtistService;
...
- (void)registerNPVScrollProvider;
...
- (id)provideArtistAlbumsViewController:(id)arg1 context:(id)arg2;
- (id)provideArtistPlaylistsViewController:(id)arg1 context:(id)arg2;
- (id)provideArtistRelatedArtistsViewController:(id)arg1 context:(id)arg2;
- (void)unload;
- (void)load;
