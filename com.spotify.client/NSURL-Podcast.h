...
@property(readonly, nonatomic, getter=spt_isPodmarksEpisodesCollectionURL) _Bool isPodmarksEpisodesCollectionURL;
@property(readonly, nonatomic, getter=spt_isPodmarksCollectionURL) _Bool isPodmarksCollectionURL;
...
@property(readonly, nonatomic, getter=spt_isCollectionShowsURL) _Bool isCollectionShowsURL;
