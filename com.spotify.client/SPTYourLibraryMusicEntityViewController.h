...
@protocol GLUEImageLoader, SPTPageContainer, SPTQuickScrollFactory, SPTQuickScrollView, SPTShareDragDelegateFactory, SPTSnackbarConditionalPresenter, SPTSortingFilteringUIFactory, SPTViewLogger, SPTYourLibraryMusicEntityCellConfigurator, SPTYourLibraryMusicEntityViewModel, SPTYourLibraryPageDelegate, UITableViewDragDelegate;

@interface SPTYourLibraryMusicEntityViewController : UIViewController <SPTYourLibraryMusicFilterBarViewControllerDelegate, SPTYourLibraryMusicEntityCellConfiguratorDelegate, SPTQuickScrollViewDelegate, SPTQuickScrollViewDatasource, UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, SPTYourLibraryPage, SPTYourLibraryMusicEntityViewModelDelegate, SPTScrollToTopViewController, SPTPageController>
{
