...
- (void)viewDidLoad;
- (id)initWithViewModel:(id)arg1 imageLoader:(id)arg2 theme:(id)arg3 styleFactoryBlock:(CDUnknownBlockType)arg4 viewLogger:(id)arg5 sortingFilteringUIFactory:(id)arg6 shareDragDelegateFactory:(id)arg7;
