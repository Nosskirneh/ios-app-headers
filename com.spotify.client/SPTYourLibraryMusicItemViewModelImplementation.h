...
@protocol SPTYourLibraryMusicAlbumEntity, SPTYourLibraryMusicArtistEntity, SPTYourLibraryMusicFolderEntity, SPTYourLibraryMusicPlaylistEntity, SPTYourLibraryMusicSongEntity, SPTYourLibraryMusicTestManager;
...
@property(retain, nonatomic) id <SPTYourLibraryMusicSongEntity> songEntity; // @synthesize songEntity=_songEntity;
