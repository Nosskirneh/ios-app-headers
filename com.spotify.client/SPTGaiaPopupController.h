...
@class NSNotificationCenter, NSString, SPTGaiaDeviceAppearanceMapping, SPTGaiaDeviceManager, SPTGaiaLogger, SPTGaiaPopupContentViewController, SPTPopupDialog, SPTTheme;
@protocol SPTAlertController, SPTPlayer, SPTProductState;
...
- (void)dealloc;
- (id)initWithDeviceManager:(id)arg1 alertController:(id)arg2 player:(id)arg3 productState:(id)arg4 theme:(id)arg5 deviceIconMapper:(id)arg6 notificationCenter:(id)arg7 logger:(id)arg8;
