...
@protocol CosmosFeature, EXP_SPTHubFrameworkService, ProfileFeature, SPTAbbaService, SPTContainerService, SPTContainerUIService, SPTFeatureFlagFactory, SPTFeatureFlaggingService, SPTFeedService, SPTFreeTierService, SPTGLUEService, SPTHomeTestManager, SPTHomeUIService, SPTLocalSettings, SPTNetworkService, SPTPageRegistrationToken, SPTRecentlyPlayedService, SPTSessionService, SPTSettingsFeature, SPTURIDispatchService;
