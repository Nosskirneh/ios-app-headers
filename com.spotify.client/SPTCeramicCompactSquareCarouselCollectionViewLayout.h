...
#import "SPTCeramicCollectionViewLayout-Protocol.h"

@class NSString, SPTCeramicCollectionView;

@interface SPTCeramicCompactSquareCarouselCollectionViewLayout : SPTCeramicCollectionViewLayout <SPTCeramicCollectionViewLayout>
{
