...
@interface SPTCollectionPlatformFollowHeartSignalConfiguration : NSObject <SPTCollectionPlatformConfiguration>
{
...
- (id)initWithEducationPresenter:(id)arg1 useHideWhenBanningTracks:(_Bool)arg2 usePodcastYourLibraryTitle:(_Bool)arg3;
