...
@protocol SPTAdEventLogger, SPTLogCenter, SPTPlayer, SPTStateController;

@interface SPTAdsViewModel : NSObject <SPTAdContextManagerObserver, SPTAdRegistryObserver>
{
