...
@protocol SPTAdsBaseCosmosBridge, SPTAdsBaseEntity, SPTAdsBaseRegistry, SPTLogCenter, SPTPlayer, SPTStateController;
...
- (void)dealloc;
- (id)initWithRegistry:(id)arg1 cosmosBridge:(id)arg2 adRulesManager:(id)arg3 adContextManager:(id)arg4 player:(id)arg5 logCenter:(id)arg6 stateController:(id)arg7;
