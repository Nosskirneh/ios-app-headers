...
#import "SPTNowPlayingAdDurationUnitViewModelDelegate.h"
...
@class NSString, SPTNowPlayingAdDurationUnitViewModel, SPTNowPlayingDurationViewV2, SPTTheme, UIView, UIViewController<SPTNowPlayingContainingViewController>;
