...
+ (id)dataLoaderRequestHeartingSelectingOrDeselectingWithPathComponents:(id)arg1 selectedOrDeselectedRecommendedTrack:(id)arg2 heartedTrack:(id)arg3 inContext:(id)arg4 onDemand:(_Bool)arg5 previousTrackList:(id)arg6 nextTrackList:(id)arg7;
+ (id)dataLoaderRequestUndoingHeartedTrack:(id)arg1 inContext:(id)arg2 onDemand:(_Bool)arg3;
+ (id)dataLoaderRequestDeselectingRecommendedTrack:(id)arg1 fromHeartedTrack:(id)arg2 inContext:(id)arg3 onDemand:(_Bool)arg4 previousTrackList:(id)arg5 nextTrackList:(id)arg6;
+ (id)dataLoaderRequestSelectingRecommendedTrack:(id)arg1 fromHeartedTrack:(id)arg2 inContext:(id)arg3 onDemand:(_Bool)arg4 previousTrackList:(id)arg5 nextTrackList:(id)arg6;
+ (id)dataLoaderRequestHeartingTrack:(id)arg1 inContext:(id)arg2 onDemand:(_Bool)arg3 previousTrackList:(id)arg4 nextTrackList:(id)arg5;
