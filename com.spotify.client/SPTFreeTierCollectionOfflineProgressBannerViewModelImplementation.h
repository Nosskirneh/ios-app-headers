...
#import "SPTFreeTierCollectionOfflineProgressBannerViewModel-Protocol.h"
#import "SPTOfflineSyncModelDelegate-Protocol.h"

@class NSString;
@protocol SPTFreeTierCollectionOfflineProgressBannerViewModelDelegate, SPTOfflineSyncModel;
