...
@protocol EXP_HUBComponentEventHandler, EXP_HUBComponentLayoutManager, EXP_HUBImageLoaderFactory, EXP_SPTHubImpressionLogger, EXP_SPTHubLoadingLogger, GLUETheme, SPTOfflineModeState, SPTPageContainer, SPTVoiceHomeViewModel;

@interface SPTFreeTierHomeViewController : UIViewController <EXP_SPTHubViewModelProviderDelegate, SPTScrollToTopViewController, EXP_HUBViewContentOffsetObserver, EXP_HUBViewComponentDelegate, SPContentInsetViewController, SPTPageController, SPTNavigationControllerNavigationBarState, SPViewController>
{
    ...
    id <SPTVoiceHomeViewModel> _voiceViewModelProvider;
}

@property(retain, nonatomic) id <SPTVoiceHomeViewModel> voiceViewModelProvider; // @synthesize voiceViewModelProvider=_voiceViewModelProvider;
...
- (void)viewDidLoad;
- (void)loadView;
- (id)initWithTheme:(id)arg1 viewURI:(id)arg2 componentRegistry:(id)arg3 componentLayoutManager:(id)arg4 imageLoaderFactory:(id)arg5 commandHandler:(id)arg6 viewModelProvider:(id)arg7 loadingLogger:(id)arg8 impressionLogger:(id)arg9 offlineModeState:(id)arg10 voiceViewModelProvider:(id)arg11;
