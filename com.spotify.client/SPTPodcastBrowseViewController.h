...
@protocol SPTPageContainer, SPTPodcastBrowseLoadingLogger, SPTPodcastBrowseViewModelProvider, VISREFIntegrationManager;

@interface SPTPodcastBrowseViewController : UIViewController <SPTPodcastBrowseViewModelProviderObserver, SPTNavigationControllerNavigationBarState, HUBViewContentOffsetObserver, SPTPageController>
{
    ...
    SPTTheme *_theme;
    id <SPTPodcastBrowseLoadingLogger> _loadingLogger;
...
@property(readonly, nonatomic) id <SPTPodcastBrowseLoadingLogger> loadingLogger; // @synthesize loadingLogger=_loadingLogger;
