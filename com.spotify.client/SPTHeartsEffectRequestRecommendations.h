...
@class NSArray, SPTHeartsContextURI, SPTHeartsTrackURI;

@interface SPTHeartsEffectRequestRecommendations : SPTHeartsEffect
{
    _Bool _onDemand;
...
- (void).cxx_destruct;
- (id)initWithContextURI:(id)arg1 trackURI:(id)arg2 onDemand:(_Bool)arg3 prevTracks:(id)arg4 nextTracks:(id)arg5;
