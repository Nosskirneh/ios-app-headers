...
#import "SPTBrowseUITestManager-Protocol.h"

@class NSString;
@protocol SPTFeatureFlagFactory, SPTFeatureFlagSignal, SPTFeatureSettingsItemFactory;

@interface SPTBrowseUITestManagerImplementation : NSObject <SPTBrowseUITestManager>
{
    _Bool _browseMockEnabled;
    _Bool _newCategoryCardsEnabled;
    id <SPTFeatureFlagFactory> _featureFlagFactory;
    id <SPTFeatureSettingsItemFactory> _featureSettingsItemFactory;
    id <SPTFeatureFlagSignal> _browseMockEnabledSignal;
    id <SPTFeatureFlagSignal> _newCategoryCardsSignal;
}

@property(nonatomic, getter=isNewCategoryCardsEnabled) _Bool newCategoryCardsEnabled; // @synthesize newCategoryCardsEnabled=_newCategoryCardsEnabled;
@property(readonly, nonatomic) id <SPTFeatureFlagSignal> newCategoryCardsSignal; // @synthesize newCategoryCardsSignal=_newCategoryCardsSignal;
...
- (void)setupNewCategoryCardsSignal;
