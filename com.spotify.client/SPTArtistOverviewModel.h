...
#import "SPTArtistViewModelData-Protocol.h"
...
@interface SPTArtistOverviewModel : NSObject <SPTArtistViewModelData>
{
    ...
    id <SPTArtistPinnedItem> _pinnedItem;
...
@property(readonly, nonatomic) id <SPTArtist> artist; // @synthesize artist=_artist;
...
@property(readonly, nonatomic) id <SPTArtistPinnedItem> pinnedItem; // @synthesize pinnedItem=_pinnedItem;
- (void).cxx_destruct;
