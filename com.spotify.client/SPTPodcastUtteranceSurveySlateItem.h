...
@class NSString, SPTPodcastUtteranceSurveyViewModel;
@protocol GLUEImageLoader, GLUETheme, SPTSlate;

@interface SPTPodcastUtteranceSurveySlateItem : NSObject <SPTSlateDataSource, SPTSlateDelegate, SPTSlateViewDataSource>
{
    id <SPTSlate> _slate;
...
@property(readonly, nonatomic) SPTPodcastUtteranceSurveyViewModel *viewModel; // @synthesize viewModel=_viewModel;
