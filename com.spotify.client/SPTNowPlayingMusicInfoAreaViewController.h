...
- (id)initWithModel:(id)arg1 theme:(id)arg2 contextMenuFeature:(id)arg3 logger:(id)arg4 linkDispatcher:(id)arg5 psxTestManager:(id)arg6 areaModel:(id)arg7 collectionTestManager:(id)arg8 options:(long long)arg9 heartsInTracksEnabled:(_Bool)arg10;
