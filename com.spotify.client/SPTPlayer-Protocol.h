...
@class NSObject<OS_dispatch_queue>, NSString, NSURL, SPTAddToQueueOptions, SPTPauseOptions, SPTPlayOptions, SPTPlayOrigin, SPTPlayerContext, SPTPlayerQueue, SPTPlayerState, SPTPlayerTrack, SPTSeekOptions, SPTSkipOptions, SPTask;
