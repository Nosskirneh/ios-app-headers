...
@class GLUEGradientView, GLUEHeaderBackgroundView, GLUELabel, NSLayoutConstraint, NSString, SPTFreeTierCollectionSongsHeaderContentViewStyle, UIView<SPTSortingFilteringFilterBar>;

@interface SPTFreeTierCollectionSongsHeaderContentView : UIView <GLUEStyleable>
{
    ...
    NSLayoutConstraint *_filterBarLeftConstraint;
    NSLayoutConstraint *_filterBarRightConstraint;
...
@property(retain, nonatomic) NSLayoutConstraint *filterBarRightConstraint; // @synthesize filterBarRightConstraint=_filterBarRightConstraint;
@property(retain, nonatomic) NSLayoutConstraint *filterBarLeftConstraint; // @synthesize filterBarLeftConstraint=_filterBarLeftConstraint;
