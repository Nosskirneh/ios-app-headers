...
#import "SPTVideoPlaybackTimeObservableDataSource.h"
#import "SPTVideoResourceLoaderInternalDelegate.h"

@class AVPlayer, AVPlayerItem, AVURLAsset, FBKVOController, NSDate, NSError, NSObject<OS_dispatch_queue>, NSString, NSTimer, SPTNetworkConnectivityController, SPTPlayerItemErrorLogEventFilter, SPTVideoAVFactory, SPTVideoCDNSelector, SPTVideoFormatImpl, SPTVideoLogger, SPTVideoPlaybackState, SPTVideoPlaybackTimeObservableImpl, SPTVideoPlayerSource, SPTVideoSubtitleSelector, SPTask, UIView<SPTVideoSurface>;
