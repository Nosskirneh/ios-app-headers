...
@class AVPlayer, AVPlayerItem, AVURLAsset, FBKVOController, NSDate, NSError, NSString, NSTimer, SPTNetworkConnectivityController, SPTPlayerItemErrorLogEventFilter, SPTVideoAVFactory, SPTVideoCDNSelector, SPTVideoFormatImpl, SPTVideoLogger, SPTVideoPlaybackState, SPTVideoPlaybackTimeObservableImpl, SPTVideoPlayerSource, SPTVideoSubtitleSelector, SPTask, UIView;
@protocol OS_dispatch_queue, SPTVideoEventObserver, SPTVideoPlaybackIdentity, SPTVideoPlaybackSessionDelegate, SPTVideoResourceLoaderInternal, SPTVideoSubtitle, SPTVideoSurface;

@interface SPTVideoPlaybackSession : NSObject <SPTVideoResourceLoaderInternalDelegate, SPTNetworkConnectivityControllerObserver, SPTVideoPlaybackTimeObservableDataSource>
{
    ...
    SPTVideoPlaybackTimeObservableImpl *_playbackTimeObservable;
...
@property(nonatomic) _Bool likelyToKeepUp; // @synthesize likelyToKeepUp=_likelyToKeepUp;
...
@property(retain, nonatomic) SPTVideoPlaybackTimeObservableImpl *playbackTimeObservable; // @synthesize playbackTimeObservable=_playbackTimeObservable;
