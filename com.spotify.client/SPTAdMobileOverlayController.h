...
@protocol SPTAdEventLogger, SPTAdOverlayImageContentViewDataSource, SPTAdsManager, SPTImageLoaderFactory, SPTLinkDispatcher, SPTPlayer, SPTSlate, SPTSlateBuilderProvider, SPTSlateManager;
...
- (void)dealloc;
- (id)initWithRegistry:(id)arg1 cosmosBridge:(id)arg2 theme:(id)arg3 player:(id)arg4 slateBuilderProvider:(id)arg5 slateManager:(id)arg6 manager:(id)arg7 imageLoaderFactory:(id)arg8 eventLogger:(id)arg9 linkDispatcher:(id)arg10;
