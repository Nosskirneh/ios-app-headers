...
@class NSString;
@protocol SPTFreeTierCollectionMigration, SPTLocalSettings, SPTYourLibraryMusicTestManager;
...
- (id)initWithLocalSettings:(id)arg1 testManager:(id)arg2 freeTierCollectionMigration:(id)arg3;
