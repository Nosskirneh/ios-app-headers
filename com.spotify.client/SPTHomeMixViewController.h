...
#import "SPTHomeMixHeaderContentViewControllerDelegate-Protocol.h"
...
@protocol GLUEImageLoader, SPTBarButtonItemManager, SPTContextMenuActionsProvider, SPTContextMenuOptionsFactory, SPTContextMenuPresenterFactory, SPTHomeMixHeaderViewModel, SPTHomeMixViewModel, SPTLogCenter, SPTPageContainer;
...
- (void)viewDidLoad;
- (id)initWithViewModel:(id)arg1 theme:(id)arg2 glueImageLoader:(id)arg3 contextMenuOptionsFactory:(id)arg4 contextMenuPresenterFactory:(id)arg5 contextMenuActionsProvider:(id)arg6 barButtonItemManager:(id)arg7 logCenter:(id)arg8;
