...
@class NSArray, NSMutableArray, NSString, SPTLanguageOnboardingDataLoader, SPTNetworkConnectivityController;
@protocol SPTLanguageOnboardingDataControllerDelegate;

@interface SPTLanguageOnboardingDataController : NSObject <SPTLanguageOnboardingDataLoaderDelegate, SPTNetworkConnectivityControllerObserver>
{
    _Bool _loading;
    _Bool _selectedRequiredNumberOfLanguages;
    id <SPTLanguageOnboardingDataControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <SPTLanguageOnboardingDataControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (void)fetchLanguages;
@property(readonly, nonatomic) unsigned long long numberOfSelectedLanguages;
