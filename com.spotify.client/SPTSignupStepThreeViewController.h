...
#import "SPTSignupStepThreeViewModelDelegate.h"
#import "SPTSignupTermsAndPolicyViewModelDelegate.h"
...
@property(retain, nonatomic) SPTSignupStepThreeView *view; // @dynamic view;
