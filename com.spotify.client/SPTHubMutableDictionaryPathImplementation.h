...
#import "SPTHubMutableDictionaryPath-Protocol.h"

@class NSString, SPTHubDictionaryPathNode;
@protocol SPTHubDictionaryActionButtonIconAlignmentPath, SPTHubDictionaryActionButtonSizePath, SPTHubDictionaryActionButtonStylePath, SPTHubDictionaryBoolPath, SPTHubDictionaryDatePath, SPTHubDictionaryDictionaryPath, SPTHubDictionaryDoublePath, SPTHubDictionaryHeaderViewStylePath, SPTHubDictionaryIconPath, SPTHubDictionaryImageDecorationPath, SPTHubDictionaryImageStylePath, SPTHubDictionaryItemTypePath, SPTHubDictionaryStringPath, SPTHubDictionaryTargetTypePath, SPTHubDictionaryURLPath, SPTHubDictionaryUnsignedIntegerPath;
