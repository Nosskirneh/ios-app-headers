...
#import "SPTSignupStepTwoViewModelDelegate-Protocol.h"
#import "UIPickerViewDataSource-Protocol.h"
#import "UIPickerViewDelegate-Protocol.h"
#import "UITextFieldDelegate-Protocol.h"
#import "UITextViewDelegate-Protocol.h"

@class NSDictionary, NSError, NSString, NSURL, SPTSignupAnimatedTransitioning, SPTSignupStepTwoView, SPTSignupStepTwoViewModel;
@protocol SPTPageContainer;

@interface SPTSignupStepTwoViewController : UIViewController <SPTNavigationControllerNavigationBarState, SPTSignupPickerContainerViewDelegate, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate, UITextViewDelegate, SPTNavigationControllerTransitioning, SPTPageController, SPTSignupStepTwoViewModelDelegate, SPTLoginViewControllerProtocol>
{
    _Bool performLogout;
    _Bool forgetUserAfterLogout;
    NSError *error;
    SPTSignupStepTwoViewModel *_viewModel;
...
@property(retain, nonatomic) SPTSignupStepTwoViewModel *viewModel; // @synthesize viewModel=_viewModel;
...
@property(retain, nonatomic) SPTSignupStepTwoView *view; // @dynamic view;
