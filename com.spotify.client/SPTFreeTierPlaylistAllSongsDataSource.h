...
@protocol SPTAssistedCurationUIService, SPTCollectionPlatform, SPTCollectionPlatformDataLoaderRequestToken, SPTFreeTierAllSongsDataSourceDelegate, SPTFreeTierAllSongsHeaderEntityViewModel, SPTFreeTierEducationSnackBarPresenter, SPTFreeTierPlaylistModel, SPTFreeTierPlaylistModelEntity, SPTFreeTierPlaylistTestManager, SPTOfflineModeState, SPTPlaylistPlatformPlaylistDataLoader;
...
- (void)dealloc;
- (id)initWithModel:(id)arg1 offlineModeState:(id)arg2 playlistDataLoader:(id)arg3 collectionPlatform:(id)arg4 testManager:(id)arg5 assistedCurationUIService:(id)arg6 educationPresenter:(id)arg7 logger:(id)arg8;
