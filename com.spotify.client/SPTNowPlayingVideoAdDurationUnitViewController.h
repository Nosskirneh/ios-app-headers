...
@class NSString, SPTNowPlayingAdPlayerObservable, SPTTheme, UIProgressView, UIViewController<SPTNowPlayingContainingViewController>;
...
- (double)currentTrackLengthForPlayerState:(id)arg1;
- (double)currentTrackProgressForPlayerState:(id)arg1;
