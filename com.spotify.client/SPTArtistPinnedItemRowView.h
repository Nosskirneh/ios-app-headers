...
@class GLUECalendarThumbnailView, GLUEImageView, GLUELabel, NSLayoutConstraint, NSString, SPTArtistPinnedItemCommentPlaceholderView, SPTArtistPinnedItemCommentView;

@interface SPTArtistPinnedItemRowView : UIView <GLUEStyleable>
{
    NSString *_titleText;
