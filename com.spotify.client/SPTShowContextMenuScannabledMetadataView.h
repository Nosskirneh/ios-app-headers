...
@property(nonatomic) _Bool scannablesEnabled; // @synthesize scannablesEnabled=_scannablesEnabled;
...
- (void)setupConstraintsForScannables;
- (void)setupDescriptionTextView;
- (id)initWithFrame:(struct CGRect)arg1 scannablesImageView:(id)arg2 headerType:(long long)arg3;
- (id)arrowIcon;
