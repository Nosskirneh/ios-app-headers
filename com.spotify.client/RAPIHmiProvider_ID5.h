...
@class IDCommunicationSystem, IDInstrumentCluster, IDMultimediaInfo, IDNavigationSystem, IDStatusBar, NSDictionary, NSString;

@interface RAPIHmiProvider_ID5 : NSObject <IDHmiProvider>
{
    IDMultimediaInfo *_multimediaInfo;
    IDStatusBar *_hmiStatusBar;
    IDInstrumentCluster *_instrumentCluster;
...
@property(retain) IDInstrumentCluster *instrumentCluster; // @synthesize instrumentCluster=_instrumentCluster;
