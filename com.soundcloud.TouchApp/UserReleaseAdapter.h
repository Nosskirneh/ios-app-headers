...
@interface UserReleaseAdapter : NSObject <NewApiCoreDataAdapter>
{
...
- (void)adaptUserPostedPlaylistsWithReleases:(id)arg1 collection:(id)arg2;
- (id)adapt:(id)arg1;
- (id)initWithManagedObjectContext:(id)arg1 user:(id)arg2 playlistAdaptor:(id)arg3;
