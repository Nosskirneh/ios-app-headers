...
@interface UserLikedPlaylistAdapter : NSObject <NewApiCoreDataAdapter>
{
...
- (void).cxx_destruct;
- (id)userLikedPlaylistWithPlaylist:(id)arg1 user:(id)arg2;
- (void)adaptUserLikedPlaylistsWithPlaylists:(id)arg1 collection:(id)arg2;
- (id)adapt:(id)arg1;
- (id)initWithManagedObjectContext:(id)arg1 user:(id)arg2 playlistAdapter:(id)arg3;
- (id)initWithContext:(id)arg1 user:(id)arg2;
