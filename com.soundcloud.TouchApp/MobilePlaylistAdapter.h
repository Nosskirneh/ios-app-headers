...
@class MobileMiniUserAdapter, NSString, PlaylistRepository;

@interface MobilePlaylistAdapter : NSObject <ApiCoreDataAdapter>
{
...
- (id)initWithPlaylistRepository:(id)arg1 mobileMiniUserAdapter:(id)arg2;
