...
@interface DeeplinkBaseResolver : NSObject <DeeplinkResolver>
{
}

- (_Bool)resolveBaseLink:(id)arg1 sourceApplication:(id)arg2 annotation:(id)arg3 origin:(long long)arg4 resolutionBlock:(CDUnknownBlockType)arg5;
