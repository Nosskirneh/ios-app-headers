...
@class CCTExperimentIds, NSArray, NSDictionary, NSString;
...
@interface PHTPhenotypeExperimentTokens : NSObject
{
    ...
    CCTExperimentIds *_externalExperimentIDs;
}

+ (id)experimentIDsStringWithTokensArray:(id)arg1 userID:(id)arg2;
+ (id)experimentIDsWithTokensArray:(id)arg1 userID:(id)arg2;
@property(readonly, copy, nonatomic) CCTExperimentIds *externalExperimentIDs; // @synthesize externalExperimentIDs=_externalExperimentIDs;
