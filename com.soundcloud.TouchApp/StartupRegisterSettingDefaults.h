...
@class LocalizationSettings, NSString, UserSettings;

@interface StartupRegisterSettingDefaults : NSObject <StartupOperation, _TtP4Core21PerformanceProfilable_>
{
...
@property(readonly, nonatomic) LocalizationSettings *localizationSettings; // @synthesize localizationSettings=_localizationSettings;
...
- (id)initWithUserSettings:(id)arg1 localizationSettings:(id)arg2;
- (id)init;
