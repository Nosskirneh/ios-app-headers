...
@interface UserRepostedTrackAdapter : NSObject <NewApiCoreDataAdapter>
{
...
- (void).cxx_destruct;
- (id)userPostedTrackWithTrack:(id)arg1 user:(id)arg2;
- (void)adaptUserPostedPlaylistsWithRepostedTracks:(id)arg1 collection:(id)arg2;
- (id)adapt:(id)arg1;
