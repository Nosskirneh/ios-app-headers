...
@interface DeeplinkAPNResolver : NSObject <DeeplinkResolver>
{
}

- (_Bool)shouldConsumeURL:(id)arg1;
- (_Bool)isValidAPNPromptRequest:(id)arg1;
- (_Bool)resolveAPNWithURL:(id)arg1 sourceApplication:(id)arg2 annotation:(id)arg3 origin:(long long)arg4 resolutionBlock:(CDUnknownBlockType)arg5;
