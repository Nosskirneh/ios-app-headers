...
@protocol OMIDSoundcloudCommandPublisher;

@interface OMIDSoundcloudAdSessionStatePublisher : NSObject
{
    id <OMIDSoundcloudCommandPublisher> _commandPublisher;
...
@property(readonly, nonatomic) id <OMIDSoundcloudCommandPublisher> commandPublisher; // @synthesize commandPublisher=_commandPublisher;
- (void).cxx_destruct;
