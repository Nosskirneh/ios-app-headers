...
@interface PlaylistScreenPlaylistTrackStorageControllerFactory : NSObject
{
...
- (id)playlistTrackRequestForUrn:(id)arg1;
- (id)upsellRequestControllerWithRequestController:(id)arg1;
- (id)playlistUpsellRequestControllerForUrn:(id)arg1;
- (id)playlistScreenPlaylistTracksForUrn:(id)arg1;
