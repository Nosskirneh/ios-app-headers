...
@interface AnalyticsOnePasswordExtensionTagger : NSObject
{
...
- (void).cxx_destruct;
- (id)tagUseOnePasswordExtensionOnScreenEvent:(long long)arg1;
- (void)tagEvent:(id)arg1;
- (void)tagUseOnePasswordExtensionOnScreen:(long long)arg1;
