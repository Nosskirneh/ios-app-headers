...
@interface SignupErrorParser : NSObject <ErrorParser>
{
...
- (void).cxx_destruct;
- (id)ageRestrictionErrorFrom:(id)arg1 body:(id)arg2;
- (_Bool)isAgeRestrictionErrorWithResponse:(id)arg1 body:(id)arg2;
- (_Bool)isSpammingErrorWithResponse:(id)arg1 body:(id)arg2;
- (_Bool)isEmailTakenErrorWithResponse:(id)arg1 body:(id)arg2;
