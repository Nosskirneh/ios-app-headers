...
@interface FollowErrorParser : NSObject <ErrorParser>
{
...
- (void).cxx_destruct;
- (id)extractErrorFrom:(id)arg1 withUnderlyingError:(id)arg2;
- (id)mapErrorWithStatusCode:(long long)arg1 body:(id)arg2 error:(id)arg3;
