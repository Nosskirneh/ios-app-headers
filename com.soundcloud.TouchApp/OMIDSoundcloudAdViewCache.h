...
@class NSDictionary, NSMutableDictionary, NSMutableSet, NSSet, OMIDSoundcloudAdSessionRegistry, OMIDSoundcloudViewKey;

@interface OMIDSoundcloudAdViewCache : NSObject
{
    NSMutableDictionary *_adViews;
    NSMutableDictionary *_friendlyObstructions;
    OMIDSoundcloudViewKey *_key;
    _Bool _isAdViewProcessed;
    NSMutableSet *_rootViews;
    NSMutableSet *_visibleSessionIds;
    NSMutableSet *_hiddenSessionIds;
    OMIDSoundcloudAdSessionRegistry *_adSessionRegistry;
}

@property(readonly, nonatomic) OMIDSoundcloudAdSessionRegistry *adSessionRegistry; // @synthesize adSessionRegistry=_adSessionRegistry;
- (void).cxx_destruct;
