...
@class NSArray, NSString, OMIDSoundcloudPartner, UIView;

@interface OMIDSoundcloudAdSessionContext : NSObject
{
    OMIDSoundcloudPartner *_partner;
...
@property(readonly, nonatomic) OMIDSoundcloudPartner *partner; // @synthesize partner=_partner;
- (void).cxx_destruct;
- (id)typeString;
- (id)resourcesJSON;
- (id)toJSON;
