...
@class GIDAuthenticationSession, GIDGoogleUser, GIDRuntimeConfigFetcher, GIDSignInCallbackSchemes, NSArray, NSString;
...
- (_Bool)startAuthenticationSessionWithOptions:(id)arg1 verifier:(id)arg2;
- (void)closeSafariViewController;
- (void)startSafariViewControllerWithOptions:(id)arg1 verifier:(id)arg2;
