...
@interface APEventGatewayEventTransformerV1 : NSObject <APEventTransformer>
{
    NSString *_clientId;
...
- (void)transformV1PlayheadPositionAttribute:(id)arg1;
- (void)transformV1LatencyAttribute:(id)arg1;
- (void)transformV1QueryPositionAttribute:(id)arg1;
- (void)transformV1TrackLengthAttribute:(id)arg1;
- (void)transformV1TrackAttribute:(id)arg1;
- (void)transformAttributes:(id)arg1 forAudioPerformanceEvent:(id)arg2;
- (void)transformAttributes:(id)arg1 forAudioEvent:(id)arg2;
- (void)transformAttributes:(id)arg1 forClickEvent:(id)arg2;
