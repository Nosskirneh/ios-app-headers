...
@class CoreDataController, NSString, YouRepository;

@interface UserPostedOrLikedPlaylistsSyncCreator : NSObject <SyncCreator>
{
...
- (id)initWithController:(id)arg1 youRepository:(id)arg2;
