...
@class ADJActivityState, ADJAttribution, ADJConfig, ADJDeviceInfo, NSDate, NSDictionary, NSString;
...
- (id)buildEventPackage:(id)arg1 sessionParameters:(id)arg2 isInDelay:(_Bool)arg3;
- (id)buildSessionPackage:(id)arg1 isInDelay:(_Bool)arg2;
