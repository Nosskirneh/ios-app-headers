...
@protocol OMIDSoundcloudStateWatcherDelegate;

@interface OMIDSoundcloudStateWatcher : NSObject
{
    unsigned long long _appState;
    id <OMIDSoundcloudStateWatcherDelegate> _delegate;
}

+ (id)getInstance;
@property(nonatomic) __weak id <OMIDSoundcloudStateWatcherDelegate> delegate; // @synthesize delegate=_delegate;
