...
+ (id)valueForKeychainKeyNew:(id)arg1 service:(id)arg2;
+ (id)valueForKeychainKeyOld:(id)arg1 service:(id)arg2;
...
- (id)keychainItemForKeyOld:(id)arg1 service:(id)arg2;
- (id)keychainItemForKeyNew:(id)arg1 service:(id)arg2;
