...
#import "OMIDSoundcloudAdEventsPublisher-Protocol.h"
#import "OMIDSoundcloudCommandPublisher-Protocol.h"
#import "OMIDSoundcloudSessionEventsPublisher-Protocol.h"
#import "OMIDSoundcloudVideoEventsPublisher-Protocol.h"

@class NSString;
@protocol OMIDSoundcloudJSExecutor;

@interface OMIDSoundcloudBridge : NSObject <OMIDSoundcloudCommandPublisher, OMIDSoundcloudSessionEventsPublisher, OMIDSoundcloudAdEventsPublisher, OMIDSoundcloudVideoEventsPublisher>
{
    id <OMIDSoundcloudJSExecutor> _jsExecutor;
}

@property(readonly, nonatomic) id <OMIDSoundcloudJSExecutor> jsExecutor; // @synthesize jsExecutor=_jsExecutor;
- (void).cxx_destruct;
