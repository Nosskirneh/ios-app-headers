...
@class NSString, UserSettings;

@interface StartupAssignTroubleshootingId : NSObject <StartupOperation, _TtP4Core21PerformanceProfilable_>
{
    UserSettings *_userSettings;
}

+ (_Bool)shouldDispatchToMainThread;
@property(readonly) UserSettings *userSettings; // @synthesize userSettings=_userSettings;
- (void).cxx_destruct;
