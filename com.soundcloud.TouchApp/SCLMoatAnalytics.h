...
@class NSHashTable, NSMutableArray, NSString, SCLMoatWebViewAndBridge;

@interface SCLMoatAnalytics : NSObject
{
    _Bool _initialized;
    ...
    SCLMoatWebViewAndBridge *_globalDisplayWebView;
...
@property(retain) SCLMoatWebViewAndBridge *globalDisplayWebView; // @synthesize globalDisplayWebView=_globalDisplayWebView;
