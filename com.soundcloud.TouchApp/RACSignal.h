...
- (id)description;
- (void)log:(id)arg1 forSignal:(id)arg2 withTag:(int)arg3;
- (void)logError:(id)arg1 forSignal:(id)arg2 withTag:(int)arg3;
- (void)logCompleted:(id)arg1 withTag:(int)arg2;
- (id)formatObject:(id)arg1 maxLength:(unsigned long long)arg2;
- (void)logNext:(id)arg1 forSignal:(id)arg2 withTag:(int)arg3;
- (id)LJ_logCompleted:(int)arg1;
- (id)LJ_logError:(int)arg1;
- (id)LJ_logNext:(int)arg1;
- (id)LJ_logAll:(int)arg1;
- (id)zipWith:(id)arg1;
- (id)concat:(id)arg1;
