...
@class BITAuthenticator, BITCrashManager, BITFeedbackManager, BITHockeyAppClient, BITMetricsManager, BITStoreUpdateManager, BITUpdateManager, NSString;
...
@property(readonly, nonatomic) BITMetricsManager *metricsManager; // @synthesize metricsManager=_metricsManager;
