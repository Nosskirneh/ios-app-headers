...
@class NSData, NSMutableArray, NSString, NSURL, VX_GCDAsyncReadPacket, VX_GCDAsyncSocketPreBuffer, VX_GCDAsyncWritePacket;
@protocol OS_dispatch_queue, OS_dispatch_source;

@interface VX_GCDAsyncSocket : NSObject
{
    unsigned int flags;
    ...
    VX_GCDAsyncReadPacket *currentRead;
    VX_GCDAsyncWritePacket *currentWrite;
    unsigned long long socketFDBytesAvailable;
    VX_GCDAsyncSocketPreBuffer *preBuffer;
    CDStruct_4210025a streamContext;
    struct __CFReadStream *readStream;
    struct __CFWriteStream *writeStream;
    struct SSLContext *sslContext;
    VX_GCDAsyncSocketPreBuffer *sslPreBuffer;
