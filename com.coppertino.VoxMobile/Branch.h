...
@class BNCContentDiscoveryManager, BNCLinkCache, BNCPreferenceHelper, BNCServerInterface, BNCServerRequestQueue, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, UIViewController;
...
@interface Branch : NSObject <BranchDeepLinkingControllerCompletionDelegate, FABKit>
{
    ...
    _Bool _delayForAppleAds;
    _Bool _searchAdsDebugMode;
...
@property(nonatomic) _Bool searchAdsDebugMode; // @synthesize searchAdsDebugMode=_searchAdsDebugMode;
@property(nonatomic) _Bool delayForAppleAds; // @synthesize delayForAppleAds=_delayForAppleAds;
...
@property(nonatomic) long long asyncRequestCount; // @synthesize asyncRequestCount=_asyncRequestCount;
...
- (_Bool)checkAppleSearchAdsAttribution;
- (void)setAppleSearchAdsDebugMode;
- (void)delayInitToCheckForSearchAds;
- (void)handlePushNotification:(id)arg1;
- (_Bool)continueUserActivity:(id)arg1;
- (_Bool)handleUniversalDeepLink:(id)arg1 fromSelf:(_Bool)arg2;
- (_Bool)application:(id)arg1 openURL:(id)arg2 options:(id)arg3;
- (_Bool)application:(id)arg1 openURL:(id)arg2 sourceApplication:(id)arg3 annotation:(id)arg4;
- (_Bool)handleSchemeDeepLink:(id)arg1 fromSelf:(_Bool)arg2;
- (_Bool)handleDeepLink:(id)arg1 fromSelf:(_Bool)arg2;
