...
@class BITAttributedLabelLink, NSArray, NSAttributedString, NSDataDetector, NSDictionary, NSString, UIColor, UILongPressGestureRecognizer;
...
@interface BITAttributedLabel : UILabel <BITAttributedLabel, UIGestureRecognizerDelegate>
{
    ...
    NSArray *_linkModels;
    BITAttributedLabelLink *_activeLink;
...
@property(retain, nonatomic) BITAttributedLabelLink *activeLink; // @synthesize activeLink=_activeLink;
