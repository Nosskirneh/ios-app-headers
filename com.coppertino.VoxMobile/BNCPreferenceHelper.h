...
@class NSDate, NSDictionary, NSMutableDictionary, NSOperationQueue, NSString;
...
@interface BNCPreferenceHelper : NSObject
{
    ...
    long long _installRequestDelay;
...
@property(nonatomic) long long installRequestDelay; // @synthesize installRequestDelay=_installRequestDelay;
