...
- (void)setClientID:(id)arg1 secret:(id)arg2 scope:(id)arg3 authorizationURL:(id)arg4 tokenURL:(id)arg5 redirectURL:(id)arg6 tokenType:(id)arg7 forAccountType:(id)arg8;
- (void)setClientID:(id)arg1 secret:(id)arg2 scope:(id)arg3 authorizationURL:(id)arg4 tokenURL:(id)arg5 redirectURL:(id)arg6 forAccountType:(id)arg7;
