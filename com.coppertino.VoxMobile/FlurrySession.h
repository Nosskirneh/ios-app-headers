...
@class NSArray, NSData, NSDate, NSMutableArray, NSMutableDictionary, NSString;
...
@interface FlurrySession : NSObject <FlurryDataSenderDelegate, FlurryWatchConnectivityDelegate, IFlurrySession, NSCoding>
{
    ...
    _Bool _notificationsSettingEnabled;
...
@property(nonatomic) _Bool notificationsSettingEnabled; // @synthesize notificationsSettingEnabled=_notificationsSettingEnabled;
...
- (_Bool)isPushNotificationSettingEnabled;
